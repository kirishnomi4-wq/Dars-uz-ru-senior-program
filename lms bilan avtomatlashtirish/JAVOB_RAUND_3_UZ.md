...
| S-5 belgisi mo'rt ekan | siz haqsiz, `version.json` qabul qilindi |
...
**Taklifingizni qabul qilamiz.** O'zgarmas manzilda kichik `version.json`
qilamiz — yig'ilish raqami va sanasi bilan. Bu bir tomonlama ish, sizdan hech
narsa talab qilmaydi; tayyor bo'lgach manzilini yozamiz.
...
| `version.json` (o'zgarmas belgi) | Biz | qabul qilindi, navbatda |
