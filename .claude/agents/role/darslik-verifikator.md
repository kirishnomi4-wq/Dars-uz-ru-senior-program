...
4. **Jonli sinov ESLATMASI** (o'zingiz qila olmasangiz): "yangi PIN + 2 o'quvchi → podium/arena ballari 0 EMAS (mentor-kod `server/.env.deploy.*` da; hujjatga yozilmaydi)" — bu QO'LDA sinov ekanini foydalanuvchiga eslating.
