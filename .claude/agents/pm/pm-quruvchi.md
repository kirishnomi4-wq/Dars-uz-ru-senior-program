...
- **🔴 MENTOR-REVEAL-YASHIRISH har scored mexanikada (2026-07-24, ETALON 44 — MatchPairs saboqi):** juftlash/biriktirish ekranida mentor-rejim javob-kaliti (`isMentorLive ? [0,1,2,3]`) FAQAT `mReveal`dan keyin — reveal'gacha slotlar bo'sh («🙈 "Natijani ochish"da ko'rinadi»), aks holda proyektorda javob oldindan ochilib qoladi (naqsh: PmJtbdLesson s9).
- **🔴 SINF-PULS o'quvchiga (2026-07-24, ETALON 45):** jonli gated koding/amaliyot ekranda «Bajardim» ostiga o'quvchi-ko'radigan ixcham jonli hisob: «👥 Sinfda: N bajardi · ✏️ M hali bajarmoqda» (ismlarsiz; ismlar mentor-panelda). `MentorPracticeStats` signal-zonasidan sof O'QISH polling — ball-relsga yozmaydi; solo'da render yo'q (naqsh: PmJtbdLesson `StudentPracticePulse`).
- **🔴 TAP-OCHILMA TOGGLE (2026-07-24, ETALON 46):** flip-ikonka/ochilma-karta birinchi bosishdan keyin `disabled` bo'lmaydi — qayta bosilsa yopilib-ochiladi; progress-darvoza `seen` (kamida bir marta ochildi) bilan ALOHIDA (naqsh: PmJtbdLesson s2 `opened`/`seen`).
