...
//  Qayta yig'ish:  node scripts/build-lms.mjs --shared react src/2-Modull/JsLoopsLesson.jsx
        ...
        <div className="split">
          <Col>
            ...
            {!fixed ? <div className="term fade-up delay-2">
                ...
                <div className="term-body" style={{ padding: "8px 14px", gap: 3 }}>{[1, 0, -1, -2].map((v, k) => <div key={k} className="term-line"><span className="term-arrow" style={{ color: T.accent }}>›</span><span>{v}</span></div>)}<div className="term-line warn-pulse" style={{ color: T.accent }}><span className="term-arrow" style={{ color: T.accent }}>›</span><span>⋮</span></div><p className="term-empty warn-pulse" style={{ color: T.accent }}>⚠️ {tr2({ uz: "i kamayyapti — 5 ga hech yetmaydi, cheksiz!", ru: "i уменьшается — до 5 не дойдёт никогда, бесконечно!" })}</p></div>
