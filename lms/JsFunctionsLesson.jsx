...
` }
  ...
  requirements: [
    { id: "ret", label: { uz: "return ishlatildi", ru: "использован return" }, check: checks.js(/return/, { uz: "Funksiya ichida `return kuch * 3` yozing", ru: "Внутри функции напишите `return kuch * 3`" }) },
