...
var Screen6 = ({ screen, storedAnswer, onAnswer, onNext, onPrev }) => {
  ...
  const [sel, setSel] = useState3(storedAnswer ? storedAnswer.sel ?? 1 : null);
  const done = sel !== null;
...
var Screen7 = ({ screen, storedAnswer, onAnswer, onNext, onPrev }) => {
  ...
  const [font, setFont] = useState3(storedAnswer?.font || "sans");
  const [size, setSize] = useState3(storedAnswer?.size || 24);
  const [touched, setTouched] = useState3(!!storedAnswer);
  const done = touched;
