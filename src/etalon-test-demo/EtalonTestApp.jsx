...
// Etalon-test demo: faqat 2 dars (PmLesson2 + PmUserStory) — coddycamp-etalon-test.vercel.app ko'rigi uchun
const PmLesson2 = lazy(() => import('../1-Modull/PmLesson2.jsx'))
const PmUserStoryLesson = lazy(() => import('../pm/PmUserStoryLesson.jsx'))

const LESSONS = [
  { key: 'struktura', emoji: '🗺️', title: 'Struktura — mahsulot qarori', sub: "Bo'limlar tartibi kimga qarab tuziladi — OLX misolida", tag: '1-modul · 6-dars', comp: PmLesson2 },
...
export default function EtalonTestApp() {
  const key = useRoute()
  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#F2F0FA', fontFamily: "'Manrope', system-ui, sans-serif" }}>
      ...
      <div className="pmd-wrap">
        <p style={{ margin: '0 0 8px', fontSize: 11.5, fontWeight: 800, letterSpacing: '0.18em', textTransform: 'uppercase', color: '#5B3DE6' }}>CoddyCamp · Senior 2026 · Etalon-test</p>
        <h1 style={{ margin: '0 0 10px', fontFamily: "'Source Serif 4', Georgia, serif", fontWeight: 600, fontSize: 'clamp(28px,4.6vw,42px)', color: '#1B1630' }}>Etalon-test — 2 dars</h1>
        <p style={{ margin: '0 0 26px', fontSize: 14.5, fontWeight: 500, color: '#565073', maxWidth: 560 }}>
          Ko'rik uchun 2 ta interaktiv dars. Darsni bosing — to'liq ochiladi; ⌂ tugmasi bilan ro'yxatga qaytasiz.
        </p>
