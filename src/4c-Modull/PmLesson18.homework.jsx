    ...
    <div className="hw-root">
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .inp.num { max-width: 120px; font-family: 'JetBrains Mono', monospace; font-feature-settings: "liga" 0, "calt" 0; }
        ...
        .wf-ck { font-family: 'JetBrains Mono', monospace; font-feature-settings: "liga" 0, "calt" 0; font-size: 11.5px; color: ${T.ink3}; display: inline-flex; align-items: center; min-width: 38px; justify-content: flex-end; flex-shrink: 0; margin-left: auto; }
