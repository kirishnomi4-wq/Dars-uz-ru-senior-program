        ...
        {!isLive ? (
          ...
          <>
            ...
            <div className="card fade-up d2">
              ...
              {live.mode === 'mentor' && <p className="small" style={{ margin: '10px 0 0', color: T.ink2 }}>{tr({ uz: '⚠️ belgili savollar — sinf qiynalgan mavzular. Ularni yana bir bor tushuntiring.', ru: 'Вопросы с ⚠️ — темы, где класс споткнулся. Объясните их ещё раз.' })}</p>}
            </div>
          </>
        )}
      </div>
