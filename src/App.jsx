...
const MODULES = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { key: 'm2-07', n: 7,  type: 'PM',      emoji: '🪜', title: 'Dekompozitsiya — PM quroli',    sub: 'katta rejani bo\'laklab, MVP va backlog qilish', comp: PmLesson5 },
  ...
  },
  {
    ...
    lessons: [
      ...
      { key: 'm4a-02', n: 2, type: 'PM',      emoji: '📈', title: 'Masshtablanuvchanlik ham mahsulot qarori', sub: 'bugungi arxitektura — 6 oydan keyingi tezlik', comp: PmLesson15 },
  ...
  },
  {
    ...
    lessons: [
      ...
      { key: 'm4c-02', n: 2, type: 'PM',      emoji: '⚡', title: 'Yetkazish tezligi ustunlik beradi', sub: 'oyiga nechta eksperiment o\'tkaza olasiz?', comp: PmLesson17 },
      ...
      { key: 'm4c-06', n: 6, type: 'PM',      emoji: '📟', title: 'Monitoring — mahsulot metrikasi', sub: 'sayt ishlab turdimi, javob tezligi va xatolar ulushi', comp: PmLesson18 },
  ...
  },
  {
    ...
    lessons: [
      ...
      { key: 'm6-14', n: 14, type: 'PM',      emoji: '🎤', title: 'Metrikali pitch — Demo Day 3', sub: 'metrika isbot beradi, arxitektura slaydga chiqadi', comp: PmLesson25 },
  ...
  },
  {
    ...
    lessons: [
      ...
      { key: 'm7-14', n: 14, type: 'PM',      emoji: '🎤', title: 'Pitch: muammo, yechim va foydalanuvchi', sub: 'real foydalanuvchi hikoyasi bilan' },
  ...
  },
  {
    ...
    lessons: [
      { key: 'm8-01', n: 1,  type: 'PM',      emoji: '📈', title: 'Metrika nima',              sub: 'kunlik foydalanuvchi, qaytish, tark etish va bosh metrika', comp: PmMetricsLesson },
      { key: 'm8-02', n: 2,  type: 'PM',      emoji: '🎯', title: 'OKR: maqsad, metrika va eksperiment', sub: 'o\'lchanadigan maqsadlar' },
      ...
      { key: 'm8-06', n: 6,  type: 'PM',      emoji: '🛡️', title: 'Xavfsizlik — ishonch demak',      sub: 'privacy as a feature' },
      ...
      { key: 'm8-11', n: 11, type: 'PM',      emoji: '🛤️', title: 'Yillik himoya: bir yillik yo\'l', sub: 'nima bo\'ldi, nima bo\'ladi va keyin nima' },
