...
const DeckMock = ({ ochiq = false }) => (
  <div className="dk-wrap" role="img" aria-label={ochiq ? 'Taqdimot: o\'nta varaq, birinchisida odamlarning muammosi' : "Taqdimot: o'nta oddiy varaq, birinchisi ajratilgan"}>
