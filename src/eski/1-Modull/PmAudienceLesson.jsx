...
import { useLiveSession, useServerProgress, LiveGateCtx, LiveGate, LiveBadge, liveGet, livePlayers, liveAnswers, liveQuizAnswers, setLiveLang } from '../live/index.js';
...
export default function PmAudienceLesson({ lang: langProp, onFinished, liveToken }) {
