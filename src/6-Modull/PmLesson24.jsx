...
const CSS_LESSON = `
  ...
  .vsc-term { display: flex; align-items: center; gap: 10px; background: #252526; padding: 8px 14px; box-shadow: inset 0 1px 0 rgba(255,255,255,0.08); color: #8FE38F; font-family: 'JetBrains Mono', monospace; font-feature-settings: "liga" 0, "calt" 0; font-size: 11.5px; }
  ...
  .vsc-body { padding: 10px 14px 12px 6px; font-family: 'JetBrains Mono', monospace; font-feature-settings: "liga" 0, "calt" 0; font-size: clamp(11px,1.35vw,12.5px); color: #D4D4D4; line-height: 1.58; overflow: auto; max-height: clamp(190px, 34vh, 380px); scrollbar-width: thin; scrollbar-color: #4A4A4A #1E1E1E; }
