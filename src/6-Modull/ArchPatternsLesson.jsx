...
export default function ArchPatternsLesson({ lang: langProp, onFinished, liveToken }) {
  ...
  return (
    <LangContext.Provider value={lang}>
      <style>{`
        ...
        .mvc-box .mvc-tag { font-family: 'JetBrains Mono'; font-feature-settings: "liga" 0, "calt" 0; font-weight: 600; font-size: 10px; color: ${T.ink3}; }
        ...
        .micro-svc .micro-tag { font-family: 'JetBrains Mono'; font-feature-settings: "liga" 0, "calt" 0; font-weight: 600; font-size: 9px; color: ${T.success}; }
