  ...
  return (
    <LangContext.Provider value={lang}>
      <style>{`        /* PRODUCTION: shu @import OLIB TASHLANADI — shriftlarni LMS yuklaydi (platform_contract). */
        ...
        .codepill { font-family: 'JetBrains Mono'; font-feature-settings: "liga" 0, "calt" 0; font-size: 11.5px; line-height: 1.5; color: ${CODE.str}; background: ${CODE.bg}; border-radius: 9px; padding: 10px 12px; word-break: break-word; }
        ...
        .vibe-dot { width: 24px; height: 24px; min-width: 24px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; color: #fff; font-family: 'JetBrains Mono'; font-feature-settings: "liga" 0, "calt" 0; font-weight: 700; font-size: 11px; transition: background 0.3s; }
