  ...
  return (
    <Stage eyebrow="Tayyor" screen={screen} audioState={audio} navContent={<><NavBack onPrev={onPrev} /><button className="btn-ghost" onClick={onReset} style={{ padding: 'clamp(11px,1.6vw,13px) clamp(16px,2.2vw,22px)', fontSize: 'clamp(13px,1.5vw,15px)' }}>Qaytadan</button><button className="btn-white-accent" onClick={onFinish} style={{ marginLeft: 'auto', padding: 'clamp(11px,1.6vw,13px) clamp(22px,2.6vw,30px)', fontSize: 'clamp(13px,1.5vw,15px)' }}>Yakunlash</button></>}>
      <div className="screen">
        ...
        {!isMentorL && <div className="ach-collect fade-up d4">
...
const QZ_BG_SHAPES = [
  ...
  { ch: 'pitch',    l: 84, t: 12, s: 30, c: 'rgba(203,173,255,0.13)', d: 23, dl: 1.5 },
  { ch: '🎤',       l: 9,  t: 74, s: 38, c: 'rgba(255,110,70,0.15)',  d: 27, dl: 0.8 },
  { ch: 'Demo Day', l: 76, t: 70, s: 24, c: 'rgba(203,173,255,0.11)', d: 21, dl: 2.2 },
  { ch: '30s',      l: 46, t: 86, s: 28, c: 'rgba(203,173,255,0.14)', d: 25, dl: 1.1 },
  { ch: '💰',       l: 66, t: 24, s: 34, c: 'rgba(80,200,255,0.14)',  d: 17, dl: 0.4 },
  { ch: 'hook',     l: 24, t: 36, s: 24, c: 'rgba(203,173,255,0.12)', d: 20, dl: 1.9 },
  { ch: 'demo',     l: 92, t: 46, s: 24, c: 'rgba(120,235,175,0.13)', d: 24, dl: 1.3 },
  { ch: '<pitch>',  l: 2,  t: 46, s: 22, c: 'rgba(203,173,255,0.10)', d: 26, dl: 2.6 },
];
const QUIZ_BANK = [
  ...
  return (
    <LangContext.Provider value={lang}>
      <style>{`
        ...
        @media (prefers-reduced-motion: reduce) { .cs-cap, .cs-ring, .cs-tok, .cs-dash, .cs-thunder, .cs-word, .cs-word::before, .csn-bolt, .cs-spark, .cs-enter, .cs-livedot i, .cs-hud-i, .cs-portal { animation: none !important; } .inv-face, .fc-fly, .acu-medal, .acu-rays, .inv-avatar.deal .inv-label, .dd-chip.nudge, .pc-row.lit { animation: none !important; } .pc-row.lit { opacity: 1 !important; transform: none !important; filter: none !important; } }
