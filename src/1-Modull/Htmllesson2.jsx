...
function MentorTestStats({ live, screenIdx, options, correctIdx, reveal, onReveal, onOpenRecap }) {
  ...
  return (
    <div className="mstats fade-up">
      ...
      {reveal && struggling && <p className="mstats-warn">⚠️ {tr({ uz: "Ko'pchilik xato qildi — bu mavzu tushunarsiz bo'lgan ko'rinadi. Qayta tushuntiring.", ru: 'Большинство ошиблось — похоже, тема осталась непонятной. Объясните ещё раз.' })}</p>}
  ...
  return (
    <Stage eyebrow={tr({ uz: 'Kirish', ru: 'Введение' })} screen={screen} audioState={audio} navContent={<NavNext optionalLive disabled={picked === null} label={tr({ uz: 'Davom etish', ru: 'Продолжить' })} onClick={onNext} />}>
      <div className="screen">
        <h1 className="title h-title fade-up">{tr({ uz: <>Sayt faqat <span className="italic" style={{ color: T.accent }}>matndan</span> iboratmi?</>, ru: <>Сайт состоит только из <span className="italic" style={{ color: T.accent }}>текста</span>?</> })}</h1>
  ...
  return (
    <LangContext.Provider value={lang}>
      <style>{`
        ...
        .dt-bar { background: #232f45; color: ${CODE.punct}; font-family: 'JetBrains Mono'; font-feature-settings: "liga" 0, "calt" 0; font-size: 11px; padding: 8px 12px; display: flex; align-items: center; gap: 12px; border-bottom: 1px solid #2e3a52; }
        ...
        .dt-node { font-family: 'JetBrains Mono'; font-feature-settings: "liga" 0, "calt" 0; font-size: 12.5px; color: ${CODE.text}; padding: 4px 7px; border-radius: 5px; cursor: pointer; transition: background 0.15s; white-space: pre-wrap; word-break: break-word; display: flex; align-items: center; gap: 2px; flex-wrap: wrap; }
        ...
        .dt-edit { font-family: 'JetBrains Mono'; font-feature-settings: "liga" 0, "calt" 0; font-size: 12.5px; background: #0f1626; color: ${CODE.str}; border: none; border-radius: 4px; padding: 2px 6px; outline: none; box-shadow: inset 0 0 0 1px ${T.accent}; width: 130px; }
        .dt-hint.dt-hint { font-family: 'JetBrains Mono'; font-feature-settings: "liga" 0, "calt" 0; font-size: 11px; color: ${CODE.comment}; padding: 2px 12px 10px; margin: 0; }
