...
59. 🔴 **«TEKSHIRUVCHI STOLI» — peer-ekranning YAGONA to'g'ri shakli (2026-07-25, foydalanuvchi qarori; 52-qonunning sherik-bandini BEKOR qiladi).**
    ...
    **Ekran tarkibi (bir vaqtda FAQAT shular — 54-qonun):** buyruq-sarlavha «Uch kartani tekshiring.» · 1 jumlalik mentor · `●○○ 1/3` progress · KATTA namuna-karta · ikki tugma `✓ ishlaydi` / `✕ tuzatish kerak` · `✕` bosilsa 3 sabab-chip · hukmdan keyin 1 qator izoh + «Keyingisi ▸» · yakunda xulosa-strip + «Endi shu ko'z bilan o'z kartangizga qarang».
