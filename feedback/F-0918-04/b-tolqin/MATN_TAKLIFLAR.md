...
> Mezon: `MATN_KORPUS.md` §63 (tavsif ≤ 48 belgi) · §133/§184 (tavsif faqat real ishni aytadi) · §183 (151-qator).
> Tasdiqlash usuli: har partiya bo'limi uchun «hammasi ok» yoki raqam bilan («P3-2 yo'q, P4-5 boshqacha: …»).

## Qisqa ko'rinish — jami 49 ta taklif

| Partiya | Takliflar | Asosiy turlar |
|---|---|---|
| P1 (1-Modull + pm) | 13 | Q6 debug ekranlarida Mentor javobni aytadi (Htmllesson2 s14, CssLesson2 s14) · CssLesson2 s7 «Nishonga tegdi!» xato qilganga ham · CssLesson1 s13 `bezak` ko'chirish tavsifi |
| P2 (2-Modull + 4a + 4b) | 7 | javob oldindan aytiladi (JsConditions s14, JsLoops s14, PracticeLesson3 s5) · Jest `fakeTestHunter` tavsifi |
| P3 (3-Modull) | 5 | maslahat xato qatorni nomlaydi (ReactCrudPractice s13 ×2, ReactIntro s14, ReactRouterPractice s13) · PmLesson9 `clearTerms` |
| P4 (4-Modull) | 13 | 7 ekranda javob oldindan (ApiPostman s14, DbSql s14, NodeServer s13/s14, PostgresCrud s14, Routing s11, AuthEnv s14) · BackendCrud s10 `// price?` |
| P5 (4c + 6-Modull) | 3 | CiCdIntro s9 tavsifi · FullPipeline s10 yorliq javobni aytadi · PmLesson17 s9 i18n |
| P6 (5-Modull) | 8 | BotApiButtons ko'chirish tavsiflari · `cycleBuilder`, `rightEnvelope` · BotIntro s13 kod-qutisida `) =&gt;` |

Nega muhim: javob urinishdan OLDIN aytilgan ekranda «🏅 Birinchi urinishda to'g'ri bajarsangiz» sharti bilimni emas,
o'qishni tekshiradi — nishon amalda kafolatli bo'lib qoladi. Tushuntirish yo'qolmaydi: xatodan keyin va topilgandan keyin chiqadi.
