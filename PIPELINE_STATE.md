# 📊 PIPELINE HOLAT MANIFESTI

> Har dars qaysi bosqichda ekanini kuzatadi. "Bosqich" ustuni joriy holatni ko'rsatadi.
>
...
| Dars | Holat |
|---|---|
| `Htmllesson1.jsx` | ✅ OLTIN ETALON (dinozavr idea + restoran abrazets + CodeStrike + ~70 animatsiya) |
| `Htmllesson2.jsx` | ✅ OLTIN ETALON — SINXRONLANGAN (2026-07-10) | 7/7 delta + 15s + auto-open fix · GATE 3 foydalanuvchi IMZOLADI · jonli-sinov qo'lda · UNCOMMITTED |
| `CssLesson1.jsx` | ✅ to'liq ko'chirilgan (2026-07-08) |

## Ko'chirish navbati (21 dars)
| # | Dars | Bosqich | Izoh |
|---|---|---|---|
| 1 | `CssLesson2.jsx` | ✅ v18 (2026-07-09) | 9-bosqich pipeline o'tdi · jonli-sinov qo'lda kutilmoqda · UNCOMMITTED |
| 2 | `GitLesson.jsx` | ✅ v18 (2026-07-10) | To'liq pipeline + «MINORA QURUVCHI» idea (foydalanuvchi talabi bilan Ijodkor) + QA 2-aylanish · GATE 3 (vakolat) · jonli-sinov qo'lda · UNCOMMITTED |
...
| 18 | `PracticeLesson4.jsx` | ⬜ | |
| 19 | `PmLesson1.jsx` | ✅ v18 (2026-07-10) | To'liq pipeline + «Bu men-ku!» idea + QA 2-aylanish · GATE 3 foydalanuvchi IMZOLADI · jonli-sinov qo'lda · UNCOMMITTED |
...
## ONBOARDING TOZALASH (2026-07-28) — 1-Modul: tur faqat 3 darsda qoldi — ✅
**Foydalanuvchi buyrug'i:** onboarding (coach-mark spotlight tur) faqat InternetLesson · PmLesson1 · Htmllesson1 da qolsin; qolgan 1-Modul darslaridan juda ehtiyotkorlik bilan olib tashlansin.
**Tashxis:** 14 darsdan 9 tasida to'liq ishlaydigan tur bor edi (TourGuide + holat + CSS + render), 2 tasida (HtmlTakrorlash, VsCode) esa komponentsiz **o'lik CSS** qolgan edi.
**Bajarildi:** 6 darsdan to'liq tur olib tashlandi (CssLesson2 · DeployLesson · GitLesson · Htmllesson2 · PmLesson3 · **PmLesson2**) — har birida 4 blok: TOUR+TourGuide (~63 q) · holat/effekt (13 q) · CSS (21 q) · render (1 q) + inert `data-tour` atributlari. HtmlTakrorlash va VsCode dan o'lik CSS (21 q) tozalandi; CssLesson2 dagi yetim CSS-izohi ham.
**Usul:** qat'iy langar-skript + **quruq yurish** (avval ko'rsatdi, keyin yozdi); langarlardan bittasi topilmasa fayl butunlay o'tkazib yuboriladi. 5 faylda blok-hajmlari aynan bir xil chiqdi (98 qator) — langarlar to'g'riligining dalili.
**Tekshiruv:** 8 fayl esbuild toza · `vite build` toza · qoldiq-grep 0 (`TourGuide`/`.tg-`/`data-tour`/`setOnboard`) · PmLesson2 butunligi saqlandi (SCREEN_META 20 = screens 20, INLINE_KEYS o'zgarmagan).
**Eslatma:** 3 darsda (GitLesson · PmLesson3 · PmLesson2) «Katta PIN auto-ochilmaydi — onboarding bilan to'qnashmasin» degan IZOH qoldi. Xatti-harakat (PIN auto-ochilmasligi) TEGILMADI — faqat izohdagi sabab endi eskirgan. UNCOMMITTED.

## NAVBAT-PULSI (2026-07-28) — onboarding o'rniga lahzali affordans, PmLesson2 da joriy — ✅
**Foydalanuvchi g'oyasi:** onboarding-tur o'rniga «navbat kimda bo'lsa, o'sha tugma yonib tursa» — birinchi marta kirgan o'quvchi «bu nima, u nima» deb qolmasin; ammo ixcham va chiroyli bo'lsin, rasvo qilmasin.
**Qabul qilingan 4 shart (88-qonun):** (a) ekranda faqat BITTA element yonadi, guruh emas — ko'p variantli ro'yxatda faqat birinchisi; harakatdan keyin navbat «Davom etish»ga o'tadi; (b) puls darhol emas, ~2.6s harakatsizlikdan keyin — bilgan o'quvchi uni umuman ko'rmaydi; (c) ballanadigan testda javobgacha puls YO'Q (test halolligi); (d) qulflangan/kutish tugmasi yonmaydi.
**Qurildi:** `useTurnHint` hooki + `.turn-hint` (tugma — asosiy soyasi saqlanadi) va `.turn-ring` (chip/karta/zona — halqa `::after` da, layout surilmaydi). O'lcham o'zgarmaydi (UI sakramaydi); `prefers-reduced-motion` da o'chiq. `NavNext` markazida — 20 ekranga birdan tarqaldi; `Screen0` birinchi variantida (darsning eng birinchi harakati).
**To'qnashuv auditi:** NavNext↔Screen0 varianti o'zaro istisno (tanlanmasa NavNext disabled) · NavNext↔sudrash chiplari istisno · arena CTA yakuniy ekranda, u yerda NavNext yo'q. CodeStrike arenasi ichidagi qo'sh-animatsiya brend-himoyasi ostida — tegilmadi.
**Brauzer-sinovi (playwright, 1440×900, 0 console/page xatosi):** halqa variantlar chizilgandan **2639 ms** keyin yondi (kutilgan ~2600) · faqat 1-variant `[true,false,false]` · bosilishi bilan darhol o'chdi · NavNext yopiq holatda pulssiz, ochilgach ~3s da yondi.
**Yon-foyda:** «nima bosish» vazifasi pulsga o'tgani uchun mentor gaplari yo'riqnomadan ozod bo'ladi — bu foydalanuvchining «mentor so'zlari chala tushunarsiz» shikoyatini hal qilish yo'lini ochadi (keyingi bosqich: pm-metodist).
**Qonun:** `PM_DARS_ETALON.md` 88-qonun. esbuild + vite build + lint:til + lint:prompt toza. UNCOMMITTED.

## NAVBAT-PULSI — TAKOMIL (2026-07-28, foydalanuvchi ko'rigi) — ✅
**Foydalanuvchi topilmasi (1-ekran):** puls noto'g'ri elementni ko'rsatayotgan edi. «Tartibli» sukut bo'yicha ochiq turadi — demak ko'rilmagani «Chalkash», puls o'sha yerda bo'lishi kerak; ovoz-variantlari esa bittasi emas, BIRMA-BIR yonsa mantiq ravshanroq bo'ladi.
**Tekshiruv natijasi — ikkalasi ham o'rinli, ikkinchisi kutilganidan kuchliroq sabab bilan:**
1. Ekranning O'Z mentor-gapi shuni aytadi: «Ikkala tugmani bosib solishtiring, KEYIN sababini tanlang». Ya'ni navbat solishtirishdan boshlanishi kerak edi — dastlabki tatbiqda 1-qadam tashlab ketilgan edi (haqiqiy xato).
2. Dastlabki tatbiq BIRINCHI variantni yoritardi — u esa «Ranglari chiroyliroq», ya'ni **noto'g'ri javob**. Variantlar teng bo'lmagani uchun bittasini yoritish javobga undash edi. To'lqin hammasiga teng munosabatda — ya'ni to'lqin faqat chiroyli emas, **halolroq**.
**Qurildi:** `seenBad` holati + ikki navbat (`cmpHint` → `voteHint`); `.turn-wave` + `w1/w2/w3` kechikishlari (0 / 0.7 / 1.4s), 4 aylanish bilan cheklangan.
**Brauzer-sinovi (playwright, 0 xato):** (1) ~3s da faqat «Chalkash» yondi, variantlar tinch, NavNext yopiq · (2) bosilgach chip halqasi darhol o'chdi · (3) +2.6s da to'lqin boshlandi va **ayni lahzada ko'ringan halqa soni 12 o'lchovda MAKS = 1** (88-qonun (a) buzilmadi) · (4) variant bosilgach hammasi o'chdi · (5) +2.8s da navbat NavNext ga o'tdi.
**Qonun:** 88-qonun (a) bandi yangilandi + yangi (a2) band: «navbat dars mantig'iga ergashadi, ekran tartibiga emas; sukut bo'yicha ochiq turgan emas, KO'RILMAGANI yonadi». UNCOMMITTED.

## NAVBAT-PULSI — 5 EKRANGA KENGAYTIRISH (2026-07-28) — ✅
**Foydalanuvchi topshirig'i (sahifa raqamlari bo'yicha):** 3 va 9 — sukut bo'yicha ochiq turgan emas, ko'rilmagan variant yonsin · 4, 6, 10 — elementlar birma-bir, navbat bilan yonsin (birdan emas); bajarilmay qolganlari aylanishda davom etsin; 10-da tanlov qilingach to'xtasin. «Yaxshiroq yo'li bo'lsa — o'sha yo'lda qil».
**Qabul qilingan yechim (soddalashtirish):** beshala ekran uchun 5 xil kod emas, BITTA umumiy mexanizm — `useTurnWalk(pending, enabled)`. Sabab: beshala ekran ham bir xil naqshda ishlaydi (`seen` to'plami / `matched`), demak «bajarilmaganlar ro'yxati bo'ylab navbat» tushunchasi hammasini qoplaydi. Bitta element qolsa yurish ma'nosini yo'qotadi — u tinch yonib turadi (3 va 9-sahifadagi juftlik shu holat).
**Ulandi:** Screen2 (3-sahifa, chip juftligi) · Screen3 (4-sahifa, 3 sayt) · Screen5 (6-sahifa, 5 bo'lim) · Screen7 (9-sahifa, chip juftligi) · Screen8 (10-sahifa, 4 juftlik; `enabled=!sel` — bo'lim tanlangach to'xtaydi, chunki navbat o'ng ustunga o'tadi va uni yoritish javobni aytish bo'lardi).
**Tartib tekshirildi:** `ORDER` = Sarlavha→Muammo→Qanday ishlaydi→Isbot→Harakat va `PAIRS` = Sarlavha→Muammo→Isbot→Harakat — foydalanuvchi so'ragan ketma-ketlikka AYNAN mos, o'zgartirish shart emas edi.
**Brauzer-sinovi (playwright, 0 xato):** 3-sahifa — faqat «Tepada: Tugma» yondi, «Sarlavha» (sukut) yonmadi, bosilgach ikkalasi tinch · 4-sahifa — navbat `Bozor → Yangiliklar → Video → tanaffus` bo'ylab yurdi, **ayni lahzada MAKS 1 ta** (88-qonun (a) saqlandi).
**⚠ Sinov-metodikasi qaydi:** dastlabki o'lchov noto'g'ri edi — `::after` mavjud bo'lmagan elementda ham `getComputedStyle(...).opacity` **1** qaytaradi, shuning uchun hamma element «yoniq» ko'rinardi. To'g'ri usul: avval klass borligini tekshirish, keyingina opacity. Kelgusi sinovlarda shu xatoga tushmaslik kerak.
**Qonun:** 88-qonunga (a1) band qo'shildi — IKKI NAQSH: TO'LQIN (bittasi tanlanadi — hammasi teng) va YURISH (hammasi ko'riladi — faqat bajarilmaganlar aylanadi). UNCOMMITTED.

## PmLesson2 — FOYDALANUVCHI KO'RIGI (2026-07-28, F-0728-01…07) — ✅
**F-0728-01 · 12-sahifa olib tashlandi.** Foydalanuvchi: «mantiqsiz, debug jarayonini anglolmadim». Tasdiq: `fix = () => setFixed(true)` — o'quvchi bitta bo'limni topadi, keyin tugma bosadi va sahifa O'ZI tuzaladi; hech narsa ko'chirilmaydi. Keyingi ekran (drag) shu g'oyani haqiqiy ish bilan beradi. → Screen10 butunlay o'chirildi.
**F-0728-02 · 15-sahifa olib tashlandi (6-sahifa bilan takror).** Tasdiq: Screen5 va Screen13 kodi bir xil (bir xil `seen`+`active` holati, bir xil `tap`, bir xil `ORDER.map` bosish-ro'yxati); yagona farq — ochiladigan matn (vazifa ↔ o'rin sababi). O'quvchi farqni sezmaydi. → Screen13 o'chirildi. **20 → 18 ekran** (etalon ~17).
**Indeks-xavfi hal qilindi:** `RECAPS` va `Q_LABELS` ekran RAQAMIGA bog'langan edi — ekran o'chgach 13-kalit 12 ga surildi. Tasdiq: SCREEN_META 18 = screens 18, scored [4,6,10,12], RECAPS va Q_LABELS kalitlari aynan mos, o'lik havola 0.
**F-0728-03 · 13-sahifa:** «To'g'ri! Sarlavha → muammo → harakat. Mana tayyor tartib.» o'chirildi (javobni aytib qo'yardi + dars boshqa joyda 5 bosqichni o'rgatgani uchun O'ZIGA ZID edi). Mentor bilan ish maydoni orasi kengaytirildi (gap 10→14px, cho'zilib ketmasin deb jilovlangan).
**F-0728-04 · «Bozor» → «OLX»** (o'quvchilar taniydigan sayt): nom, logotip harfi, domen, e-pochta — hammasi. 🔴 **Bog'liq majburiy tuzatish:** haqiqiy OLX'da «E'lon berish» tugmasi TEPADAGI menyuda turadi, dars esa «tugma faqat oxirida» deb o'rgatardi — nom qo'yilgach bola darsning xatosini ushlashi mumkin edi. Shuning uchun 6 joyda absolyut da'vo «tugma SABABDAN KEYIN turadi» qoidasiga almashtirildi (RECAP-karta, RcFlow, ask, explainWrong×2, yakuniy RECAP). Arena savolidagi YouTube ham almashtirildi (YouTube — lenta, taqdimot sahifasi emas; unda «oxirgi tugma» yo'q).
**F-0728-05 · 17-sahifa:** mentor eslatmasi ixcham «Eslatma — faqat sizga» chipiga o'tkazildi (allaqachon `isMentor` sharti ostida edi) · «Kompilyatorni ochish» tugmasi navbat-pulsiga ulandi (halqa-uslub — tugmaning gradientiga tegmaydi).
**F-0728-06 · «qavat» atamasi olib tashlandi.** Foydalanuvchi haq: bola `header/main/footer` nomlarini Htmllesson2 da allaqachon o'rgangan, «tepa/past qavat» esa o'sha narsaga YANGI SINONIM edi (bir tushuncha — bir atama qoidasi buzilardi). 10 joyda teg nomlariga o'tkazildi (vizual bloklar, shartlar, maslahatlar, mentor, audio).
**F-0728-07 · 19-sahifa flashcard 11 → 8.** Olib tashlandi: «Muammo → Kim → Yechim» (oldingi darsning formulasi + belgi-formula taqig'i 43a) · «Bir necha soniya» (manbasiz raqam) · «Sinov mijozi» (tushuncha emas, dars mexanikasi nomi). Tuzatildi: CTA izohi va «Konversiya» ta'rifi (avval «mijozga aylanish / sahifaning asosiy maqsadi» — tor va noto'g'ri edi).
**Tekshiruv:** esbuild + vite build + lint:til toza · aralash-yozuv 0 · «Bozor/bozor» qoldig'i 0. UNCOMMITTED.

## PmLesson2 — AUDIO, lessonId, KOD-AUDITI (2026-07-28) — ✅
**Audio olib tashlandi (9 941 belgi).** 🔴 Muhim topilma: bu qatlam ALLAQACHON O'LIK edi — `speechSynthesis.speak` fayl bo'ylab **hech qachon chaqirilmagan** (`playSegment` utterance yasab, «AUDIOSIZ» izohi bilan to'xtatilgan) va `Stage` komponenti `audioState` propini **umuman qabul qilmaydi**. Ya'ni olib tashlash — xatti-harakat o'zgarishi emas, o'lik kod tozalash. Olindi: `AudioEngine` klassi + `getAudioEngine` + `useAudio` hooki (infra), 14 `const audio = useAudio(...)`, 14 `audioState=` propi, 4 `audioText/audioOk/audioWrong` propi, 2 `pushOneOff` bloki, 2 `triggerEvent`, `QuestionScreen` imzosidan 3 parametr.
**lessonId:** `pm-structure-02-v18` → **`pm-m1d6-v1`** (11-qonun formati). Jonli sessiya va saqlangan holat nolga tushadi — foydalanuvchi tasdiqlagan.
**🔴 KOD-XATOSI TOPILDI VA TUZATILDI:** `KODING_KEY = 'pm-m1d2-koding'` — bu **M1-D2** (PmLesson1) kaliti edi, dars esa **M1-D6**. Koding-ekran qurilganda noto'g'ri ko'chirilgan. → `pm-m1d6-koding`.
**🔴 ARENA JAVOB-NAQSHI TUZATILDI.** Auditda qayd etilgan nuqson: ketma-ketlik `0,1,1,1,0,2,2,2,3,0,3,3` — **5 ta qo'shni takror** (3 savolda ketma-ket «B», 3 tasida «C»); o'quvchi 15 soniyalik arenada bir joyni ko'r-ko'rona bosaverardi. Yangi: `0,1,2,3,1,0,3,2,0,3,1,2` — taqsimot 3/3/3/3 saqlandi, **qo'shni takror 0**. Usul: faqat to'g'ri variantning O'RNI surildi, `correct` shunga moslandi — savol va variant MATNLARI o'zgarmadi. Tasdiq: 12/12 javob matni o'z indeksida turibdi (dasturiy tekshirildi).
**Tuzilma-auditi (dasturiy):** SCREEN_META 18 = screens 18 · scored `[4,6,10,12]` = RECAPS kalitlari = Q_LABELS kalitlari · `INLINE_KEYS` qiymatlari `[0,2,1,3]` = kodda topilgan `correctIdx` lar `[0,2,1,3]` — hammasi MOS.
**Tekshiruv:** esbuild + vite build + lint:til + lint:prompt toza · aralash-yozuv 0 · audio qoldig'i 0 · fayl 3670 qator.
**Qolgan ish:** mentor gaplari va «UX qaror» atamasi (matn-bosqichi). UNCOMMITTED.

## NAVBAT-PULSI — UNIVERSAL YECHIM MUHRLANDI (2026-07-28) — ✅
**Foydalanuvchi talabi:** «har ekranda men o'ylab aytdim va qildik — endi qat'iy logika yozishimiz kerak, boshqalar ham xuddi menday o'ylab qilishi uchun; universal yechim».
**Yozildi — `PM_DARS_ETALON.md` 1-C bo'limi (qaror-tartibi):** 1-C.1 puls javob beradigan yagona savol · 1-C.2 **HARAKAT-ZANJIRI** (6 ekran-turi uchun namuna jadval; zanjir dars mantig'i bo'yicha, DOM tartibi bo'yicha EMAS) · 1-C.3 navbat = birinchi bajarilmagan halqa · 1-C.4 **naqsh halqaning SHAKLI bilan tanlanadi** (tinch halqa / yurish / to'lqin / NavNext-avtomatik) · 1-C.5 sukut-holati tuzog'i (ochiq turgan emas, KO'RILMAGANI yonadi) · 1-C.6 puls qo'yilmaydigan 6 joy · 1-C.7 majburiy 5 bandlik tekshiruv + `::after` opacity sinov-tuzog'i · 1-C.8 kod-shartnomasi.
**Ulandi (qonun qog'ozda qolmasligi uchun):** 88-qonunga 1-C ga havola · **5-bo'lim qabul-checklistiga** navbat-pulsi darvozasi · **`pm-tekshiruvchi` roliga 14-ov-bandi** (7 tekshiruv + o'lchash-tuzog'i ogohlantirishi).
**Yon-ish:** 8-sahifadagi «Hikoyani qurish» tugmasi ham pulsga ulandi (foydalanuvchi eslatmasi) — endi darsda 11 ta puls-nuqtasi.
**Tekshiruv:** lint:prompt toza · 1-C ga 12 ta ichki havola · xotira yangilandi. UNCOMMITTED.

## NISHONLAR — MENTOR EKRANIDA (2026-07-28) — ✅
**Foydalanuvchi:** mentor ekranidagi kichik nishon-hisoblagichi va yakuniy sahifadagi nishon-ro'yxati keraksiz; ammo o'quvchi bajarganda chiqadigan TO'LIQ-EKRAN bayram proyektorda juda chiroyli — u qolsin.
**Tekshiruvda ochilgan jihat:** nishon — QURILMAGA xos, shaxsiy narsa. Mentor rejimida mentor testga javob berolmaydi (`if (solved || isMentorLive) return;`), shuning uchun proyektordagi hisob mentorning O'Z bosishlarini sanaydi, sinf ishini emas — ya'ni yolg'on hisob.
**Qabul qilingan tamoyil:** **mentor ekrani = SAHNA (lahzalar) · o'quvchi qurilmasi = DAFTAR (hisob).** Hisoblagich va yakuniy ro'yxat — hisob, ular o'quvchida qoladi; to'liq-ekran bayram — lahza, proyektorda qoladi (mentor sinf bilan birga mashqni bajarganda o'sha moment haqiqatan umumiy).
**Bajarildi:** `AchCounter` mentor rejimida `null` qaytaradi (hooklardan KEYIN — React qoidasi buzilmadi); `Screen16` nishon-kartasi `{!isMentorL && ...}` qorovuli ostida; `AchToasts`/`AchCelebrate` TEGILMADI.
**Tekshiruv:** brauzer-sinovi — self rejimida hisoblagich BOR, mentor rejimida YO'Q (uchdan-uchgacha tasdiqlandi, aynan shu `live.mode === 'mentor'` signali) · yakuniy ro'yxat statik tekshirildi (isMentorL ta'rifi + qorovul + JSX muvozanati) — avtomat yurgich juftlik-mashqi ekranidan o'ta olmadi, bu testning cheklovi · esbuild + vite build + lint:til toza. UNCOMMITTED.

## TAKRORLASH-YO'LI (2026-07-28, 89-qonun) — ✅
**Foydalanuvchi g'oyasi:** o'quvchi uyda darsni qayta ko'rganda praktikani qayta bajarib vaqt sarflamasin.
**Tekshiruvda ochilgani (2 ta):** (1) bu qisman ALLAQACHON ishlayapti — `readKoding()` `localStorage` dan `done:true` ni tiklaydi, darvoza o'zi ochiq bo'ladi, kod ham saqlanadi; (2) 🔴 darvoza TESKARI qattiq edi — jonli darsda o'quvchi `optionalLive` tufayli praktikani o'tkazib yubora oladi, mentor ham; eng qattiq darvoza esa yolg'iz o'qiyotgan bolada edi.
**Qaror (foydalanuvchi bilan muhokamada):** erkin rejimda darvozani BUTUNLAY olib tashlamaymiz — erkin rejim ayni paytda «mustaqil o'rganish» rejimi ham, koding esa darsning yagona artefakti. To'g'ri ajratuvchi belgi — rejim emas, «avval bajarilganmi». Qolgan yagona bo'shliq (sinfda BOSHQA qurilmada bajargan — dastur bila olmaydi, login yo'q) uchun **takrorlash-yo'li** qo'shildi.
**Qurildi:** `.stq-skip` — xira matn-havola (tugma emas, ataylab), matni «✓ Bu mashqni sinfda bajarganman — davom etish →». Foydalanuvchi tuzatishi: matn UMUMIY bo'lsin («davom etish»), «uy vazifasiga o'tish» emas — bir darsda bir nechta praktika bo'lishi mumkin.
**Qat'iy chegara:** havola FAQAT `onNext` chaqiradi — nishon bermaydi · «bajarildi» yozmaydi · serverga signal yubormaydi · xotiraga saqlanmaydi. Ko'rinish sharti: `!done && isSelf` (jonli o'quvchi va mentor ekranida YO'Q).
**Tekshiruv:** 6 bandlik statik audit ✅ (prop, qorovul, faqat-onNext, yon-ta'sir yo'qligi, uslub) + rejim-jadvali (self KO'RINADI · student yo'q · mentor yo'q) · esbuild + vite build + lint:til + lint:prompt toza. ⚠️ Brauzer-sinovi qilinmadi: avtomat yurgich juftlik-mashqi ekranidan o'tolmagani uchun koding ekraniga (15-sahifa) yetib bormadi — jonli ko'rikda ko'z bilan tasdiqlansin.
**Qonun:** 89-qonun. 📌 Texnik darslarga ham tegishli (3 praktika) — `DARS_ETALON.md` ga ko'chirish KUTILMOQDA (alohida ish, ~70 dars). UNCOMMITTED.

## MENTOR EKRANI QAT'IYLASHTIRILDI (2026-07-28, 90-qonun + 1-D bo'lim) — ✅
**Foydalanuvchi:** UserStory'da mentor panelidan «0/4 to'g'ri javob» statistikasi olib tashlangan edi — PmLesson2 da ham olinsin; va bu barcha darslar uchun QAT'IY qilinsin; nishonlar bo'yicha ham mentor panelida qanday bo'lishi qat'iy yozilsin, MD ga to'liq.
**Tashxis:** etalonni (`PmUserStoryLesson.jsx`) PmLesson2 bilan solishtirdim — etalon podiumida «📊 Savollar bo'yicha» kartasi UMUMAN YO'Q, PmLesson2 da esa bor edi (`SCORED_IDX` bo'yicha har savolga `okN/qa.length`, ya'ni «0/4»). Shu karta + uning o'lik CSS'i (`pod-qstats`, `qstat-*` — 4 qator) olib tashlandi.
**Nima uchun to'g'ri (sabab yozib qo'yildi):** proyektorda butun sinf oldida «0/4» — mag'lubiyat-tablosi, kamsitadi. Mentor bu ma'lumotni YO'QOTMAYDI: u dars PAYTIDA `MentorTestStats` orqali, aynan test ekranida ko'radi («sinf qiynaldi» ogohlantirishi bilan).
**Muhrlandi — `PM_DARS_ETALON.md` 1-D bo'limi:** «MENTOR EKRANI (proyektor) — QAT'IY KO'RINISH». 13 element × mentor/o'quvchi × sabab jadvali. Ikki tayanch tamoyil: (1) SHAXSIY narsa proyektorda chiqmaydi (nishon-hisoblagichi, nishon-ro'yxati, ScoreRing — mentorda ular yolg'on son, chunki mentor testga javob berolmaydi); (2) MAG'LUBIYAT-TABLOSI chiqmaydi. Qisqa qoida: **mentor ekrani = SAHNA (lahzalar) · o'quvchi qurilmasi = DAFTAR (hisob)**.
**90-qonun** yozildi + **qabul-checklistiga** mentor-ekrani darvozasi + **`pm-tekshiruvchi` 15-ov-bandi** (13 band sweep + o'lik CSS residue-grep).
**Tekshiruv:** 8 bandlik dasturiy audit PmLesson2 da ✅ (hisoblagich yo'q · ro'yxat yo'q · qstats yo'q · CSS qoldig'i yo'q · ScoreRing faqat !isLive · bayram saqlangan · ikkala mentor-panel bor) · esbuild + vite build + lint:til toza · lint:prompt o'zimning homoglifimni ushladi («jazо») → tuzatildi.
📌 Texnik darslarga ko'chirish KUTILMOQDA (`DARS_ETALON.md`). UNCOMMITTED.

## TEXNIK DARSLARGA KO'CHIRILDI (2026-07-28) — `DARS_ETALON.md` 9.4-A · 10.1 · 10-B — ✅
**Foydalanuvchi buyrug'i:** mentor-ekrani, kompilyator (praktika-darvozasi) va nishonlar mavzusini texnik darslar etaloniga ham qat'iy qilib ko'chir.
**Usul:** dublikat bo'lim yaratilmadi — `DARS_ETALON.md` da praktika (9.4) va nishonlar (10) bo'limlari allaqachon bor edi, yangi qoidalar ULARNING ICHIGA qo'shildi; mentor-ekrani esa yangi 10-B bo'limi bo'ldi (hujjatning o'z uslubi: `15-I` kabi harfli bo'lim allaqachon bor).
**🔴 Ko'chirishda topilgan kuchliroq muammo:** texnik darslarda praktika-darvozasi PM darsdan ham og'ir — `next()` izohida ochiq yozilgan: «*har safar compilatorni ochadi (orqaga qaytib qayta bossa ham)*», va bajarilganlik **hech qayerda saqlanmaydi** (`Htmllesson2` da localStorage faqat live-sessiya va nickname uchun). Ya'ni uyda takrorlayotgan bola **uchala** praktikani qaytadan bajarmaguncha oldinga o'tolmaydi. Bu 9.4-A da muammo sifatida ochiq yozildi + 3 bandlik talab qo'yildi (saqlash · qayta majburlamaslik · takrorlash-yo'li).
**Yozilgan bo'limlar:** **9.4-A** praktika-darvozasi bir marta yopiladi (PM 89-qonun bilan bir xil, texnik oqimga moslangan) · **10.1** nishonlarning 3 qatlamidan IKKITASI mentorda o'chadi (bayram QOLADI — u lahza, hisob emas) + tatbiq usuli (qorovul komponentning o'zida, hooklardan keyin) · **10-B** mentor ekranining 12 bandlik jadvali + ikki tayanch tamoyil.
**Ulandi:** 14-bo'lim tekshiruv ro'yxatiga 7 yangi band · `darslik-tekshiruvchi` roliga yangi bo'lim (2 sinf: mentor-ekrani 5 buzilish + praktika-darvozasi; S33 o'lik-kod saboqi bilan bog'landi).
**Tekshiruv:** lint:prompt toza · vite build toza · ichki havolalar: DARS_ETALON 13 ta, tekshiruvchi-rol 3 ta.
⚠️ **Diqqat:** bu — QONUN, tatbiq emas. ~70 texnik darsda praktika-saqlash hali yo'q; har dars tegilganda shu bo'yicha tuzatiladi. UNCOMMITTED.

## KATALOG MATNI TOZALANDI (2026-07-28) — `App.jsx` + `M1DemoApp.jsx` — ✅
**Foydalanuvchi:** «chala so'zlarni ham to'liq qilaylik — qisqa bo'lishi uchun qilinmasin; UI da ko'ringan so'z tushunarli bo'lmasa, kerakmas».
**1. Belgi-formulalar (43a-qonun) — 19 ta.** Katalog nomlari va tavsiflarida `=` va `→` to'liq iboraga aylandi: «Muammo → Yechim» → «Muammodan yechimga» · «Komponent = feature: prioritet» → «Komponent ham funksiya: qaysi biri birinchi?» · «Delivery tezligi = ustunlik» → «Yetkazish tezligi ustunlik beradi» · «idrok → qaror → amal sikli» → «idrok, qaror va amal aylanmasi» va h.k. PmLesson2 niki ham: «Struktura = mahsulot qarori» → «Struktura — mahsulot qarori».
**2. «Atama-bo'tqa» — 3 ta.** Bitta qatorda 4 ta izohsiz inglizcha so'z turgan tavsiflar (bola hech narsa tushunmaydi): «workflow, job, step, ci.yml» → «avtomatik ish oqimi: qadamlar va sozlash fayli» · «uptime, latency, error rate, SLA» → «sayt ishlab turdimi, javob tezligi va xatolar ulushi» · «DAU, retention, churn, North Star» → «kunlik foydalanuvchi, qaytish, tark etish va bosh metrika».
**Qaror-chegarasi:** YAKKA atamalar (MVP, backlog, Acceptance Criteria kabi) TEGILMADI — ular katalogda «shu darsda nima o'rganasiz» ma'nosini beradi va darsning o'z mavzusi. Faqat 3+ izohsiz atama yonma-yon turgan holatlar tuzatildi.
**⚠️ Yo'l-yo'lakay 2 xato ushlandi (o'zim kiritgan):** almashtirishda tipografik apostrof (`’`) kirib qolgan edi — bu MATN_ETALONI da taqiqlangan, va bittasi JS satrini buzib `vite build` ni to'xtatgan edi. Ikkalasi ASCII apostrofga o'tkazildi; qolgan joyda ibora umuman apostrofsiz qayta yozildi («so'ng demo» → «oxirida demo»).
**Tekshiruv:** belgi-formula 0 · atama-bo'tqa 0 · tipografik apostrof 0 · vite build toza.
**Dars ichidagi karta-ochilish matnlari** (SECDATA/SITES/NEEDS/flashcard back/RECAPS/explainWrong) — pm-metodistga alohida topshiriq bilan yuborildi. UNCOMMITTED.

## PmLesson2 MATN-SAYQALI (2026-07-28) — pm-metodist — ✅
**«UX qaror» 14 o'rinda olib tashlandi** → «foydalanuvchi uchun qilingan qaror». Qamrov: `LESSON_META` (uz+ru) · RECAPS · hook-ack · mentor gaplari · test izohlari · flashcard · yakuniy RECAP · `QUIZ_BANK` Q1 to'g'ri javobi (indeks va pozitsiya TEGILMADI).
**Mentor gaplari — «NEGA + aniq chorlov» qolipiga o'tkazildi** (foydalanuvchi talabi: puls QAYERDA ekanini ko'rsatadi, mentor NIMA QILISHNI aytadi). Namuna: ❌ «Avval bo'limni tanlang, keyin vazifasini bosing» → ✅ «Har bo'lim bitta vazifani bajaradi: avval chapdan bo'limni tanlang, so'ng o'ngdan uning vazifasini bosing».
**Karta-ochilish matnlari** (alohida topshiriq — e'tibordan chetda qoladigan qatlam): `SECDATA` job/label · `SITES.rows` · `NEEDS` · flashcard back/note · tap-reveal freymlari — hammasi qayta yozildi.
**Fakt-nuqsonlar yopildi:** hero yagona ta'rif («birinchi blok = katta sarlavha + izoh») 7 joyda tekislandi · footer tor ta'rifi kengaytirildi · «bir necha soniya» manbasiz raqami olib tashlandi · absolyut da'volar («doim», «har doim») yumshatildi · «sinov mijozi» nihoyat ochildi · «chalkash» taqiq-oilasi 0 ga tushdi · hook variantlari tenglashtirildi · `=` belgi-formulalari tire bilan almashtirildi.
**12 ta distraktor qayta yozildi** — o'zini fosh qiladiganlar («Farqi yo'q, bari bir xil», «Hech qanday muammo yuzaga kelmaydi») ishonarli-lekin-noto'g'riga aylandi. Faqat MATN — indeks/pozitsiya tegilmadi.
**Mustaqil tekshiruvim (10 band):** ekran 18=18 · `INLINE_KEYS` o'zgarmagan · `correctIdx` [0,2,1,3] · `QUIZ_BANK` `0,1,2,3,1,0,3,2,0,3,1,2` (qo'shni takror 0) · navbat-pulsi tegilmagan · aralash-yozuv 0 · esbuild + build + lint:til + lint:prompt toza.
**Grapheme:** 17 ekran ≤400; s16 (yakun) 588 — ataylab istisno (korpus 11: yakun-ekranda uy-vazifa TO'LIQ turishi shart).
**🔴 O'zim qo'shimcha 2 qoldiq tozaladim:** (1) fayl sarlavhasi eskirgan edi — hamon «UX QAROR / PLATFORM STANDARD v16» va dizayn manbasi sifatida TEXNIK darsni (JsIntro) ko'rsatardi; keyingi quruvchini chalg'itardi → 1-tur etaloni sifatida qayta yozildi (1-B/1-C/1-D/87-qonun havolalari bilan). (2) `// ===== SCREEN 10 — ... =====` yetim izohi — u belgilagan ekran o'chirilgan edi (S33 sinfi). UNCOMMITTED.

## BUG-SINF MUHRLANDI (2026-07-29): `<style>` ichida ortiqcha backtick — ✅
**Vaziyat:** UserStory'ga navbat-pulsi qo'shilayotganda IDE **yuzlab** sintaksis-xato ko'rsatdi; foydalanuvchi «men klaviaturada xatolab bosdimmi?» deb so'radi.
**Tashxis:** yo'q — ildiz BITTA edi. Agent CSS-izohiga backtick yozgan: «… charchamasin. `wv4` — to'rt variantli qator uchun». `<style>{` … `}</style>` bloki JS shablon-satri bo'lgani uchun ichidagi backtick uni **erta yopadi**, undan keyingi butun CSS va JSX kod deb o'qiladi — shundan yuzlab «xato».
**Saboq:** bunday holatda IDE ro'yxatiga qaramaslik kerak — **esbuild**ning BIRINCHI xatosi ildizni aniq ko'rsatadi.
**⚠️ Yolg'on-signal saboqi:** dastlab grep bilan sweep yozdim (`/\* [^*]*` + backtick) — u PmJtbd va PmMetrics'da 3 ta moslik berdi, ammo ikkalasi ham **0 xato bilan yig'iladi**: ular `{/* … */}` JSX-izohlari, shablon-satridan TASHQARIDA, zararsiz. Aniqlashtirilgan grep esa aksincha, haqiqiy bugni O'TKAZIB YUBORDI (backtick ko'p qatorli izohning 3-qatorida edi). To'g'ri usul: style-blokini ajratib, ichidagi backticklarni SANASH — 4 etalon fayl shu bilan tekshirildi.
**Muhrlandi:** `DARS_ETALON.md` 12-bo'lim (ma'lum buglar) — belgi/sabab/tuzatish + grep ishonchsizligi haqida ogohlantirish bilan.
**Holat:** agent xabarni olib backtickni tuzatdi — esbuild 0 xato, ish davom etmoqda. UNCOMMITTED.

## UserStory (P0) — NAVBAT-PULSI + INPUT-NAVBATI + TAKRORLASH-YO'LI (2026-07-29) — ✅
**Bajarildi (pm-quruvchi, +226/−34, boshqa fayl tegilmagan):** yadro ko'chirildi (`useTurnHint`/`useTurnWalk`/`turnCls` + `.turn-ring/.turn-step/.turn-wave`), 21 chaqiruv, 13 ekranga naqsh qo'yildi. Yangi: `wv4` (4 variantli qator uchun to'lqin) va ikki o'rovchi (`.turn-wrap`, `.hcp-code-wrap`) — input `::after` qabul qilmagani uchun. `NavNext` ga `turnBusy` propi: tugma ochiq bo'lsa ham, navbat hali ekran ichida bo'lsa yonmaydi.
**🔴 INPUT-NAVBATI (foydalanuvchining asosiy talabi):** `pendFields = ['kim','nima','natija'].filter(bo'sh)` → `useTurnWalk(pendFields, showEditor && !fieldFocus && !isMentorW)`. To'lgan maydon navbatdan chiqadi; fokusda butun yurish to'xtaydi; uchtasi to'lgach navbat «Saqlash»ga o'tadi.
**To'qnashuv:** mavjud 4 puls (`jws-pulse`/`tray-pulse`/`kod-btn-pulse`/`pair-start-pulse`) yangi navbat-shartiga bo'ysundirildi (`.turn-quiet`/`.calm`/`muted`) — yangi puls ular bilan birga yonmaydi.
**89-qonun:** `.kdx-skip` takrorlash-yo'li qo'shildi (`{!done && isSelf && ...}`, `onClick={onNext}`).

### Mustaqil tekshiruvim (agentnikiga ishonmasdan)
- esbuild 0 · vite build · lint:til · lint:prompt · aralash-yozuv 0 · style-blokida ortiqcha backtick 0 · vaqtinchalik fayl qoldig'i 0.
- 🔴 **Ball-relslari `git show HEAD` bilan solishtirildi — IDENTIK:** `INLINE_KEYS` · `QUIZ_BANK` correct · `correctIdx` lar · `SCREEN_META` · `submitAnswer` chaqiruvlari.
- Takrorlash-yo'li yon-ta'siri: `onClick={onNext}` dan boshqa chaqiruv yo'q (statik, kontekst-grep).
- Brauzer (playwright, o'z testim): **kechikish 2668 ms** (mount lahzasidan o'lchandi) · **ayni lahzada yonayotgan maksimum = 1** (150 o'lchov: 141 marta 0, 9 marta 1, hech qachon 2+).

### ⚠️ O'LCHOV-SABOQLARI (o'z testlarimda 2 marta yolg'on-signal)
1. **Klass nomiga qarab o'lchash NOTO'G'RI.** Birinchi testim 0 puls ko'rsatdi — chunki men faqat `turn-*` klasslarini qidirdim, agent esa 0-ekranda mavjud `taphint` klassini qayta ishlatgan (to'g'ri qaror — yangi vizual ixtiro qilmagan). **To'g'ri usul: klass emas, HAQIQIY animatsiyani o'lchash.**
2. **«Animatsiya ishlayapti» ≠ «element yonyapti».** Ikkinchi testim «4 ta birga yonyapti» dedi. Aslida `hook-tap` keyframe'ida element **88% vaqt neytral**, faqat 88–100% oralig'ida (≈0.29s) yonadi, kechikishlar esa 0.3s — ustma-ust tushmaydi. **To'g'ri usul: hisoblangan `box-shadow` dagi aksent rangini sanash.**
3. **Kechikishni sahifa yuklangandan KEYIN o'lchash NOTO'G'RI** — «40 ms» chiqdi, aslida 2668 ms. **To'g'ri usul: `addInitScript` bilan mount lahzasidan o'lchash.**
...
## 2026-07-30 — F-0730-05: OQ-EKRAN BUG — Stage eyebrow xom {uz,ru} render (React #31) — ✅
**Tashxis (foydalanuvchi skrinshoti: InternetLesson m1-01, texnik-demo):** 3-ekrandan 4-ekranga (birinchi test) o'tishda oq ekran. Sabab: `Stage` ichida `<span>{eyebrow}</span>` xom render; QuestionScreen'lar `eyebrow={{uz,ru}}` obyekt beradi → React #31 «Objects are not valid as a React child». i18n-migratsiya davridan qolgan bug (F-0730-01 saqloviga aloqasi YO'Q — toza localStorage bilan playwright'da qayta hosil qilindi).
**Tuzatish:** `<span>{tr(eyebrow)}</span>` — 8 faylda (InternetLesson + BotIntro/BotStateful/BotAiProject/BotAiAgent/BotFeedback + ArchPatterns + WriteSkill; qolgan 90 faylda eyebrow doim string — tegilmadi, xavfli kombinatsiya grep bilan aniqlangan).
**Tekshiruv:** playwright-repro: m1-01 4 ekrandan xatosiz o'tdi · esbuild 8/8 toza · texnik-demo qayta deploy (coddycamp-texnik-darslar.vercel.app 200).
**Saboq (takror bug-sinf):** yangi i18n-lessonlarda Stage/umumiy komponentlar {uz,ru} qabul qiladigan har prop'ni tr() bilan o'rashi shart. UNCOMMITTED.

## 2026-07-31 — 2-MODUL BOSHLANDI · 96-QONUN (MODUL-IPI) + M2-D6 FUNKSIYALAR OLAMI ALMASHDI — 🔄
**GATE 1 (bosh-agent auditi, foydalanuvchi tasdig'i bilan):** 13 dars skanerlandi. Infratuzilma 13/13 da sog'lom (SCREEN_META · jonli-ball · ccProgress · flashcard · QUIZ_BANK) — ya'ni Retsept C (etalonga tortish), A emas. Hook-lar 95-qonun bo'yicha tekshirildi: tana, o'yin bali, metro turniketi, xabar, izoh-baza, ilovalar, skeytbord-MVP, do'kon-loyihalari — hammasi Toshkent o'smiriga YAQIN, saqlanadi.
**Topilgan 3 tizimli muammo:** (1) 🔴 «limonad» olami + «retsept» oshxona-metaforasi (JsFunctions 20+12, JsIntro 13) — 95-qonunga zid; (2) 🔴 PmLesson4/5/6 da RU tarjima YO'Q (`ru:`=1), qolgan 10 dars to'liq; (3) 🟡 92/94/95-qonun va KORPUS 38–52 bu darslardan KEYIN tug'ilgan. lint: 0 error, 41 warn.
**FOYDALANUVCHI QARORI — MODUL-IPI:** 2-Modul 1-Modulning **lavash do'koni** olamida davom etadi: M1-D2 auditoriya-kartasi → M2 o'sha do'konga ishlaydigan sayt. Qonunlashtirildi: PM_DARS_ETALON **96-qonun** (modul-ipi: loyiha kunlari qanday mahsulot qursa, nazariy darslar ham shu mahsulot bo'laklarida o'rgatiladi; oldingi modul artefakti kirish bo'ladi; tanlov qurishdan OLDIN yoziladi) + memory/modul2-lavash-ipi.md.
**FAZA 1 · M2-D6 (JsFunctionsLesson) — limonad → narx hisoblagichi ✅:** hook «Limonadni har safar noldan qo'lda tayyorlaysizmi?» → **«Har bir buyurtma narxini qo'lda hisoblaysizmi?»** (4 amal: lavash narxi · ichimlik · yetkazib berish · jami; 🍋→🧾) · S11 payoff `limonadTayyorla(xil)` → **`narxHisobla(soni)`** — endi funksiya HAQIQIY hisob qiladi (`return soni * 25000`), 1/3/12 ta buyurtma bilan chaqirilib har xil narx qaytaradi (parametr→natija bog'lanishi ko'rinadigan bo'ldi) · flavor-kartalar ta'm o'rniga narx ko'rsatadi.
**«Retsept» metaforasi olib tashlandi (12 joy):** RECAPS kartasi «Funksiya — bu retsept» (🍳 + «retsept ovqat pishirmaydi») → **«Funksiya — nomlangan ish tartibi»** (📋 + «yozib qo'yilgani bilan o'zi ishlamaydi — nomi bilan chaqirish kerak»); qolgan joylarda retsept→tartib. Sabab: MATN_ETALONI oshxona-metafora taqig'i + lint warn.
**Darvozalar:** esbuild ✓ · lint:til **0 topilma** (avval 12 warn) ✓ · lint:prompt ✓ · `vite build` toza ✓ · UZ/RU muvozanati 563↔563 ✓ · residue-grep (limonad/retsept/🍋/🥤) = 0 ✓.
**Keyingi:** M2-D1 JsIntro (retsept 13x) → D3 JsVars → D4 JsConditions → D5 JsLoops; keyin Faza 2 (PM uchligi + RU), Faza 3 (loyiha kunlari). UNCOMMITTED.

## 2026-07-31 — FAZA 1 · M2-D1 (JsIntro) LAVASH-IPIGA KO'CHIRILDI + D3/D5 sayqal — ✅
**M2-D1 «Sistema va Algoritm» — 45 o'zgarish (skript bilan, har biri 1x-tekshiruvidan o'tgan):**
· 🔴 **«Algoritm = retsept» ta'rifi olib tashlandi** (13 joy): nishon «Recipe Master»→**«Algorithm Master»** · maqsad-chip, maqsad-karta, RECAP, lug'at, 2 test savoli, 2 audio-skript, S6 mentor+audio («xuddi ovqat retsepti kabi» tushirildi) → hamma joyda **«Algoritm — aniq qadamlar tartibi»**.
· 🔴 **BAJARBOT olami nonushta→lavash (96-qonun):** S7 ketma-ketlik (🥣🥚🥛🍳 → 🫓🍗🥫🌯 «Nonni yoy · Go'sht sol · Sous quy · O'rab uzat»; chalkash-tartib falokati «avval o'radi — bo'sh nonni!») · S8 shart (sensor muzlatgich/sut → **sous idishi**; AGAR sous bo'lsa→sous quy, AKS HOLDA→sousiz o'ra; natija 🌯🥫/🌯) · S13 blok-palitrasi + S15 drag-drop dasturi (sikl bloki «Aralashtir ×5»→**«Sabzavot sol ×3»**) · KitchenStage sukut-matnlari («bo'sh likob»→«bo'sh peshtaxta», «Tayyor nonushta!»→«Lavash tayyor!») · «Oshxona sahnasi»→«Tayyorlash sahnasi» (3 joy) · CSS izohlari.
· S6 ertalabki tartib (uyg'onish→nonushta→maktabga) **TEGILMADI** — bu o'quvchining O'Z kuni, 95-qonundan o'tadi.
· 🟡 73-qonun buzilishi tuzatildi: «→ keyingi darsda buni JavaScript'da yozamiz» va'da-qatori → «→ shu uch qism bilan istalgan algoritm yoziladi».
**D3 (JsVars):** «quti to'ladi» → «qutiga yoziladi» (KORPUS 42-qonun fe'l↔ekran).
**D4 (JsConditions):** `else if zanjiri` — lint yolg'on-ijobiysi edi; qoidaga `except` qo'shildi (else if · if-else · rol/prompt/agent-zanjir · zanjir-reaksiya), matn TEGILMADI.
**2-Modul lint holati:** 41 warn → **13 warn, 0 error** (qolgani: PracticeLesson1/3 «retsept», Practice2 kirill-homoglif, 3 darsda «to'ladi», Practice3 va'da-qatorlari — Faza 3 da).
**Darvozalar:** esbuild ✓ (3 fayl) · lint:til 0 error ✓ · lint:prompt ✓ · `vite build` toza ✓ · UZ/RU muvozanati ✓ · residue-grep (retsept/likob/tuxum/nonushta) = 0 ✓.
**⚠️ QAROR KUTILMOQDA (D3/D4/D5 misollari):** hozir D3 = shaxsiy ma'lumot (`let ism = "Aziza"`, ball, yosh) · D4 = metro turniketi + ball-shartlari · D5 = 30 do'stga xabar. Uchalasi ham 95-qonundan O'TADI va pedagogik jihatdan kuchli (birinchi o'zgaruvchi — o'quvchining O'Z ismi). 96-qonunni qat'iy qo'llasak, ular ham lavash-do'koniga ko'chishi kerak. Bosh-agent tavsiyasi: **hook va birinchi misol shaxsiy qolsin, lavash-ipi «Yakuniy · amaliy» ekranida ko'prik sifatida kirsin** — foydalanuvchi qarori kutilmoqda. UNCOMMITTED.

## 2026-07-31 — FAZA 1 YAKUNI · «🌯 LOYIHAGA KO'PRIK» NAQSHI (D3/D4/D5) — ✅
**Foydalanuvchi qarori:** «ko'prik variant bilan davom et» — D3/D4/D5 to'liq lavashga KO'CHIRILMAYDI (shaxsiy misollar pedagogik jihatdan kuchli), modul-ipi ko'prik-karta bilan ulanadi.
**Bajarildi:** uch darsning **yakuniy amaliy** ekraniga `ProjectBridge` komponenti qo'shildi — mashq BAJARILGANDAN keyin muvaffaqiyat-blokidan so'ng chiqadi (92-qonun buzilmasin: mashq oldidan ekran bulg'anmaydi):
· **D3 JsVars:** «Loyiha kunlarida lavash do'koni sayti uchun xuddi shunday qutilar yozasiz: `let narx = 25000`, `let soni = 3`. Ism o'rniga — buyurtma ma'lumotlari.»
· **D4 JsConditions:** «Loyiha kunlarida shart do'kon saytida qaror qabul qiladi: `if (soni > 10)` — ko'p buyurtmaga yetkazib berish bepul bo'ladi.»
· **D5 JsLoops:** «Loyiha kunlarida menyuni sikl chiqaradi: 12 ta lavashni bittalab yozmaysiz — `for` ularni o'zi ro'yxatga tizadi.»
Har biri UZ+RU, `frame-soft` uslubida, bitta gap.
**Qonunlashtirish:** PM_DARS_ETALON **96b — KO'PRIK NAQSHI** (96-qonun har ekranni majburlamaydi: hook va birinchi misol yaqin/shaxsiy olamda qoladi, modul-ipi yakuniy amaliyda ko'prik-karta bilan ulanadi; ko'prik mashqdan oldin chiqmaydi, bitta gapdan oshmaydi; loyiha kunlari esa to'liq mahsulot olamida).
**Darvozalar:** esbuild ✓ (3 fayl) · `ProjectBridge` ta'rif/ishlatilish 1:1 uchchalasida ✓ · UZ/RU muvozanati 511/511 · 536/536 · 564/564 ✓ · lint:til 0 error (13 warn — Faza 3 darslarida) ✓ · lint:prompt ✓ · `vite build` toza ✓.
**FAZA 1 YAKUNLANDI:** D1 (JsIntro, lavash-BAJARBOT) · D3 · D4 · D5 (ko'prik) · D6 (JsFunctions, narx hisoblagichi). Keyingi: **Faza 2 — PM uchligi (D2 PmLesson4 · D7 PmLesson5 · D13 PmLesson6)** sayqal + RU tarjima (hozir `ru:`=1). UNCOMMITTED.

## 2026-07-31 — F-0731-32/33: Htmllesson1 s8 GAZETA → TELEGRAM POSTI — ✅
**Foydalanuvchi topilmasi:** «sarlavha teglarini gazeta misolida tushuntirganmiz — gazetani umuman olib tashlardim. Analogiyaning maqsadi: o'quvchi "ha, buni har kuni ko'raman" deyishi kerak; gazeta esa "gazeta qanday bo'lardi o'zi?" degan savolni tug'diradi.»
**Bosh-agent qo'shimcha tashxisi:** shu darsning **9-ekrani allaqachon Telegram olamida** (post ichidagi so'zni B/I bilan formatlash) — ya'ni gazeta darsdagi YAGONA begona olam edi, 91-qonun (bitta misol-ip) ham buzilgan. Almashtirish ipni butun qildi: s8 (post tuzilishi) → s9 (post ichidagi so'z).
**🔴 Bosh-agent topgan aniqlik muammosi (foydalanuvchi matniga tuzatish):** taklif matnida «avval eng KATTA yozuvni ko'rasiz» edi — Telegram postida shrift o'lchami YO'Q, muhim gap QALIN va BIRINCHI turadi. Ko'prik ochiq qilib yozildi: «Telegramda eng muhim gap qalin va birinchi turadi. HTML sahifasida esa uni kattaligi ko'rsatadi: h1 eng katta va muhim, keyin h2, h3… h6 eng kichik.»
**Tuzatildi:** sarlavha «Gazetada nima darrov ko'zga tashlanadi?» → «**Telegram postida qaysi yozuv birinchi ko'zga tashlanadi?**» · mentor · audio-skript · javob-izohi (UZ+RU) · bir martalik audio-payoff.
**Vizual (foydalanuvchi tasdig'i bilan):** «📰 Gazeta sahifasi» yorlig'i o'rniga haqiqiy post ko'rinishi — 🏫 kanal avatari + «Maktab kanali» + «bugun 09:14» sarlavha-paneli, pastda «👁 412 · Maktab kanali» izi. Yangi CSS: `.tgp-head/.tgp-ava/.tgp-name/.tgp-sub/.tgp-foot`. Post KONTENTI tegilmadi (robototexnika to'garagi e'loni — maktab kanalida aynan shunday e'lon chiqadi) va h1/h2/p teg-mexanikasi o'zgarmadi.
**Qonunlashtirish:** MATN_KORPUS **53** (analogiya o'quvchi HAR KUNI ko'radigan yuzadan; tekshiruv-savoli «oxirgi bir haftada ko'rganmi?»; dars-ipiga qarab tanlanadi) · **54** (analogiya MEXANIKASI ham haqiqatga mos bo'lsin; qolip: [tanish yuzada qanday] → «… esa …» → [texnikada qanday]).
**Yo'l-yo'lakay tuzatildi:** korpusda 51-bo'lim sarlavhasi tahrir paytida o'chib qolgan edi — tiklandi, 53/54 raqam-tartibga qo'yildi.
**Darvozalar:** esbuild ✓ · lint:til 0 error ✓ · lint:prompt ✓ · UZ/RU muvozanati 776↔776 ✓ · residue-grep (gazeta) = 0 ✓. UNCOMMITTED.

## 2026-07-31 — F-0731-34: Htmllesson1 dan TAKRORIY DEBUGGING EKRANI (16-sahifa) OLIB TASHLANDI — ✅
**Foydalanuvchi topilmasi:** «16-pageda Debugging bor ekan — bundan oldin ham shu darsda debugging bo'lgan, 2 marta bo'lmasin. O'chirib tashla, ehtiyotkorlik bilan barchasini moslab.»
**Tasdiqlangan tashxis:** 16-sahifa = `screens[15]` = `Screen13` (id `s13`, «DEBUGGING — musbat ramka + tuzatish»), ball berilmaydigan ekran. Takror: xato-topish mashqi allaqachon **s6** (8-sahifa, «🐞 Endi xatoni toping») ichida bor.
**Olib tashlandi (6 bog'liq joy, hammasi tekshirilgan):**
1. `SCREEN_META` dan `{ id: 's13' }` yozuvi · 2. `screens` massividan `Screen13` · 3. `Screen13` komponentining o'zi (60 qator) · 4. `PRACTICE_AFTER` kaliti **15 → 14** (yakuniy praktika endi oxirgi nazariya-ekranidan keyin chaqiriladi; aks holda Podiumdan keyin ochilardi) · 5. 🏅 `ACH_TRIGGERS`: `s13: 'debugger'` → **`s6: 'debugger'`** — nishon yo'qolmadi, endi qolgan xato-topish mashqidan beriladi (ta'rifi «Buzuq kodni topib tuzatdingiz» s6 mazmuniga mos) · 6. eskirgan izoh-qator.
**TEGILMADI (ataylab):** `.debug-*` CSS oilasi — u qayta ishlatiladigan (s6 dagi mashq shu uslubda ishlaydi).
**Indeks-siljish tekshiruvi (dasturiy):** `SCREEN_META 18 === screens 18` ✅ · ekran-tartibi 1:1 xaritalandi ✅ · `SCORED_IDX 4,6,8,12` — o'zgarmadi (hammasi o'chirilgan indeksdan OLDIN) ✅ · `RECAPS` kalitlari 4/6/8/12 — o'zgarmadi ✅ · `PRACTICE_AFTER` 9/13/14 ✅.
**Darvozalar:** esbuild ✓ · lint:til 0 error ✓ · `vite build` toza ✓ · UZ/RU muvozanati 750↔750 ✓ · s6 debug-mashqi va 🐞 nishon joyida ✓. Dars 19 → **18 ekran**. UNCOMMITTED.

## 2026-07-31 — M1-D12 «Git va GitHub» TO'LIQ QAYTA QURILDI (nazariya → amaliyot) — ✅ Quruvchi
**Foydalanuvchi qarori (ketma-ketlik tasdiqlangan):** dars nazariya-darsi emas, **amaliy o'rnatish-darsi** bo'lsin: brauzer/akkaunt → Git o'rnatish → GitHub ro'yxati → 4 qisqa nazariya (repo·add·commit·push) → repo yaratish → VS Code'dan push. `pull` faqat ma'lumot o'rnida. «12–15 sahifa bo'lsayam, 17 bo'sayam farqi yo'q — ketma-ketlik muhim».
**Natija:** 21 nazariya-ekran → **18 amaliy ekran** (3697 → 3405 qator). Tasdiqlangan tartibdan chekinish YO'Q.
· s0 hook (kompyuter buzilsa kod qayerda) · s1 natija-preview (shaxsiy `github.com/<nick>/mening-saytim`) · **s2 Chrome+Google** · **s3 Git o'rnatish** (`git --version` tekshiruvi) · s4 TEST-1 · **s5 GitHub ro'yxat** · s6 TEST-2 · s7–s10 nazariya (repo·add·commit·push, `pull` bir gapda) · s11 TEST-3 · **s12 AMALIYOT: repo yaratish** · **s13 AMALIYOT: clone→fayl→commit→Sync** · s14 yakuniy test · podium · flashcard · yakun.
**UX (foydalanuvchi talabi «real, tushunarli, ekran bulg'anmasin»):** yagona `DoSteps`/`DoScreen` qolipi — qadamlar **bittalab ochiladi** (94-qonun), bajarilgani ✓ bilan yig'iladi, keyingilari qulf-sarlavha holida; **kutilgan natija maketi** har qadamda (brauzer oynasi · terminal `git version 2.45.2` · o'rnatuvchi · repo sahifasi); «Bajarolmadim» yordami `<details>` ichida yashirin; o'tish tugmasi aynan qolgan qadamni aytadi. Nazariya ekranlariga bittalik harakat-gate («ko'rdim» emas, «qildim»).
**Yondosh:** 90(b) podium «📊 Savollar bo'yicha» + CSS olib tashlandi · o'lik kod tozalandi (`DragDropOrder`, `Zoomable`, `CodeBox/Tg/At/Sr`, `.twr-*/.gtl-*/.jmini-*`) · `prefers-reduced-motion` bloki · 4 nishon mavzuga moslandi (`installed·quizace·shipped·graduate`) · `lessonId` → `git-github-v19`.
**Darvozalar (bosh-agent qayta o'lchadi):** esbuild ✓ · lint:til **0 topilma** ✓ · `vite build` toza ✓ · `SCREEN_META 18 === screens 18` ✓ · `QUIZ_BANK` 12 (3/3/3/3, qo'shni-takrorsiz) ✓ · `INLINE_KEYS {s4:1,s6:0,s11:2,s14:3, s12:-1,s13:-1}` ↔ scored id'lar 1:1 ✓ · `RECAPS`/`Q_LABELS` kalitlari = SCORED_IDX ✓ · UZ/RU 541↔541 ✓ · qstats qoldig'i 0 ✓.
**QOLGAN:** 🎨 Dizayn (s13 o'ng ustuni 1280×800 da skroll xavfi — brauzerda o'lchansin) · ⚡ Jonli · ✍️ Metodist · 👦 o'quvchi o'qishi · RU-korrektura. Xavf: VS Code UI yorliqlari («Sync Changes», «Source Control») versiyaga bog'liq — sinfda bir marta jonli sinov tavsiya etiladi. UNCOMMITTED.

## 2026-08-01 — M1-D13 «Netlify va deploy» TO'LIQ QAYTA QURILDI (nazariya → deploy-amaliyoti) — ✅ Quruvchi
**Foydalanuvchi qarori (ketma-ketlik tasdiqlangan):** «Netlify nimaligini aytamiz xolos, registratsiya yo'q; o'quvchi VS Code'da o'zi loyiha tanlaydi (Demo Day uchun, 4–5 sahifali), biz unga to'liq PROMPT beramiz (HTML+CSS, JS yo'q, responsive, animatsiyali), AI'dan kodni olib qo'yadi; keyin Netlify (GitHub akkaunti bilan) → git'ga qo'yib deploy → uy vazifasi = URL yuborish; bitkazmaganlar tugatib yuboradi». Talab: «real UX/UI, tushunarli sahifalar, ekran bulg'anmasin».
**Natija:** 20 nazariya-ekran → **17 amaliy ekran**.
· s0 hook (sayt faqat kompyuteringizda) · s1 papka→Netlify→havola oqimi · s2 TEST-1 · **s3 loyiha tanlash + 4–5 sahifa nomini yozish** (94-qonun: 4 karta → tanlangach bir qatorga yig'iladi, maydonlar ochiladi; o'ngda menyu jonli yig'iladi) · **s4 tayyor topshiriq** (4 uslub: minimalist·yorqin·qorong'i·gradient; chapda uslub, o'ngda skrollanadigan panel + 📋) · **s5 AI'dan kod → VS Code** · s6 TEST-2 · **s7 GitHub'ga push** · **s8 Netlify — Log in with GitHub** · **s9 Deploy → havola** · s10 TEST-3 · **s11 havolani sinash + saqlash (IXTIYORIY)** · s12 yakuniy test · s13 uy vazifasi · podium · flashcard · yakun.
**Prompt (darsning yuragi):** 10 bandli topshiriq — faqat HTML/CSS (JS ISHLATMA, sababi 87-qonun stek-chegarasi) · har sahifa alohida fayl + bitta `style.css` · menyu orqali bog'lanish · `header/main/footer` semantik teglar (o'quvchi Htmllesson2 da o'tgan) · responsive · animatsiyalar (hover, silliq o'tish, yumshoq paydo bo'lish) · `picsum.photos` rasmlari · uslub tavsifi · izohli toza kod. LOYIHA/SAHIFALAR s3 dan avtomatik to'ladi, UZ va RU paralleli bilan.
**Loyiha-tanlovlari (o'quvchining O'Z tanlovi, demo emas):** lavash do'koni · o'yin-klub · o'zim haqimda · maktab to'garagi.
**🔗 Artefakt-zanjiri:** s3 → `cc-deploy-project` · s11 → `cc-site-url` **va** `ccPitch3.link` ga buzmasdan qo'shiladi → ya'ni **M1-D14 «Demo Day» darsidagi sayt-manzili maydoni endi O'ZI TO'LADI** (o'sha maydon avval majburiy bo'lib to'siq bo'lgan, 92(d) qonuni shundan tug'ilgan edi).
**UX:** `DoSteps`/`DoScreen` qolipi GitLesson'dan olindi (93-qonun — qayta ixtiro qilinmadi): qadamlar bittalab, ✓ bilan yig'iladi, ↺ bilan qaytariladi, «Bajarolmadim» `<details>` ichida, chapda kutilgan natija mock-paneli (Netlify `NetWin` · terminal · GitHub repo · brauzer), NavNext qolgan qadamni aytadi.
**Legacy bug tuzatildi:** `recordAnswer` da `scope==='final'` uchun `live.submitAnswer(idx, id, 0, true, 0)` dubl/yolg'on yozuv yuborardi — olib tashlandi.
**Darvozalar (bosh-agent qayta o'lchadi):** esbuild ✓ · lint:til **0 topilma** ✓ · `vite build` toza ✓ · `SCREEN_META 17 === screens 17` ✓ · `QUIZ_BANK` 12 (3/3/3/3) ✓ · scored `[s2,s6,s10,s12]` ↔ `INLINE_KEYS` 1:1 ✓ · UZ/RU 554↔554 ✓ · artefakt-kalitlari 3/3 ✓ · SSR-smoke 17×2=34 render, matn zichligi 184–738 belgi (92-qonun ichida) ✓.
**QOLGAN:** 🎨 Dizayn · ⚡ Jonli · ✍️ Metodist · 👦 o'quvchi o'qishi. Xavf: mock-panellar real Netlify UI o'zgarsa eskiradi · `hw-big` CTA `onHomework` propisiz ulangani uchun matn NavNext'ga berilgan. UNCOMMITTED.

## 2026-08-01 — 1-MODUL VERCEL'GA CHIQARILDI (UZ-RU to'liq) — ✅
**Foydalanuvchi buyrug'i:** «1-Modulni PM+tex to'liq Vercel'ga qo'yib URL ber, UZ-RU da».
**Build:** `npx vite build --config vite.m1.config.js` → `dist-m1/` (4.7 MB, 14 dars alohida chunk).
**Deploy:** `dist-m1` scratchpad'ga ko'chirildi, `modul1.html` → `index.html` deb nomlandi (statik root uchun), `npx vercel deploy --prod --yes` (hisob: kirishnomi4-6915 / azizbek10).
**URL:** https://coddycamp-1modul.vercel.app — status ● Ready, HTTP 200, JS bandl 200.
**Tarkib:** 14 dars — InternetLesson · **PmLesson1** · Htmllesson1 · Htmllesson2 · HtmlTakrorlashLesson · **PmLesson2** · CssLesson1 · CssLesson2 · HtmlPractice · VsCodeLesson · CssPractice · **GitLesson (yangi)** · **DeployLesson (yangi)** · **PmLesson3**. Hammasi UZ-RU.
**Shu deploy'ga kirgan bugungi ishlar:** PmLesson1 (lavash olami + bosqichli karta + so'z-sayqal + RU) · Htmllesson1 (gazeta→Telegram, Debugging ekrani olib tashlandi) · Htmllesson2 (tushunarsiz so'zlar) · HtmlTakrorlash (tartiblanmagan ro'yxat) · PracticeLesson1 (tugma) · **GitLesson to'liq qayta qurildi (18 amaliy ekran)** · **DeployLesson to'liq qayta qurildi (17 ekran, prompt + deploy oqimi)** · PmLesson2 RU.
UNCOMMITTED (deploy build'dan qilindi, git'ga bog'liq emas).

## 2026-08-01 — QA RAUNDI 1-MODUL · InternetLesson hook (F-0801-01…04) — ✅
**Manba:** QA 1-2-Modulni tekshirdi; foydalanuvchi topilmalarni yechimi bilan aytdi. Retsept B.
**F-0801-01 — hook savoli sun'iy.** ❌ «Sayt manzilini yozib Enter bossangiz, u qayerdan keladi?» → ✅ «**youtube.com yozib Enter bossangiz, sayt sizga qayerdan yetib keladi?**» (`InternetLesson.jsx` Screen0 h1 + `:940` yon-savol + `s0` audio). Foydalanuvchi dalili: «"qayerdan keladi" sun'iy — bola aslida bunday o'ylamaydi». **Qaror A** tanlandi (savol «qayerdan» bo'lib qoladi) — chunki 3 variant (`kompyuterim ichidan / boshqa kompyuterdan / hech qayerdan`) aynan JOYga javob beradi; sof «qanday»ga o'tish variantlarni ham qayta yozishni talab qilardi (savol↔variant nomosligi xavfi).
**F-0801-02 — mentor gapidagi «katta yo'l» mavhum.** ❌ «…ekran ortida so'rovingiz katta yo'lni bosib o'tadi» → ✅ «…so'rovingiz **xonangizdan chiqib ketadi, chet elgacha yo'l bosadi va javob bilan qaytib keladi**». Foydalanuvchining dastlabki taklifi («internet orqali boshqa kompyutergacha boradi») **rad etildi — spoyler**: u hook variantlaridan birining aynan o'zi edi. Kelishilgan variant masofa/borib-qaytishni aytadi, MEXANIKAni (kim javob berdi) 1-ekranga qoldiradi. «minglab kilometr» → «chet elgacha» (o'smir uchun raqamdan ko'ra his qilinadigan).
**F-0801-03 — RAD.** «Kompyuterimning ichidan» → «O'z kompyuterim ichidan» taklifi foydalanuvchi tomonidan bekor qilindi; variant o'zgarmadi.
**F-0801-04 — QONUNLASHTIRILDI.** Yangi **97-qonun** (`PM_DARS_ETALON.md` 4-bo'lim, 95/96 yonida — barcha darslarga): *hook-savol o'quvchining o'z savoli shaklida yoziladi*; 5 band (aniq narsa · harakat fe'li · o'quvchi harakatidan o'sadi · savol o'zgarsa variantlar qayta tekshiriladi · ovoz chiqarib o'qish testi). Korpusga 2 juftlik: **§57** (hook-savol) + **§58** (mavhum «yo'l» → ko'rinadigan sayohat + spoyler taqiqi).
**Darvozalar:** esbuild ✓ · `lint:til` **0 error** (3 warn — oldindan bor «retsept» metaforasi, texnik darsda ruxsat) ✓ · `lint:prompt` 0 topilma ✓ · UZ/RU parallel tahrirlandi ✓.
**QOLGAN:** 1-Modulning qolgan 13 darsi 97-qonun bo'yicha supurilmagan. UNCOMMITTED.

**F-0801-05 — `google.uz` → `coddycamp.uz` (InternetLesson, foydalanuvchi qarori).** 6-sahifadagi (Screen5 «Domen») `.uz` namunasi brend-domenga almashtirildi. Faqat o'sha ekran emas, BUTUN misol-ip ko'chirildi (91-qonun): `s5` audio+chip+mentor · `s5b` test (3 matn) · `s7` DNS jadvali · `SITE_CATALOG` (`🎓 CoddyCamp`, `#FF4F28`, mock `generic`) · RECAPS flashcard 6 · `QUIZ_BANK` yakuniy savol. `.uz` izohi kuchaytirildi: «O'zbekiston saytlari uchun. **Bizning maktabimiz ham shu zonada.**» — 95-qonun bo'yicha o'quvchi bu domenni haqiqatan ishlatadi. **Yo'l-yo'lakay tuzatilgan nomoslik:** `google.uz` IP'si DNS ekranida `173.194.220.94`, simulyatorda `142.250.185.3` edi (bir domen, ikki raqam — DNS darsida ayni ziyonli); yangi domenga bitta IP `213.230.106.24` qo'yildi. `google.uz` qoldig'i 0 (grep). Darvozalar: esbuild ✓ · lint:til 0 error ✓ · UZ/RU parallel ✓. UNCOMMITTED.

**F-0801-06 — ichki nom o'quvchi matniga chiqib ketgan (17-page mentori).** `ScreenReqOrder` (`s13c`) mentori «**Paket o'yinida** ko'rdingiz…» deb boshlanardi. **Dalil (grep):** `paket` so'zi faylda 8 marta — 7 tasi KOD IZOHI (`953,966,986,1436,2081,2119,2985`), yagona o'quvchi ko'radigan joyi `:3002` edi. Ya'ni bola bu nomni hech qayerda ko'rmagan; oldingi (16-) ekranda u ko'rgan yagona nom — sarlavha «youtube.com ni topib, ekranga keltira olasizmi?». Foydalanuvchi dalili: «14 yoshli o'quvchi bo'lib o'qisam, shu joyda 1–2 soniya to'xtab qolaman — qaysi paket? qaysi o'yin?».
**F-0801-07 — mentor mashqning javobini aytib turgan (bosh-agent topdi, foydalanuvchi tasdiqladi).** O'sha mentor tartibni to'liq sanardi («brauzerdan boshlanadi, DNS manzilni topadi, server sahifani beradi, ekran chizadi»), holbuki ekranning O'Z topshirig'i — shu tartibni DragDrop bilan **yig'ish**. Javob mashq ustida turgani uchun bola yig'maydi, ko'chiradi. `s13c` **ovozli matni** ham xuddi shuni aytardi.
**Tuzatildi (foydalanuvchi tasdiqlagan matn):** ❌ «Paket o'yinida ko'rdingiz: so'rov brauzerdan boshlanadi…» → ✅ «**Hozirgina youtube.com ni topib, ekranga keltirdingiz. So'rov o'sha yo'lni bosib o'tdi. Endi shu tartibni o'zingiz yig'ing.**» — havola oldingi ekran SARLAVHASI so'zlari bilan beriladi (yangi nom qo'shilmaydi), tartib esa aytilmaydi. Audio ham qayta yozildi; RU parallel. Yo'l-yo'lakay `sk-buildbox` dagi uchlanma takror (mentor «Endi shu tartibni o'zingiz yig'ing» + eyebrow «🧲 Endi o'zingiz yig'ing» + body «Bo'laklarni to'g'ri tartibda joylang») bitta qatorga yig'ildi: «🧲 Bo'laklarni sudrab yoki bosib joylang».
**Supurish:** butun dars orqaga-havolaga tekshirildi (`ko'rdingiz|yuqorida|oldingi ekran|esingizdami`) — boshqa ichki-nom havolasi YO'Q; `s13b` mentori ham javobni bermaydi (usulni aytadi) ✓. O'quvchi ko'radigan `paket` qoldig'i 0.
**Qonunlashtirildi:** **98-qonun** (`PM_DARS_ETALON.md`, barcha darslarga) — (a) orqaga-havola faqat o'quvchi O'QIGAN so'z / O'ZI QILGAN harakat bilan, ichki ish-nomi taqiq (grep-tekshiruvi bilan); (b) mentor gapi VA ovozli matn mashqning javobini sanab bermaydi — ipucha komponentning O'Z `hints` mexanikasidan. Korpus: **§59** + **§60**.
**Darvozalar:** esbuild ✓ · lint:til 0 error ✓ · lint:prompt 0 ✓ · UZ/RU parallel ✓. UNCOMMITTED.

**F-0801-08 — flashcard ekranidagi mentor takroriy (foydalanuvchi taklifi).** `ScreenFlashcards` da 3 qatlam bor edi: sarlavha → mentor → karta. Mentorning uchala gapi ham ekranda ALLAQACHON bor edi: «javobini o'ylang» ↔ karta yuzidagi «Javobni o'ylang 🤔 bosing» · «kartani bosib tekshiring» ↔ `.fc-hint` «👆 Kartani bosing — javobni ko'rasiz» · «Bildim yoki Takrorlash bilan baholang» ↔ tugmalarning O'Z matni. Foydalanuvchi dalili: «o'quvchi savolga o'tishdan oldin bir xil ma'lumotni ikki marta o'qiydi — darsning ritmi sekinlashadi».
**Tuzatildi:** `<Mentor>` BUTUNLAY olib tashlandi (qatlamlar: sarlavha → progress → karta). Sarlavha ❌ «Atamalarni **tez takrorlaymiz**» → ✅ «**O'zingizni sinab ko'ring**» (foydalanuvchi bergan variantlardan tanlandi — «bilimingizni» dan qisqaroq/shaxsiyroq, 97-qonunga mos: aniq narsa + harakat fe'li). RU: «Проверьте **себя**». `sflash` audio ham qisqartirildi (98b hamrohi — ovoz ham o'sha ko'rsatmani sanardi). Ritm-talabi: Savol → O'ylash → Javobni ochish → «Bildim»/«Takrorlayman».
**Qonunlashtirildi:** **99-qonun** (`PM_DARS_ETALON.md`) — komponent o'z ko'rsatmasini o'zi aytadi, mentor takrorlamaydi; flashcard ekranida mentor pufagi umuman bo'lmaydi; sarlavha faoliyatni aytadi; ovoz ham qisqaradi; umumiy shakl «ko'rsatma BIR joyda — harakatga eng yaqin joyda». Korpus **§61**.
**🔴 QARZ (supurilmagan):** grep — `ScreenFlashcards` ichida `<Mentor>` **72 darsda** bor (M1: CssLesson1/2, CssPractice, DeployLesson, GitLesson, Htmllesson1/2, HtmlPractice, PmLesson1, PmLesson3, VsCodeLesson — 11 ta; qolgani M2-M7). Sarlavhalar ham bir xil naqshda («… tez takrorlaymiz»). Foydalanuvchi qaroriga qo'yildi.
**Darvozalar:** esbuild ✓ · lint:til 0 error ✓ · lint:prompt 0 ✓ · UZ/RU parallel ✓. UNCOMMITTED.

## 2026-08-01 — 99-QONUN BUTUN KURS BO'YICHA SUPURILDI (flashcard mentori) — ✅
**Foydalanuvchi buyrug'i:** «InternetLessonni ko'r — flashcard sahifada mentor gapi yo'q; qolgan 6 Modul ham xuddi shunday bo'lsin: Mentor gapini shunchaki o'chirib, sarlavha shunaqa bo'lsin, ehtiyotkorlik bilan».
**Qamrov:** 76 flashcard-ekran skanerlandi (1-Modul 14 · 2-Modul 13 · 3-Modul 10 · 4-Modul 11 · 4a 3 · 4b 2 · 4c 5 · 5-Modul 8 · 6-Modul 10). **75 dars tuzatildi** (InternetLesson — etalon, allaqachon tayyor).
**Ehtiyot-tekshiruv (tahrirdan OLDIN, dasturiy):** 76 ekranning hammasida h2 aynan bitta va shakli **1:1 bir xil** (`<div className="head"><h2 className="title h-title fade-up">{tr(…)}</h2></div>`); `<Mentor>` 73 darsda **bitta qatorda** (`^<Mentor>…</Mentor>$`, shartli o'rash yo'q) → mexanik almashtirish xavfsiz. Quruq yurish bilan 73 ta eski sarlavha ko'zdan kechirildi, keyin qo'llandi.
**Nima qilindi (har darsda):** (a) `<Mentor>` qatori butunlay o'chirildi — qatlamlar endi sarlavha → karta; (b) sarlavha etalonga keltirildi: ❌ «Atamalarni/Tushunchalarni/… **tez takrorlaymiz**» → ✅ «**O'zingizni sinab ko'ring.**» / «Проверьте **себя**.» (UZ+RU parallel, `T.accent` kursivi saqlandi); (c) `useAudio` bo'lgan **21 darsda** ovozli matn ham qisqartirildi (99-qonun: ovoz ham ko'rsatmani sanab bermaydi) → «O'zingizni sinab ko'ring. Har kartada bir savol — javobini o'ylang, keyin kartani bosing.»
**Qo'lda (naqshdan chetda):** `PmLesson2` (mentori yo'q, faqat sarlavha) · `PracticeLesson4` (mentori yo'q, lekin h2 ostida ko'rsatmani takrorlaydigan `<p className="h-sub">` bor edi — «Kartani bosing, javobni o'ylang, o'zingizni baholang» — **o'chirildi**, audio ham qisqartirildi).
**Darvozalar:** esbuild **127/127 toza** (bittalab + bitta yurishda ikki marta o'lchandi) ✓ · qayta-skaner: flashcard-ekran 76, **qolgan `<Mentor>` = 0**, **etalon sarlavha 76/76** ✓ · `Mentor` komponenti ishlatilmay qolgan fayl **0** (o'lik kod tug'ilmadi) ✓ · har fayl diffi 2 o'chirildi/1 qo'shildi (audio bo'lsa 3/2) — begona o'zgarish yo'q ✓ · `lint:til` namunaviy 5 faylda 0 yangi error (WriteSkillLesson `sirini-ochamiz` — **oldindan bor**, flashcarddan tashqarida) ✓ · UZ/RU parallel ✓.
**QOLGAN:** WriteSkillLesson `:1548` «sirini ochamiz» (99-qonundan mustaqil, alohida raundga) · 97-qonun (hook-savol) bo'yicha 1-Modulning qolgan 13 darsi supurilmagan. UNCOMMITTED.

## 2026-08-01 — F-0801-10 · NISHON BAYRAMI BUTUN KURSDA UserStory O'LCHOVIGA — ✅
**Foydalanuvchi buyrug'i:** «UserStorydaqa nishon chiqqanda kam so'z bo'lsin — barcha darslarda, ehtiyotkorlik bilan».
**Tashxis (79 dars `AchCelebrate` skanerlandi):** etalon = `src/pm/PmUserStoryLesson.jsx:2331` — medal → nom → bitta qator (32–42 belgi) → xira «bosib davom eting». Ikki chetlanish topildi:
· **(1) ortiqcha e'lon-sarlavha** `<span className="acu-eyebrow">🏅 Nishon ochildi!</span>` — 4 darsda (PmLesson1:2957 · PmLesson2:460 · PmLesson3:3078 · PmLesson4:2817). Qolgan 75 darsda yo'q edi, faqat CSS'i o'lik yotardi.
· **(2) uzun tavsif** — 108 nishon 52 belgidan uzun; eng yomoni `MobileAppPracticeLesson` (o'rtacha 82, max **89** belgi — 4 soniyalik overlayda o'qib bo'lmaydi), `BotStatefulMemory` 80, `BotFullProject` 74. Kurs mediani 45, UserStory 38.
**Ehtiyot-tekshiruv (tahrirdan OLDIN):** `acu-eyebrow` o'chiriladigan 4 qatorning oldingi/keyingi qatori bosma bilan tasdiqlandi (hammasida `acu-txt` → **eyebrow** → `acu-name` — ya'ni aynan bitta ortiqcha qator). Tavsiflar esa `name` bo'yicha kalitlandi, skript har nishon faylda **aynan bitta marta** uchrashini talab qildi (0 nomuvofiqlik), UZ↔RU juftligi bor-yo'qligi ham tekshirildi (RU bo'lsa yangi RU majburiy).
**Nima qilindi:** (a) 4 darsdan `acu-eyebrow` qatori o'chirildi — bayram endi hamma joyda **medal → nom → tavsif → «bosib davom eting»**; (b) **108 tavsif 30 darsda** qayta yozildi (UZ+RU parallel), UserStory usuli bilan: «to'g'ri/o'zingiz/to'liq» to'ldiruvchilari, tiredan keyingi tushuntirish quyrug'i va nishon NOMI aytgan takror olib tashlandi. Masalan ❌«Web bo'lakni mobil sahnaga port qilishni — o'sha backendga ulanishni to'g'ri aniqladingiz» (89) → ✅«Web bo'lakni mobil sahnaga ko'chirdingiz» (39) · ❌«ME'MOR sifatida sxema savolini to'g'ri yechdingiz — id SERIAL PRIMARY KEY» (73) → ✅«Sxema savolini to'g'ri yechdingiz» (32, chunki nishon nomi allaqachon «Blueprint!»).
**Natija (dasturiy o'lchov):** 319 nishon · 52 belgidan uzun **0 ta** · max **52** · median **42** (avval median 45, max 89) · tavsifsiz nishon 0.
**Qonunlashtirildi:** **101-qonun** (`PM_DARS_ETALON.md`, barcha darslarga) — bayram qatlamlari, 48 belgi chegarasi, e'lon-sarlavha taqiqi, nom↔tavsif takrori taqiqi, residue-grep. Korpus **63-bo'lim** (qisqartirish usuli 3 band bilan).
**Darvozalar:** esbuild **127/127 toza** ✓ · `acu-eyebrow">` qoldig'i **0** ✓ · `lint:til` — o'zgargan 635 qatorning **birortasida ham** topilma yo'q (mavjud 🔴lar boshqa qatorlarda, oldindan bor) ✓ · `lint:prompt` 0 ✓ · UZ/RU juftligi 108/108 saqlandi ✓ · nishon soni 319 — o'zgarmadi ✓.
**QOLGAN (siz hal qilasiz):** `<Confetti />` faqat 2 darsda ortiqcha (`NestArchPracticeLesson`, `FullPipelineProjectLesson`) · 3 ta nishon nomi 18 belgidan uzun (`Full Stack Explorer` · `Cleared for Takeoff` · `One Tower vs District`). UNCOMMITTED.

## 2026-08-01 — F-0801-11: Htmllesson1 s9 (Telegram-formatlash) IKKINCHI-QADAM AFFORDANSI — ✅
**Foydalanuvchi tashxisi:** «shuni bosish kerakligini zo'rg'a topdim. Men ham birinchi qarashda **xabarni** bosaman deb o'yladim. **B/I menyusi bosilishini esa darrov anglamadim**.» — muallifning o'zi topolmagan bo'lsa, o'quvchi umuman topmaydi.
**Ildiz-sabab (bug-sinfi, nomlandi):** ko'p-qadamli mexanikada 1-qadam (so'zni bosib belgilash) ko'rinib turadi, **2-qadam** esa pop-up menyu bo'lib ko'z-yo'lidan tashqarida paydo bo'ladi. Ipucha ham yordam bermasdi: «Ustidagi **menyudan** B (qalin) yoki I (yotiq) tanlang» — «menyu» ekranda hech qayerda yozilmagan so'z, o'quvchi uni izlaydi.
**Tatbiq (`src/1-Modull/Htmllesson1.jsx` Screen9) — foydalanuvchi taklif qilgan ikkala yechim ham qo'yildi:**
· **(1) Ipucha** — ❌ «☝️ Ustidagi menyudan B (qalin) yoki I (yotiq) tanlang» → ✅ «**👆 Yuqoridagi B yoki I tugmasini bosing**» (nima=tugma · qayerda=yuqorida · qanday=bosing). Qavs-izohlar olib tashlandi — «qalin/yotiq» tugmaning O'Z `title` ida turibdi (99-qonun: ko'rsatma bir joyda). RU: «👆 Нажмите кнопку B или I сверху».
· **(2) Pulsatsiya** — `.tgm-menu button.pulse` + `@keyframes tgm-breathe`: 2 s davrda bir marta `scale(1)→1.22`, fon yorishadi. 🔴 Muhimi: pulsatsiya **bosilgach o'chadi** (`usedB`/`usedI` bayroqlari) — bajarilgan ish chaqirib turmasin.
· **reduced-motion:** animatsiya o'chadi, **affordans qoladi** — doimiy yorug' fon (`rgba(255,255,255,0.26)`). Harakatni butunlay o'chirish = o'sha muammoni qaytarish.
**Qonunlashtirish:** `DARS_ETALON.md` **§5.9 — «IKKINCHI QADAM AFFORDANSI»** (3 band + tekshiruv-savoli). 📌 Bu MATN emas, UX-qoidasi — shuning uchun KORPUSga emas, ETALONga muhrlandi (retsept B marshruti).
**Darvozalar:** esbuild toza ✓ · `lint:til` **0 error** (14 warn — `retsept` metaforasi ×11, `nuqtali ro'yxat`, kirill-homoglif, `topshiriq-boshlash`; hammasi tegilmagan qatorlarda, oldindan bor) ✓.
**Qarz (keyingi raundga):** shu sinf boshqa darslarda ham bo'lishi mumkin — ko'p-qadamli mexanikalarni (DragDrop, tanlov→qo'yish) 5.9 bo'yicha ko'zdan kechirish kerak. UNCOMMITTED.

## 2026-08-01 — F-0801-12: GitLesson — 2-ekran matni + TASHQI-BOG'LIQLIK ZAXIRA-YO'LI — ✅
**Foydalanuvchi tashxisi:** «kursning eng muhim darslaridan biri, chunki oxirida o'quvchi o'z saytini internetga chiqaradi — shuning uchun iloji boricha muammosiz bo'lishi kerak». Ikki xavf ko'rsatildi: **(1)** `git-scm.com` yotib qolishi (`ERR_CONNECTION_RESET`) → o'quvchi «dars buzilibdi» deb o'ylaydi; **(2)** Git o'rnatish butun kursni OS'ga bog'lab qo'yadi (Windows/Mac/Linux, antivirus, administrator huquqi, restart). Plyus 2-ekran (5 qadam) matniga uchta aniq tuzatish.
**[GATE 1] Foydalanuvchi qarori:** uch variantdan **«Zaxira-yo'l: GitHub web»** tanlandi — dars asosiy yo'lda Git bilan qoladi, lekin har to'siq nuqtasida zaxira ochiladi va **natija-va'dasi har qanday holatda bajariladi**.
**A. 2-ekran matni (`ScreenGoal` · `STEPS`):**
· 2-qadam ❌ «Git dasturini o'rnatamiz» (bola uchun nimani anglatadi?) → ✅ «**Kompyuterimizga Git o'rnatamiz**» + yangi **`sub`** qatori «kodni GitHub'ga yuborish uchun» (nima uchun kerakligi darhol aytiladi).
· 4-qadam ❌ «Loyiha uchun joy ochamiz» (mavhum — qanaqa «joy»?) → ✅ «**GitHub'da yangi loyiha (Repository) yaratamiz**». Chip `repo` → `github.com`: «Repository» endi matnda turibdi, chipda takrorlansa bir ko'rsatma ikki joyda bo'lardi (99-qonun).
· 5-qadam chip ❌ `push` (14 yoshli bola bu so'zni hali bilmaydi) → ✅ **`git push`** — buyruq sifatida o'qiladi.
· Yangi `.step-line` / `.step-sub` qatlami (`step-body` endi ustun) — qadam-kartaga ikkinchi qator sig'adi.
**B. Zaxira-yo'l (yangi `FallbackPanel` + `.dsx-fb*`) — yopiq `details`, kerak bo'lgan ochadi:**
· **O'rnatish ekrani (s3):** `site` qadamiga `help` — **xatoning aynan matni** yozildi (`ERR_CONNECTION_RESET`) va ayb o'quvchidan olindi («bu sizning xatongiz emas»). `dl` qadamiga `help` — Mac/Linux tugma nomlari. Panel ichida: **(1)** saytsiz o'rnatish — `winget install --id Git.Git` · `brew install git` · `sudo apt install git`; **(2)** hech biri ishlamasa — **dars TO'XTAMAYDI**: GitHub'ning o'zida `Add file → Upload files`.
· 🔴 **Darvoza qulflanmasligi:** panel oxirida ochiq ko'rsatma — bajarolmagan qadamni ham belgilab, keyingi ekranga o'ting (aks holda himoya o'rniga yangi devor bo'lardi).
· **Push-amaliyoti (s13):** `clone` qadamining `help` i endi «2-qadamga qayting» degan **boshi berk yo'l** emas — zaxira-panelga yo'naltiradi. Panelda 4 bandli web-marshrut (repo → Add file → Upload files → Commit changes) + «fayl sahifada ko'rindi = kodingiz internetda; bu ham commit».
**Qonunlashtirish:** `DARS_ETALON.md` **§5.10 — «TASHQI BOG'LIQLIK DARSNI TO'XTATMAYDI»** (bosh mezon + 4 band + tekshiruv-savoli). UX/jarayon qoidasi — KORPUSga emas, ETALONga.
**Darvozalar:** esbuild toza ✓ · `lint:til` **TOZA** (0 error, 0 warn) ✓ · `lint:prompt` toza ✓.
**Qarz:** shu sinf boshqa darslarda ham bor — `DeployLesson` (Netlify), `VSCode`/`Takrorlash` darslari tashqi yuklab olishga tayanadi; §5.10 bo'yicha ko'zdan kechirish kerak. UNCOMMITTED.

## 2026-08-01 — F-0801-13: JsIntroLesson (M2-D07) — qisqa yorliqlarda sen-forma → siz-forma — ✅
**Foydalanuvchi tashxisi:** «2-Modulda algoritm — JS intro, 5-qadamida sensirabdi, sizsizlashi kerak edi».
**Topilma (2 joy, bitta sinf):** siz-forma faqat prozada tutilgan, **qisqa yorliqlarda** buzilgan.
· `src/2-Modull/JsIntroLesson.jsx:1067` (Screen1 REJA, «5 qadam» ro'yxatining 5-qadami) — ❌ «O'z algoritmingni tuz» · ru «Составь свой алгоритм». Qolgan 4 qadam neytral ot-birikma, faqat shu bittasi sen-formada edi.
· `:1879` (yakun, `HOMEWORK` sarlavhalari) — ❌ «Sistema top / Algoritm yoz / Shart qo'sh» · ru «Найди систему / Напиши алгоритм / Добавь условие», **izohlari esa siz-formada** («…toping, yozing, qo'shing») — bitta qatorda ikki xil murojaat.
**Tuzatildi:** ✅ «O'z algoritmingizni tuzing» · «Составьте свой алгоритм» · «Sistemani toping / Algoritm yozing / Shart qo'shing» · «Найдите систему / Напишите алгоритм / Добавьте условие». UZ va RU birga (i18n juftligi buzilmadi).
**Tegilmadi (ataylab):** `:1529`, `:1596`, `:1715` — BAJARBOT buyruq-kartalari («Sabzavot sol ×3» · ru «Добавь овощи ×3»). Bu buyruq **o'quvchiga emas, robot-ijrochiga** aytiladi — sen-forma o'rinli va izchil.
**Qonunlashtirish:** matn-topilma → `MATN_KORPUS.md` **64-bo'lim** («QISQA YORLIQ HAM SIZ-FORMADA») — ikkala juftlik + robot-buyrug'i istisnosi + grep-naqshi.
**Darvozalar:** esbuild toza ✓ · `lint:til src/2-Modull/JsIntroLesson.jsx` **TOZA (0 error, 0 warn)** ✓.
**Qarz (o'lchandi, tuzatilmadi):** shu sinf repo bo'ylab bor — ru ты-imperativ grepi `src/` da **230 topilma / 48 fayl** (ko'pi PracticeLesson2/4, React/Bot/Skill darslari), uz `\w+ingni` — 8 topilma (PmJtbdLesson, PmLesson4/8/23, RoutingLesson). Har biri qo'lda ko'rilishi kerak (robot-buyruqlari va kod-satrlari istisno) — shuning uchun `til-lint-rules.json` ga avto-qoida QO'YILMADI: 230 warn shovqin bo'lib, darvozani ko'r qilardi. Alohida sweep-raundida ko'riladi. UNCOMMITTED.

## 2026-08-01 — F-0801-11 · FLASHCARD EKRANI: o'lik bo'sh joy yo'qotildi (76 dars) — ✅
**Kelib chiqishi:** 1+2-Modul vizual auditi (real Chrome, 27 dars × har ekran × 3 o'lcham = 1542 o'lchov; animatsiya tinchlangach har ekran IKKI marta o'lchandi, faqat ikkalasida chiqqan topilma qabul qilindi — bu filtr 2 ta yolg'on topilmani rad etdi).
**Flashcard bo'yicha tashxis:** ekran 27/27 da **sig'may qolmaydi** (0 px) — muammo teskari: karta tepaga yopishib, **ostida ~300px o'lik bo'sh joy** qolardi (1366×768). Sabab: `.fc-center { display:flex; justify-content:center }` — `flex:1` ham, vertikal markazlash ham yo'q; `.fc-card` balandligi esa `clamp(160px,26vw,188px)` — ekran BALANDLIGIGA emas, KENGLIGIGA bog'langan (past-keng ekranda foydasiz).
**Tuzatildi (76 darsda bir xil, 390 tahrir):**
· `.fc-center` → `flex:1; min-height:0; align-items:center` — blok bo'sh maydonni egallaydi va markazlashadi
· `.fc-card` balandligi → `clamp(188px,27vh,268px)` — endi ekran balandligiga qarab o'sadi (26vw → 27vh)
· `.fc` kengligi 480 → 520px
· `.fc-actions`/`.fc-hint` ga `min-height:48px` — karta ag'darilganda sakramaydi (avval hint↔tugmalar balandligi farqidan ~30px sakrardi)
**Natija (o'lchangan):** karta 188 → **207px** · kartadan pastdagi bo'sh joy ~300 → **~181px** (shundan 48px — tugmalar qatori) · 27 dars × 3 o'lcham (1366/1280/1024) **sig'maslik 0**, kartadan toshgan matn **0**.
**Darvozalar:** esbuild 127/127 toza ✓ · `vite build --config vite.m1.config.js` toza ✓ · tuzatishdan keyin flashcard ekrani qayta o'lchandi: **0 muammo** ✓.
**⚠️ QOLGAN (tasdiqlanmagan, alohida raundga):** audit topgan asosiy nuqson — **26/27 darsning YAKUNIY ekrani 1366×768 da sig'maydi** (o'rtacha 245px, max 399px); o'rta ekranlarda 31 joy; nav paneli ostida qolgan 22 tugma/matn. Ildiz-sabab: 27 darsda `@media (max-height)` **0 ta**, vertikal bo'shliqlar `vw` ga bog'langani uchun 1366px da maksimumga chiqadi. Hisobot va 200+ screenshot saqlangan. UNCOMMITTED.

## 2026-08-01/02 — F-0801-01: TEXNIK DARSLARDA KOMPILYATOR TAB-QAYTISHDA YOPILARDI (9 fayl + infra) — ✅
**Kelib chiqishi:** PM darslaridagi F-0801-01 tuzatilgach foydalanuvchi «texnik darslarniyam qivor, lekin tex darslarda bunday muammo ko'rmagandim — bitta testlab ko'rchi» dedi. Ya'ni **avval o'lchov, keyin tuzatish**.
**Brauzer-testi (playwright-core + Chrome, `_test102.mjs`):** praktika ochish → kod yozish → `page.reload()` (= Chrome Memory Saver fon-tabni bo'shatib qaytganda). Tuzatishdan OLDIN `Htmllesson1`: **oyna ❌ · kod ❌** — ya'ni texnik darsda holat PM darsidan YOMONROQ edi (PM'da kod saqlanardi, bu yerda umuman yo'q).
**Nega sezilmagan:** texnik darsda dars-ichi praktikasi **erkin rejimda ochilmaydi** (2026-07-29 qoidasi — faqat jonli darsda majburiy); mustaqil o'quvchi unga faqat yakun-sahifadagi «Uyga vazifa» orqali kiradi. Shuning uchun duch kelish chastotasi past bo'lgan.
**🔴 Yo'lda topilgan tuzilma-fakti:** har texnik dars markaziy `src/compilator/HtmlCompiler.jsx` dan import QILMAYDI — har birining **o'z ichki nusxasi** bor. Infra-manbani tuzatish darslarga tarqalmaydi. Bu faqat test tufayli aniqlandi (tuzatish ishlamagach sabab qidirildi).
**Tatbiq (9 dars + infra):** `Htmllesson1` (pilot, qo'lda) · `Htmllesson2` · `CssLesson1` · `CssLesson2` · `CssPractice` · `HtmlPractice` · `HtmlTakrorlashLesson` · `VsCodeLesson` · `PracticeLesson1` (8 tasi `_apply102.py` skripti bilan, har almashtirish 1-moslik tekshiruvi ostida) + `src/compilator/HtmlCompiler.jsx` (kelgusi darslar uchun). Naqsh: `ccPractice:<lessonId>` (qaysi praktika ochiq) + `ccCode:<lessonId>:<kind>` (yozilgan kod, 400ms jonli saqlov) + mount'da tiklash + eskirgan saqlovni tashlash.
**🔴 Skript yo'l qo'ygan xato (o'z vaqtida tutildi):** `codes` boshlang'ich qiymati hamma faylda `f.starter` deb tekislangan edi — `CssLesson1` da esa asli `tr(f.starter)` (UZ-RU). Natija: `css.trim is not a function` → oq ekran. Brauzer-testi buni tutdi (`CssLesson1: kompilyator ochilmadi`), `git stash` bilan «meningmi yoki oldindanmi» aniqlandi va qaytarildi. **Sabot:** bir naqshni N faylga skript bilan yoyganda har faylning O'Z ifodasi tekshirilishi shart.
**Darvozalar:** esbuild **10/10 toza** ✅ · `vite build` toza ✅ · brauzer-testi **8/8 dars: oyna ✅ kod ✅** ✅ · ikkinchi yo'l (dars-ichi praktikasi `kind:'sN'`) tiklanadi ✅ · eskirgan saqlov (`s99`) jimgina tozalanadi ✅ · o'quvchi-matni o'zgarmadi (`lint:til` shart emas).
**Qonunlashtirish:** `DARS_ETALON.md` → yangi **11-D bo'lim** (102-qonunning texnik tomoni: ikki saqlov, tiklash, fayl-to'plami mosligi sharti, `tr(f.starter)` ehtiyoti, har darsda ICHKI nusxa fakti) + 12-bo'lim bug-jadvaliga qator. PM tomonida **102-qonun** allaqachon `PM_DARS_ETALON.md` da.
**Qamrovdan tashqari:** `JsFunctionsLesson` · `NestArchAliveLesson` · `AiPipelineProjectLesson` · `CiCdIntroLesson` · `FullProPipelineLesson` — bularda kompilyator YO'Q (fayl izohida aniq yozilgan: «HtmlCompiler YO'Q, o'quvchi VS Code/GitHub'da bajaradi»). UNCOMMITTED.

## 2026-08-02 — F-0802-01…06: JsIntro REJA-EKRANI + DARSNI YOPUVCHI FIKR (M2-D1) — ✅
**Kelib chiqishi:** foydalanuvchi 2-Modul QA raundini boshladi; birinchi topilma — `JsIntroLesson` 1-ekrani (Reja) va darsning yakuniy natijasi.
**F-0802-01 «sir» taqiqi** (`JsIntroLesson.jsx:1061` audio + `:1101` Mentor uz/ru): «Sizga bir sirni aytaman…» — sun'iy intriga, ortidan oddiy ta'rif keladi. → «Kod yozishni boshlashdan oldin yaxshi dasturchilar muammoni qanday hal qilishni o'ylaydi… ikkita kuchli vosita: sistema va algoritm… keyingi darslarda ularni JavaScript'da ishlatamiz.» Qo'shimcha yutuq: «tushuncha» → **vosita**, oxirida keyingi darsga **ko'prik**. ru ham qayta yozildi («Открою вам секрет» olib tashlandi).
**F-0802-02 SISTEMA kartasi** (`:1077`): «Birga ishlaydigan qismlar **+** bog'lanishlar» — `+` formula. → «Bir nechta qismlar birgalikda ishlasa — sistema hosil bo'ladi.» (ta'rif emas, hodisa).
**F-0802-03 ALGORITM kartasi** (`:1081`): «Aniq qadamlar: ketma-ketlik, shart, sikl» — uchala atama hali o'tilmagan, birinchi ekranda berish = uchalasini yo'qotish. → «Maqsadga olib boradigan aniq qadamlar.»
**F-0802-04 ost-matn** (`:1084`): «→ shu uch qism bilan istalgan algoritm yoziladi» — texnik + «uch qism» endi havoda. → «→ Har qanday dastur aynan shu ikki g'oyadan quriladi». (Foydalanuvchi «uchta g'oya» degan edi; kartada 2 g'oya qolgani uchun «ikki» qilindi — tasdiqlandi.)
**F-0802-05 reja 4-qadami** (`:1066`): matn «Shart va sikl» / yorliq «agar · takrorla» — atama tashqarida, tanish so'z ichkarida (teskari). → matn «Shart va **takrorlash**» / yorliq «agar · **sikl**».
**F-0802-06 darsni yopuvchi fikr (YANGI, tuzilmaviy):** foydalanuvchi kutgan natija — o'quvchi dars oxirida **«Har qanday ilova — bu sistema. Sistema ichida esa algoritmlar ishlaydi.»** deya olishi. Bu gap darsda umuman yo'q edi: sistema va algoritm alohida-alohida o'rgatilib, bir-biriga bog'lanmasdan qolardi (RECAP — sanoq ro'yxati, xulosa emas). Yakun-ekraniga (`Screen16`) hero+ScoreRing dan keyin, CodeStrike CTA dan oldin **kichik «🧠 Bugungi asosiy fikr —»** bloki qo'shildi; `s16` audio matni ham shu gapga tenglashtirildi. **Flashcardga qo'shilmadi** — foydalanuvchi qoidasi: flashcard faqat darsda O'TILGAN atamalarni takrorlaydi, yopuvchi fikr — sintez.
**Darvozalar:** esbuild toza ✅ · `lint:til` 0 topilma (64 qoida) ✅ · `lint:prompt` 0 topilma ✅ · residue-grep `sir|sirni|секрет` — o'quvchi-matnida 0 (qolgani kod izohlari va «ta'sir» so'zi) ✅.
**Qonunlashtirish:** `MATN_KORPUS.md` → **65-bo'lim** («sir» taqiqi + grep) va **66-bo'lim** (karta-osti: ta'rif emas hodisa; atama-sanog'i taqiq; «ko'rinadigan matn — tanish so'z, kichik yorliq — atama» naqshi). `DARS_ETALON.md` → yangi **4.2-A bo'lim / 103-qonun** (dars bitta gap bilan yopiladi: joyi, hajmi, ohangi, audio-mosligi, flashcardga qo'shilmasligi).
**⚠️ Yo'lda topilgan, TUZATILMAGAN:** `JsIntroLesson` yakun-ekranida **GLOSSARY bloki bor** (`Screen16`, «💡 Kalit so'zlar») — `DARS_ETALON` 4.2 esa uni yakun sahifasida taqiqlaydi (Flashcard takrorlaydi). Foydalanuvchiga aytilgan, qarori kutilmoqda. UNCOMMITTED.

## 2026-08-02 — F-0802-11/12: TEST-SAVOLI TIPOGRAFIYASI 111 DARSGA (105-qonun) — ✅
**Kelib chiqishi:** foydalanuvchi PmLesson4'ning 4-sahifasidagi testga «5.5/10» baho qo'ydi: «savol juda katta shrift bo'lganiga tag ma tag tushib ancha pastlagan, bu o'qish tugul ko'rgim ham kelmadi… boshqa testlardayam yaxshilaylik».
**Tashxis (o'lchov bilan):** savol `.h-title` = `clamp(22px,4vw,38px)` + `.title` dan `line-height: 1.1`. Bu klass **2-5 so'zlik sarlavha** uchun; test savoli 10-20 so'z → 680px tor ustunda 3-4 qatorga bo'linadi va qatorlar yopishadi. Variantlar esa 16px — savol variantdan **2.4×** katta, ya'ni o'quvchining asosiy ishi eng mayda joyda. 🔴 **Etalon repo ICHIDA allaqachon bor edi:** arena `.qz-q` savolni `clamp(19px,3.2vw,28px)` + `lh 1.35` + `text-wrap: balance` bilan chizadi — ichki testlar shundan chetda qolgan (bir platformada ikki xil savol-tipografiyasi).
**Yechim — yangi `.h-ask` klassi:** `font-size: clamp(19px,2.6vw,27px); line-height: 1.32; letter-spacing:-0.01em; text-wrap: balance`. `.h-title` (sarlavha) va `.h-sub` (yakun-subtitr) **tegilmadi** — savol ulardan AJRATILDI, aks holda ikki ehtiyoj bitta klassda kurashadi. Variantlar: `clamp(15px,1.85vw,17px)` · `line-height:1.45` · padding `clamp(13px,1.9vw,17px) clamp(15px,2.2vw,20px)` · orasi 9→11px. Savol÷variant **2.4× → 1.6×**.
**Qamrov (skript `apply_hask.py`, har almashtirish moslik-sanog'i bilan):** **111 fayl** — `css-hask` 110 (`.h-ask` e'loni) · `q-hsub` **514** savol-sarlavhasi (`title h-sub`→`title h-ask`) · `q-htitle` 8 PM darsi (`const Q` naqshi: PmLesson3–10) · `opt-lh` 111 · `opt-size` 124 · `opt-gap` 109.
**🔴 Skript qamrab olmagan 6 fayl qo'lda yopildi:** `NestArchPracticeLesson · NestArchResourceLesson · FullPipelineProjectLesson · GithubActionsLesson · ArchPatternsLesson · ReactNativeAppLesson` — ularda `.option` qoidasi `font-family: 'Manrope'` (qolganlarda `'Manrope', sans-serif`). O'lchov bilan topildi: «option-CSS bor 111 / lh qo'shilgan 105». **Sabot (F-0801-01 saboqining takrori):** bir naqshni N faylga yoyganda «hammasi bir xil» deb faraz qilinmaydi — QAMROV SANALADI va farq qolgani alohida yopiladi.
**🔴 `gap: 9` xavfi chetlab o'tildi:** bu satr 278 joyda bor, lekin faqat 109 tasi variant-ro'yxati (qolgani boshqa vertikal ro'yxatlar). Regex `{options.map(` bilan bog'landi — aks holda darslar bo'ylab aloqasiz bo'shliqlar o'zgarardi.
**F-0802-12 savol matni** (`PmLesson4.jsx` Screen3): «Saytga yangi imkoniyat taklif qilindi: bosh sahifada fon musiqasi. Uni qo'shishdan oldin qaysi savolga javob topiladi?» (15 so'z) → «🎵 Saytga fon musiqasi qo'shmoqchisiz. Avval qaysi savolga javob berish kerak?» (10 so'z). Shaxssiz «taklif qilindi/javob topiladi» → o'quvchi qaror qiluvchi «qo'shmoqchisiz/javob berish kerak».
**Darvozalar:** esbuild **127/127 toza** ✅ · `vite build` toza (1.48s) ✅ · dasturiy tekshiruv: `title h-ask` ishlatgan har faylda `.h-ask {` e'loni bor — «ishlatgan, e'lon qilmagan» **0** ✅ · dublikat e'lon **0** ✅ · `.option` da `line-height:1.45` **111/111** ✅ · `lint:prompt` 0 topilma ✅. (`PmJtbdLesson`, `PmUserStoryLesson` — `.h-ask` e'lon qilgan, ishlatmagan: ularda savol boshqa naqshda; zararsiz, kelgusi tahrirga tayyor.)
**Qonunlashtirish:** `PM_DARS_ETALON.md` → **105-qonun** (`.h-ask` standarti, 5 band + dasturiy o'lchov) va **105b** (savol matni bir nafasda o'qiladigan). `DARS_ETALON.md` → yangi **4.3-bo'lim** (texnik darslar uchun CSS-blok + qamrov). `MATN_KORPUS.md` → **68-bo'lim** (savolni qisqartirishning uch usuli: sahna-tafsilotini kes · shaxssiz fe'lni o'quvchiga qarat · emoji so'z o'rnini bossin; o'lchov 12 so'z).
**⚠️ Javobsiz qolgan fidbek-bandi:** foydalanuvchining «2. Variantlar "test"ga o'xshaydi» bandi yarim uzilgan (matn-ohangimi yoki ko'rinishmi — aniqlanmagan), so'ralgan, javob kutilmoqda. UNCOMMITTED.

## 2026-08-02 — F-0802-15: DARSLIK OQ EKRAN (`chip is not defined`) + YANGI DARVOZA `lint:jsx` — ✅
**Kelib chiqishi:** foydalanuvchi darslikni ochdi — **oq ekran**, konsolda `Uncaught ReferenceError: chip is not defined at PmLesson4 (PmLesson4.jsx:3851)`.
**Sabab — o'zim kiritganman (F-0802-13 tahririda):** `.mt-card` CSS'iga izoh yozdim va unda backtik ishlatdim — `` Qatorga tushgach `.mt-chip.in` ga aylanadi ``. Dars CSS'i esa `<style>{` … `}</style>` **shablon-satrida** yashaydi: izohdagi backtik satrni **erta yopdi**, undan keyingi matn JS sifatida o'qildi va `chip` identifikatoriga aylandi.
**🔴 ENG MUHIMI — bu xato-sinf repoda ALLAQACHON hujjatlashtirilgan edi:** `DARS_ETALON.md` 12-bo'lim bug-jadvalida 2026-07-28 dan beri qator turibdi, hatto TO'G'RI diagnostika usuli bilan («`<style>{\`` va `` \`}</style> `` orasidagi matnni ajratib, backticklarni sanash — 0 bo'lishi shart»). Ya'ni bilim bor edi, men uni o'qimadim va aynan o'sha xatoni takrorladim. Bu F-0802-14 dagi saboqning **aynan takrori boshqa qatlamda**: 60-qonunda «qonun yozilishi ≠ tatbiq», bu yerda «bug-jadvalidagi eslatma ≠ darvoza».
**🔴 Darvoza-bo'shlig'i (asosiy xulosa):** `esbuild` **toza** edi va `vite build` ham **toza** edi — ikkalasi ham sintaksisni tekshiradi, buzilgan esa MA'NO. Ya'ni mavjud darvozalarim bu sinfni prinsipial ravishda ushlay olmaydi va nuqson to'g'ri foydalanuvchiga yetib bordi.
**Yechim — yangi avtomatik darvoza `jsx-lint.mjs` (`npm run lint:jsx`), ikki sinfni tutadi:**
· **(1) CSS ichida backtik** — har `<style>{`…`}</style>` bloki ajratiladi va ichidagi backtik sanaladi (fayl:qator + qatorning o'zi bilan hisobot).
· **(2) bir-qatorli funksiya ichida `//` izoh** — F-0802-14 sinfini qamrab oladi (izohdan keyin o'sha qatorda yopiluvchi `}` bo'lsa → xato).
· **Kalibrovka:** birinchi ishga tushirishda 1 ta yolg'on-ijobiy chiqdi (`FullstackConnectPracticeLesson.jsx:1133` — kod-namunasi ichidagi `"http://localhost:3000/…"`). Detektor **satr-literallarini hisobga oladigan** qilib qayta yozildi (qavs-holati kuzatiladi, `://` istisno) — endi qo'shtirnoq ichidagi `//` va `=> {` signal bermaydi.
· **Detektorning O'ZI sinovdan o'tkazildi** (ataylab buzilgan probe-fayllarda): CSS-backtik ✅ tutildi · izoh-o'rtada ✅ tutildi · izoh-oxirida (xavfsiz) ✅ o'tkazildi · ko'p qatorli funksiya (xavfsiz) ✅ o'tkazildi · `http://` ✅ o'tkazildi.
**Darvozalar:** `lint:jsx` **127 fayl · 0 topilma** ✅ · esbuild 127/127 toza ✅ · `vite build` toza (1.43s) ✅.
**Qonunlashtirish:** `DARS_ETALON.md` 12-bo'lim — mavjud backtik-qatoriga «endi QO'LDA emas, `npm run lint:jsx`» izohi + **yangi qator** (bir-qatorli funksiya ichida `//` izoh). `package.json` → `lint:jsx` skripti.
**✅ Foydalanuvchi tasdig'i olindi («ha qo'sh»):** `lint:jsx` `CLAUDE.md` 4-bo'limiga **majburiy darvoza** sifatida qo'shildi — `.jsx` tahrirlangan har seansda 0 topilma shart, izohida nega esbuild/`vite build` yetmasligi va ikkala xato-sinf yozilgan. UNCOMMITTED.

## 2026-08-03 — F-0803-09: JsVarsLesson'ga YENGIL PRAKTIKA-KOMPILYATORI (9.4-qonun bo'shlig'i) — ✅
**Kelib chiqishi:** foydalanuvchi: «1-navbatda kompilyator — masalan HtmlPractice 1-2 larni ko'r, shunaqa praktika bu darsimizdayam yengil qilishimiz kerak, to'g'rimi?».
**Tashxis (o'lchov bilan):** `JsVarsLesson.jsx` da praktika-kompilyator **umuman yo'q edi** — `PRACTICE_AFTER` 0, `HtmlCompiler` nusxasi 0, `pracRead/codesRead` (102-qonun) 0. `DARS_ETALON.md` 9.4 esa har texnik darsda **AYNAN 3 praktika-compiler** talab qiladi. Yagona «yozish» — `s15` dagi bitta `<input>` + regex (kod ishga tushmaydi, natija ko'rinmaydi). Foydalanuvchining «yengil» talabi ham to'g'ri: HtmlPractice/PracticeLesson1 praktikasi 2 faylli (`index.html`+`script.js`) va DOM-tekshiruvli — bu birinchi JS darsiga og'ir.
**Yechim — YENGIL rejim (dvijok o'zgarmadi, konfiguratsiya o'zgardi):** kompilyator qatlami `PracticeLesson1.jsx` dan ko'chirildi (bir xil dvijok, 10-qoida: har darsning o'z ichki nusxasi). Yengillik `task.files` orqali: **bitta fayl `script.js`** → `showConsole` yonadi va o'quvchi natijani **🖥️ Console** panelida ko'radi; HTML/DOM/preview yo'q; shartlar 2-3 tadan; starter faqat `// Bu yerga yozing` (11.9).
**3 topshiriq (527-qonun — faqat o'sha ekrangacha o'tilgani so'raladi):** `6` (s5b, let o'tilgan) **TASK_BALL** — `let ball = 0` → `ball = 25` → konsolda `25` · `13` (s12, tur+qo'shtirnoq o'tilgan) **TASK_QUOTES** — `console.log(5 + 5)` → `10` va `console.log("5" + "5")` → `55` (s11 sirining o'z qo'li bilan tasdig'i) · `16` (s15, o'zi bitta qator yozgandan keyin) **TASK_OMBOR** — `let ism` (qo'shtirnoqda) + `let yosh` (raqam) + `const tugilgan_yil`. Narvon: s15 bitta qator → P3 uch quti.
**Uy vazifasi bilan bog'landi:** yakun-sahifadagi «Uyga vazifa» kartasi matni AYNAN `TASK_OMBOR` (ism/yosh/tugilgan_yil) — kartaga `✍️ Kompilyatorda yozib tekshirish →` tugmasi qo'shildi, u shu topshiriqni ochadi (`kind: 'hw'`, serverga «bajardim» signali yubormaydi). Dars-ichi praktikasi esa boshqa darslardagi kabi **faqat jonli darsda** ochiladi (2026-07-29 qarori) — mustaqil o'quvchi majburlanmaydi.
**102-qonun (tab-qaytish) tatbiq qilindi:** `ccPractice:js-vars-01-v18` (qaysi praktika ochiq) + `ccCode:js-vars-01-v18:<kind>` (yozilgan kod, 400ms jonli saqlov); `reset()` ikkalasini tozalaydi. Mentor uchun `MentorPracticeOverlay` (kim tugatdi + «Doskada yozib ko'rsatish») va `.mp-*` CSS ko'chirildi.
**Darvozalar:** esbuild toza ✅ · `vite build` toza (1.54s) ✅ · `lint:jsx` — JsVars 0 topilma ✅ · `lint:til` 0 topilma (64 qoida) ✅ · `PRACTICE_AFTER` kalit-sanog'i **3** ✅ (9.4).
**Brauzer-sinovi (`_prac-smoke.mjs`, playwright-core + Chrome):** yakun-sahifa → «Uyga vazifa» → kompilyator ochildi ✅ · to'g'ri yechim yozilganda **3/3 shart ✓ «Barcha shartlar bajarildi!»** va «Davom etish» faollashdi ✅ · runtime `log_includes` yo'li alohida tekshirildi: konsol chiqishi `"25 10 55"` → P1/P2 shartlari ✅ · sahifa xatolari 0 ✅. (Sinov davomida chiqqan `localStorage … sandboxed` xatosi **testning o'z `addInitScript`idan** edi — sandbox'li preview-iframe'da ham ishga tushgan; dars kodiga aloqasi yo'q, test try/catch bilan yopildi.)
**Qonunlashtirish:** yangi qonun kerak emas — bu 9.4/11.9/102 qonunlarining bajarilmagan tatbig'i edi. UNCOMMITTED.

## 2026-08-03 — F-0803-10: JsVarsLesson 4-ekrani (`s3`, «=» qiymat berish) — TAKROR KESILDI — ✅
**Kelib chiqishi:** foydalanuvchi: «bir xil g'oya 4 marta takrorlangan… robot-qo'l matni shart emas, rasmning o'zi ko'rsatib turibdi… feedbackni bitta qatorda qilardim… nomsiz quti challenge'ini qora tugma qilardim… mentor matni yanada tabiiyroq: Matematikada = "teng" degani, dasturlashda esa "qutiga joylashtir"».
**Tashxis (sanoq bilan):** `s3` da bitta g'oya **4 marta** aytilgan edi — (1) kod-namuna `let ism = "Bobur"` · (2) `VarBox` quti vizuali · (3) «🤖 Robot-qo'l `ism` qutisini topdi va ichidan `"Bobur"` ni tortib chiqardi» (paragraf) · (4) «✓ Tayyor! `ism` qutisida endi `"Bobur"` turibdi — nomi orqali istalgan payt o'qiysiz» (paragraf). 3 va 4 — sof takror: ikkalasi ham yonidagi vizual allaqachon ko'rsatgan narsani so'z bilan qaytaradi.
**Tuzatishlar (4 ta, foydalanuvchi taklifi bo'yicha):**
· **Robot-paragraf → natijaning O'ZI:** `🤖 ism → "Bobur"` (mono, `pop-num` animatsiyasi bilan). Matn emas — sxema; tarjima talab qilmaydi.
· **Yakuniy hukm bitta qatorga:** «✓ Tayyor! … nomi orqali istalgan payt o'qiysiz» → **«✓ Endi `ism` ni chaqirsangiz `"Bobur"` qaytadi.»** Qisqargani ustiga YANGI ma'no qo'shadi (kelasi zamon = o'qish qayta-qayta ishlaydi).
· **Challenge ko'rinar bo'ldi:** «❓ Nomsiz qutini chaqirib ko'ring» `btn-ghost` (ko'rinmas, 13px) → **`btn` (qora)**, bosilgach xiralashadi. Bu ekrandagi eng qimmatli kashfiyot edi, lekin eng zaif tugmada turgan edi.
· **Mentor matni — qarama-qarshi juftlik:** «Kodda `=` "teng" degani emas — u "qutiga sol" degani!» (inkor + undov) → **«Matematikada `=` — «teng» degani. Dasturlashda esa `=` — «qutiga joylashtir» degani.»** `s3` audio matni ham shunga tenglashtirildi (matn-audio mosligi).
**Darvozalar:** esbuild toza ✅ · `lint:til` 0 topilma ✅ · `lint:jsx` — JsVars 0 topilma ✅ · brauzer-sinovi (Chrome, 1440×900): ekran render bo'ldi, oqim (chip → kod → quti → 🤖 o'qi → natija → qora challenge → bitta qatorlik hukm) ishladi, sahifa xatolari **0** ✅.
**Qonunlashtirish:** `MATN_KORPUS.md` → **72-bo'lim** («interaktiv ko'rsatganini matn qaytarmasin»; o'lchov: bir ekranda bitta g'oya maks 2 marta) va **73-bo'lim** («atamani kundalik bilim bilan qarama-qarshi qo'ying» naqshi). UNCOMMITTED.
**⚠️ Keyingi nomzod (tuzatilmagan, sizning qaroringiz):** shu ekranning chap ustunida «O'qiymiz: «"Bobur" ni `ism` qutisiga sol»» ramkasi qoldi — u endi Mentor gapining uchinchi shakli. Kod o'qishni o'rgatgani uchun saqlab qoldim; aytsangiz olib tashlayman.

## 2026-08-03 — F-0803-11: JsVars 17-sahifasidan «🌯 Loyihaga ko'prik» OLIB TASHLANDI — ✅
**Kelib chiqishi:** foydalanuvchi: «17-pagedagi backgroundda qizil: "Loyihaga ko'prik… lavash do'koni sayti… let narx = 25000" — shu umuman kerakmas, to'liq olib tashlaylik, ehtiyotkorlik bilan».
**Tashxis:** `s15` (17-sahifa) ning yagona ishi — o'quvchi **birinchi o'zgaruvchisini o'zi yozishi**. Yozib bo'lgan lahzada kelajakdagi loyiha haqida qo'shimcha ramka chiqishi g'alaba-lahzasini suyultiradi va 92-qonunga («bir ekran — bir ish») qarshi ishlaydi: mashq bajarildi, lekin ekran yana o'qishga chaqiradi.
**Bajarildi (ehtiyotkorlik bilan, 3 nuqta):** `ProjectBridge` komponenti e'loni o'chirildi · `Screen15` dagi yagona ishlatilishi olib tashlandi va o'ralgan `<>…</>` fragmenti soddalashtirildi (ortiqcha o'ram qolmadi) · `grep ProjectBridge` → **0** ✅. `.frame-soft` CSS qoldirildi — u faylda yana **6 joyda** ishlatiladi (o'lik CSS emas).
**Darvozalar:** esbuild toza ✅ · `vite build` toza (1.54s) ✅ · `lint:til` 0 topilma ✅ · brauzer-sinovi: 17-sahifa render bo'ldi, `let ism = "Aziza"` yozilganda 4 ta chip ✓ va yashil hukm chiqdi, sahifa DOM'ida «Loyihaga ko'prik» **yo'q**, xatolar 0 ✅.
**⚠️ Diqqat (sizning qaroringiz):** aynan shu `ProjectBridge` bloki **`JsConditionsLesson.jsx` va `JsLoopsLesson.jsx`** da ham bor (modul-ipi naqshi). Faqat JsVars'dan olindi — qolgan ikkitasi tegilmadi. Aytsangiz ularni ham tozalayman va naqshni butunlay bekor qilamiz. UNCOMMITTED.

## 2026-08-03 — F-0803-12: «🌯 Loyihaga ko'prik» M2 ning qolgan 2 darsidan ham olib tashlandi — ✅
**Kelib chiqishi:** foydalanuvchi: «ha ularniyam tozala, ehtiyotkorlik bilan» (F-0803-11 ning davomi).
**Bajarildi (har faylda bir xil 2 nuqta):** `JsConditionsLesson.jsx` (s15, `if (soni > 10)` ko'prigi) va `JsLoopsLesson.jsx` (s15, `for` menyu ko'prigi) — komponent e'loni o'chirildi + `Screen15` dagi yagona ishlatilishi olib tashlandi, ortiqcha `<>…</>` o'ramlari soddalashtirildi.
**Qoldiq-tekshiruvi (residue-grep, butun `src/`):** `ProjectBridge` · `Loyihaga ko'prik` · `Мост к проекту` → **0 topilma** ✅. `.frame-soft` CSS ikkala faylda ham qoldirildi (JsCond 4, JsLoops 5 joyda ishlatiladi — o'lik CSS emas).
**Darvozalar:** esbuild ikkala fayl toza ✅ · `vite build` toza (1.78s) ✅ · `lint:til` ikkalasi 0 topilma ✅ · `lint:jsx` bu 3 faylda 0 ✅ · brauzer-sinovi (Chrome 1440×900, ikkala darsning 17-sahifasi): «Oxirgi qadam: if ni o'zingiz yozing» va «Oxirgi qadam: for siklini o'zingiz yozing» render bo'ldi, DOM'da ko'prik **yo'q**, sahifa xatolari **0** ✅.
**Natija:** «🌯 Loyihaga ko'prik» naqshi 2-Modul texnik darslaridan **butunlay bekor qilindi** (3/3 dars). Yakuniy mashq ekrani endi bitta ish bilan yopiladi: o'quvchi kodni o'zi yozadi → bitta hukm → keyingi ekran. UNCOMMITTED.

## 2026-08-03 — F-0803-13: FLASHCARD JAVOBI QISILIB QOLARDI — tashxis + JsVars pilot — ✅ (yoyish kutilmoqda)
**Kelib chiqishi:** foydalanuvchi 2-Modul flashcard skrinshotini tashladi: «qisilib qolgan matn, ko'p bo'lsa sababi nima?» — javob `let o'zgaradi, const o'zgarmaydi` karta chetlariga tegib turibdi, izoh esa pastki yumaloq chetga yopishgan.
**Tashxis (brauzerda o'lchov bilan takrorlandi, 1280×648):** uch sabab bir joyda —
· **(1) Shrift javob uzunligiga qaramaydi (asosiy):** `.fc-tag { font-family:'JetBrains Mono'; font-size: clamp(30px,6vw,46px) }` — bu **bir so'zlik** javob (`let`, `=`, `string`) uchun tanlangan o'lcham, lekin HAMMA javobga qo'llanardi. 32 belgilik gap × 46px mono → 2-3 qator, faqat javob **122px**.
· **(2) Monoshrift gapga qo'llangan:** mono — kod uchun, har harfi bir xil keng; gapni ~25% kengaytiradi. `let`/`const` kod, «o'zgaradi/o'zgarmaydi» esa gap — ikkalasi bir shriftda edi.
· **(3) Karta balandligi qat'iy:** `.fc-card { height: clamp(188px,27vh,268px) }` — `height`, `min-height` emas. 648px balandlikdagi oynada `27vh=175` → pastki chegara **188px**; karta o'sa olmaydi.
· **O'lchov:** kerak **195px** (javob 122 + izoh 19 + padding 44 + gap 10) · bor **188px** → izoh padding qutisidan **4px** pastga chiqadi. `.fc-face` da `justify-content:center` bo'lgani uchun ortiqcha matn ikki tomonga baravar toshadi (yuqorida ham chetga tegadi).
**🔴 Tizimli qamrov (skanerlandi, `back:` maydonlari):** butun `src/` da **891** flashcard javobi · **312 tasi (35%)** 14 belgidan uzun · **74 / 76** darsda uchraydi. Eng og'irlari: `PmLesson6` 10/10 (eng uzuni **73 belgi**), `PmLesson5` 11/12 (67), `PmLesson4` 10/11 (59). Ya'ni JsVars — eng yengil holatlardan biri.
**Yechim (JsVars'da PILOT, foydalanuvchi ko'rishi uchun):**
· **4 pog'onali o'lcham:** `t1` ≤8 belgi `clamp(30px,6vw,46px)` · `t2` ≤16 `clamp(24px,4.4vw,34px)` · `t3` ≤32 `clamp(20px,3.4vw,26px)` · `t4` >32 `clamp(17px,2.6vw,22px)` (+`line-height:1.3`).
· **Kod/gap ajrimi:** `fcIsCode()` — monoshrift FAQAT lug'atdagi kalit so'z (`let, const, var, string, number, boolean, true, false, …`) yoki kod-belgisi (`= ( ) { } ; . [ ] < > + * / % ! & | -`) bo'lgan yakka tokenga. Gap — Manrope; gap ICHIDAGI kalit so'zlar `.fc-kw` bilan mono qoladi (o'quvchi kodni ajratib ko'radi).
· `text-wrap: balance` (qatorlar tenglashadi) + `overflow-wrap: anywhere` (uzun yakka so'z chetdan chiqmaydi) + `max-width:100%`.
· **`.fc-card` balandligi TEGILMADI** — pog'onalash 73 belgilik javobni ham sig'dirgani uchun qat'iy balandlik saqlanib qoldi (kartalar sakramaydi, Quizlet uslubi buzilmaydi).
**Tekshiruv (brauzer, 12/12 karta):** har kartada `kerak/bor` o'lchandi — **toshish 0/12** (avval: 195/188 → 4px toshgan; endi eng og'iri 126/188). `o'zgaruvchi` (o'zbekcha atama) endi Manrope t2, `let`/`const`/`=` mono t1 qoldi. Sahifa xatolari 0 ✅.
**Darvozalar:** esbuild toza ✅ · `vite build` toza (2.68s) ✅ · `lint:til` 0 topilma ✅ · `lint:jsx` JsVars 0 ✅.
**⏭ Keyingi qadam (foydalanuvchi tasdig'i bilan):** shu naqshni qolgan **73 darsga** yoyish — `.h-ask` tarqatuvidagi kabi (F-0802-11) o'lchov-skript bilan, har almashtirish moslik-sanog'i bilan va qamrov SANALADI. UNCOMMITTED.

## 2026-08-03 — F-0803-14: FLASHCARD O'LCHAM-NAQSHI 76 DARSGA YOYILDI (107-qonun) — ✅
**Kelib chiqishi:** F-0803-13 pilotini ko'rgach foydalanuvchi: «ha zo'r bo'libdi, endi qolgan darslarga ham yoy, faqat ehtiyotkorlik bilan aniqlikda».
**🔴 AVVAL QAMROV SANALDI (F-0802-11 sabog'i: «hammasi bir xil» deb faraz qilinmaydi).** Survey-skript uch nuqtaning variantlarini sanadi:
· **ishlatilishi** `<span className="fc-tag">{tr(card.back)}</span>` — **76/76 AYNAN bir xil**, variant 0;
· **`function Flashcards({ cards }) {` imzosi** — **76/76 bir xil**, variant 0;
· **`.fc-card` balandligi** — **78/78 e'lon bir xil** (`clamp(188px,27vh,268px)`);
· **`.fc-tag` CSS qatori — 11 xil variant** (`clamp(22px,4.6vw,36px)` … `clamp(30px,6vw,46px)`; PM darslarda `Manrope`, texnikada `JetBrains Mono`; ba'zisida `text-wrap`/`text-align` qo'shimchalari). Hech birida saqlashga arziydigan noyob xossa yo'q — hammasi yangi blok bilan almashtirildi.
· **2 fayl `.fc-tag` ni IKKI marta e'lon qilgan** (`ReactApiPostLesson`, `ReactIntroLesson` — ikkita `<style>` bloki, e'lonlar aynan bir xil). Skript ularni chetga chiqarmasdan **ikkalasini ham** yangiladi va alohida ro'yxatda ko'rsatdi.
**Yoyish (skript `_fc-rollout.mjs`, avval QURUQ YURISH):** fayl faqat `use === 1 && fn === 1 && css >= 1` bo'lsa yoziladi. Natija: **75 fayl** (+1 pilot = 76) · **chetga chiqqan 0** · almashtirishlar: **CSS 77** (75 + 2 dublikat) · **ishlatilishi 75** · **helper 75**.
**Dasturiy tekshiruv (majburiy):** `fcAnswer(` ishlatgan **76** · `const fcAnswer =` e'lon qilgan **76** · `.fc-tag.t1 {` CSS **76** · eski naqsh qoldig'i `<span className="fc-tag">` → **0** · nomuvofiq fayl **0** ✅.
**Darvozalar:** esbuild — 127 `.jsx` bitta o'tishda sintaksis toza (0 error) ✅ · `vite build` toza (1.44s) ✅ · `lint:jsx` bu ishdan yangi topilma **0** (mavjud 1 topilma — `PmUserStoryLesson:373` uy-vazifa dublikati, bu ishdan oldin ham bor edi) ✅ · `lint:prompt` 0 ✅.
**Brauzer-sinovi (Chrome 1280×648, eng og'ir uch dars):** `PmLesson6` 10 karta — toshish **0**, eng uzuni **73 belgi → t4 · 22px · Manrope · 111/188px** · `PmLesson5` 12 karta — toshish **0** (67 belgi) · `ClaudeSkillsLesson` 12 karta — toshish **0** (34 belgi). Uchalasida sahifa xatolari **0** ✅.
**Qonunlashtirish:** `DARS_ETALON.md` → yangi **11-A bo'lim / 107-qonun** (3 band + dasturiy va brauzer tekshiruvi + sabot: «matn o'zgaruvchan uzunlikda bo'lsa, o'lcham ham o'zgaruvchan bo'lishi shart» — `.h-ask`/105-qonun bilan bir xil xato-sinf). `PM_DARS_ETALON.md` → **107-qonun havolasi** (PM javoblari ko'pincha gap → `t3`/`t4` + Manrope PM uchun odatiy holat, mono — istisno). UNCOMMITTED.

## 2026-08-03 — F-0803-15/16: JsLoops — `s15` OLIB TASHLANDI, o'rniga 2 ta YENGIL PRAKTIKA-KOMPILYATOR — ✅
**Kelib chiqishi:** foydalanuvchi: «JsLoopsLesson darsimizda 17-page'ni olib tashlaylik, chunki hozir 2 ta yengil praktika-kompilator qo'shaylik».
**Nima olib tashlandi:** `s15` (17-sahifa) — «namunani ko'chirib yozing» inputi + ikkita mini-input (while sharti, i++ qadami). U kodni ISHGA TUSHIRMAS edi: o'quvchi namunani ko'chirib yozardi, natijani ko'rmasdi.
**🔴 Ehtiyotkorlik — ekran o'chirish zanjir-ta'sirli, HAR bir xarita yangilandi (DARS_ETALON 2-bo'lim retsepti):** `SCREEN_META` dan chiqarildi (20 → **19 ekran**) · `screens[]` dan `Screen15` olindi (19 element, **meta bilan teng** ✅) · komponentning o'zi o'chirildi (73 qator) · `INLINE_KEYS` dan `s15: -1` · `Q_LABELS` dan `16: "5 — for yoz"` · `ACH_TRIGGERS` dan `s15: 'assemblymaster'`. Qoldiq-grep `Screen15|s15:` → **0** ✅.
· **Nishon yo'qolib qolmadi:** `assemblymaster` («Birinchi siklingizni o'zingiz yozdingiz») endi ekran-testidan emas, **praktika bajarilganda** beriladi (`runPractice` → `earn`). Ma'nosi hatto aniqroq bo'ldi — endi u haqiqatan ishlaydigan kod uchun.
· **Ball hisobi:** `s15` yagona `scope:'final'` ekran edi. Olingach `finalMeta.length === 0` → `finishLesson` dagi mavjud zaxira shart ishlaydi (`passed` umumiy ballli ekranlar nisbatidan hisoblanadi). Yangi kod kerak bo'lmadi.
**Nima qo'shildi (JsVars naqshi, yengil rejim):** kompilyator qatlami ko'chirildi (`HtmlCompiler` + `C.*` + konsol-uzatgich + `MentorPracticeOverlay` + `.mp-*` CSS + 102-qonun saqlovi). **2 topshiriq** (527-qonun: faqat o'tilgani so'raladi):
· **P1** — idx **6** (s5b, `for` testidan keyin) **TASK_SANOQ**: `for (let i = 1; i <= 5; i++) { console.log(i) }` → konsolda `1 2 3 4 5`. Shartlar: `C.js(for(...;...;...))` + `C.logs('1 2 3 4 5')`.
· **P2** — idx **15** (s14 debugging'dan keyin, YAKUNIY) **TASK_MEVA**: `let mevalar = ["olma","banan","uzum"]` + sikl bilan `console.log(mevalar[i])` → konsolda uchalasi. Massiv darsning o'z lug'atidan olindi (s10 dagi `["olma","banan","uzum","qulupnay"]`).
· Yakun-sahifadagi «Uyga vazifa» kartasiga **«✍️ Kompilyatorda yozib tekshirish →»** tugmasi (P2 ni ochadi, serverga signal yubormaydi).
**F-0803-16 (yo'lda topilgan, IKKALA yengil darsda tuzatildi):** JS-only topshiriqda «📺 Natija» oynasi **bo'sh oq maydon** bo'lib o'ng panelning 66% ini egallardi (HTML yozilmaydi — ko'rsatadigan sahifa yo'q). Endi `jsOnly` bayrog'i: iframe jimgina ishlashda davom etadi (JS bajariladi, konsol uzatiladi) lekin `display:none`, konsol esa butun panelni oladi. Natija: toza ikki panel — muharrir + to'liq konsol.
**Darvozalar:** esbuild ikkala fayl toza ✅ · `vite build` toza (1.40s) ✅ · `lint:til` 0 topilma ✅ · `lint:jsx` yangi topilma **0** (mavjud 1 — `PmUserStoryLesson:373`, bu ishdan oldin ham bor) ✅ · `PRACTICE_AFTER` kalitlari **2** · `SCREEN_META` 19 = `screens[]` 19 ✅.
**Brauzer-sinovi (Chrome):** **P1** — 102-qonun tiklash yo'li bilan ochildi, to'g'ri yechim yozilganda **2/2 shart ✓**, konsolda **5 qator (1..5)**, «Davom etish» faol ✅ · **P2** — yakun-sahifa → «Uyga vazifa» → kompilyator → **2/2 shart ✓**, konsolda `olma banan uzum` ✅ · mustaqil rejimda dars-ichi praktikasi ochilmadi (kutilgan xulq) ✅ · **JsVars regressiyasi** qayta chopildi: 3/3 shart ✓, konsol `25 10 55` ✅. Sahifa xatolari **0**.
**Qonunlashtirish:** yangi qonun kerak emas — 9.4 (praktika-kompilyator), 11.9 (starter), 102 (tab-qaytish), 527 (pedagogik tartib) qonunlarining tatbig'i. UNCOMMITTED.

## 2026-08-03 — F-0803-17: JsLoops 8-sahifa (`while` simulyatsiyasi) — MATN QISQARDI, QADAM-BA-QADAM QO'SHILDI — ✅
**Kelib chiqishi:** foydalanuvchi: «Mentor matni juda uzun, bu yerda 4 ta fikr bor… men ikki gap qilardim… "datchik"ni bolalar hamma vaqt tushunmaydi, men "👀 Tekshiruvchi" deb yozardim… o'quvchi to'liq animatsiyadan OLDIN har aylanishni qo'lda bosib ko'rsa… o'rganish shart yolg'on bo'lgan lahzani ko'rishdan keladi, shu lahzani vizual urg'ulang».
**Tashxis:** ekran repodagi eng kuchli sahifalardan biri (tushuncha tushuntirilmaydi — **simulyatsiya qilinadi**), lekin uch nuqtada to'siladi: (1) Mentor matnida 4 mustaqil fikr — zavod · idish · datchik · while ta'rifi; (2) «datchik» — o'smir lug'atida yo'q so'z, metafora izoh talab qiladi; (3) o'quvchi faqat KUZATADI — tugmani bosadi va animatsiya o'zi oqadi, ya'ni shart yolg'on bo'lgan lahza uning ishi emas.
**Tuzatishlar (4 ta):**
· **Mentor 4 fikr → 2 gap:** «Zavoddagi idish **to'lguncha** suv quyiladi — hech kim oldindan «5 marta quy» demaydi. `while` ham shunday: shart **rost** bo'lsa takrorlaydi, **yolg'on** bo'lsa to'xtaydi.» (158 belgi). Audio matni ham shunga tenglashtirildi.
· **«datchik» → «👀 Tekshiruvchi»** — Mentor matnida, shart-pilyulasi ustidagi yorliqda, yakuniy hukmda VA `SiklZavodi` dastagi yorlig'ida (`whileMode`). Residue-grep `datchik|датчик` → JsLoops'da **0** ✅.
· **👣 Qadam-ba-qadam:** yangi «Bir marta quy» tugmasi — o'quvchi har aylanishni O'ZI bosadi, shart-pilyulasi har bosishda yangilanadi (`suv 20 < 100 → ✓ rost — yana quy`). «▶ To'liq quyib ko'rsat» ikkilamchi tugmaga tushdi (avval yagona edi).
· **Hisoblagich ekrandagi asosiy raqamga aylandi:** avval 13px matn («Aylanishlar: 5»), endi `.loop-count` — 40px mono raqam + yorliq, har aylanishda `bump` animatsiyasi.
· **To'xtash lahzasi urg'ulandi:** shart yolg'on bo'lganda pilyulya matni `✗ yolg'on — to'xta` bo'ladi va `cond-flash` halqasi bir marta urib chiqadi.
**Brauzer-sinovi:** 5 qadam qo'lda bosildi — hisoblagich 1→5, pilyulya har qadamda to'g'ri (`20/40/60/80` da ✓ rost, `100` da ✗ yolg'on), `.cond-pill.stop` urg'usi ishladi, «Davom etish» faollashdi, xatolar 0 ✅.
**Darvozalar:** esbuild toza ✅ · `lint:til` 0 topilma ✅.

## 2026-08-03 — F-0803-18: YENGIL PRAKTIKA yana 3 DARSGA (if/else · funksiyalar · PERN) — ✅
**Kelib chiqishi:** foydalanuvchi: «js if else function PERN'da ham 2-3 ta praktika moslab yengil qo'shaylik, PERN'da shu oldingilaridan qilsak bo'ladi, qisqa 2-3 tacha».
**Ehtiyotkorlik — port SKRIPT bilan, 12 langar SANALDI:** `_prac-port.mjs` har darsga 12 qadamni qo'llaydi (import · saqlov kalitlari · `PRACTICE_DONE_BASE` · kompilyator qatlami+topshiriqlar · praktika holati · `next`→`advance`+darvoza · `reset` · render · overlaylar · `Screen16` · uy-vazifa tugmasi · CSS) va **biror langar aynan 1 marta topilmasa fayl YOZILMAYDI**. Avval quruq yurish, keyin `--write`. Natija: **3 fayl × 12 langar = 36/36** ✅.
· **🔴 Yo'lda topilgan 2 farq (qamrov sanalgani uchun tutildi):** (1) fayllar **CRLF** qator-oxiri bilan saqlangan — ko'p qatorli langarlar mos kelmasdi; skript ishlov paytida LF ga keltirib, yozishda CRLF ni qaytaradigan qilindi. (2) `PeanStackLesson` da `</div>` va `</AchCtx.Provider>` orasida yana bir Provider bor (`AchEarnCtx`) — langar «`</div>` + keyingi `Ach*`-Provider» ko'rinishida kengaytirildi.
**Topshiriqlar (hammasi yengil rejim: bitta `script.js` + 🖥️ Console, 2 tadan shart; 527-qonun — faqat o'tilgani so'raladi):**
· **JsConditions (m2-04) — 3 ta:** idx 6 `TASK_IF` (`if (ball >= 60)` → `Ajoyib`) · idx 13 `TASK_ELSE` (`else` shoxi → `Kichik`) · idx 17 `TASK_ELSEIF` (uch yo'l: Oltin/Kumush/`Mashq`).
· **JsFunctions (m2-06) — 3 ta:** idx 6 `TASK_SALOM` (funksiya yoz **va chaqir** → `Salom`) · idx 13 `TASK_KVADRAT` (parametr + `return` → `25`) · idx 16 `TASK_QAYTA` (bitta funksiya, ikki chaqiruv → `Salom, Aziza Salom, Bobur`). 🔴 **Massiv/obyekt so'ralmadi** — tekshirildi: bu dars faqat funksiya·parametr·return ni o'rgatadi (App.jsx sarlavhasidagi «Array + Object» dars mazmunida YO'Q).
· **PeanStack (m2-10) — 2 ta** (tushuncha darsi, shuning uchun 3 emas): idx 13 `TASK_HISOB` («backend hisoblaydi» — funksiya + return → `75000`) · idx 16 `TASK_BAZA` («bazadagi ro'yxat» — massiv + sikl → `Lavash Burger Shashlik`). Ikkalasi ham o'tilgan JS bilan, lekin **stack rolida** sahnalashtirilgan — PERN'da hali Node/SQL yozilmaydi.
**Darvozalar:** esbuild 3/3 toza ✅ · `vite build` toza (1.55s) ✅ · `lint:jsx` bu 3 faylda 0 ✅ · `lint:til` — Cond/Func toza, PeanStack'da 1 ta **warn** (sen-forma, qator 538) bu ishdan OLDIN ham bor edi, error 0 ✅ · `PRACTICE_AFTER` sanog'i 3 · 3 · 2 ✅.
**Brauzer-sinovi (Chrome, 102-qonun tiklash yo'li bilan har topshiriq alohida ochildi):** **8/8 praktika** — hammasi ochildi, to'g'ri yechim yozilganda **2/2 shart ✓ «Barcha shartlar bajarildi!»**, «Davom etish» faollashdi, sahifa xatolari **0** ✅.
**Natija:** 2-Modul JS o'zagi endi **to'liq** praktikali — Vars (3) · if/else (3) · Sikllar (2) · Funksiyalar (3) · PERN (2) = **13 ta yengil kompilyator-mashq**. UNCOMMITTED.

## 2026-08-03 — F-0803-19: JsFunctions — 4-SAHIFA BLOKERI + 2-SAHIFA TMI — ✅ (tuzilma-reja kutilmoqda)
**Kelib chiqishi:** foydalanuvchi: «2-pageda TMI… bu darsda mavzu nimaligini bilib bo'lmayapti, ketma-ketlik, misollarda chalkashlik bordek, DIRECT va POINT bersin… 4-pagedan keyin o'tib bo'lmayapti, ishlamayapti, UI'da drag-drop chiqmayapti, oq bo'lib qolgan. Aslida "Mashinani sinab ko'ramiz" tomon ochib, o'rniga drag-drop paydo bo'ladi — shunaqa logikda qil».
**🔴 BLOKER TASHXISI (o'lchov bilan takrorlandi) — foydalanuvchi haq edi:** `Screen3` (4-sahifa) drag-drop blokini ikki ustunli splitdan KEYIN, to'liq enli qilib chizardi. O'lchov: blok `y=766…1116`, oyna balandligi **720px**, `.lesson-root` da `overflow: hidden` → 1280×720 va 1280×648 da vidjet **umuman ko'rinmasdi** (`korinadi: false`), 1280×800 da faqat 34px uchi chiqardi. «Davom etish» esa aynan shu vidjet yechilishini talab qilardi (`done = dragDone`) → **o'quvchi 4-sahifada qamalib qolardi**. Ekranning umumiy kontenti 1024px edi, ya'ni har qanday noutbukda kesilardi.
**Yechim (foydalanuvchi aytgan mantiq):** drag-drop endi **o'ng ustunni ALMASHTIRADI** — «Mashinani sinab ko'ramiz» bloki `showBuild = ran && !dragDone` bo'lganda yig'ish maydoniga aylanadi, yechilgach yana mashina ko'rinishiga qaytadi (natija + hukm bilan). Pastdagi to'liq enli blok butunlay olib tashlandi. Qo'shimcha: `Screen3` Mentor matni 4 fikrdan 2 gapga qisqardi va `.sk-buildbox` ichida slotlar ixchamlashtirildi (`min-height 56→42`, padding/gap kichraydi) — blok balandligi **401px → 321px**.
**Tekshiruv (3 balandlikda):** 1280×800 · 1280×720 · 1280×648 — uchalasida ham `to'liq ko'rinadi: true` ✅ (avval 2 tasida umuman ko'rinmasdi). Yechib ko'rildi: 4 bo'lak tartib bilan joylandi → nishon («Machine Builder») chiqdi, o'ng ustun mashina ko'rinishiga qaytdi, «Davom etish» **faollashdi**, sahifa xatolari 0 ✅.
**F-0803-19b — 2-sahifa TMI:** bu ekran darsning eng katta matni edi (**918 belgi**) va unda 3 ta ATAMA-TA'RIFI (funksiya · parametr · return) + 2 xatboshi turardi — ya'ni dars boshlanmasdan turib butun mazmun ta'rif bilan aytib qo'yilardi (deduktiv; induktiv tartib qoidasiga zid). Endi bitta ko'rsatiladigan nuqta qoldi: «🛠️ Bir marta **yozasiz** — **xohlagancha** ishlatasiz» + `salomBer()` chaqiruv-pilyulalari. Mentor ham 3 fikrdan 1 to'g'ridan-to'g'ri gapga tushdi. Natija: **918 → 503 belgi**, toshish 0.
**Darvozalar:** esbuild toza ✅ · `vite build` toza (1.63s) ✅ · `lint:til` 0 topilma ✅ · `lint:jsx` JsFunctions 0 ✅.
**⏭ HALI TUZATILMAGAN (foydalanuvchi tasdig'i kerak) — «ketma-ketlik va misollarda chalkashlik»:** dasturiy tekshirildi, shikoyat asosli — darsda **uchta boshqa-boshqa ish-misoli** ipsiz almashadi: `s0` da **jami/narx** (buyurtma) → `s1–s5` da **salomBer/ism/"Ali"** (salomlashish) → `s9–s11` da **hisobla/narxHisobla** (yana narx) → `s14–s15` da **kvadrat**. Ya'ni o'quvchi har 3-4 ekranda yangi olamga tushadi. Tuzatish tuzilmaviy (bitta ip tanlab, 8+ ekran matni va kod-namunalari qayta yoziladi) — shuning uchun REJA bilan tasdiqlashga qo'yildi, ko'r-ko'rona qayta yozilmadi. UNCOMMITTED.

## 2026-08-03 — F-0803-20: JsFunctions — MISOL-IPI BIRLASHTIRILDI (o'yin zarari) — ✅ (foydalanuvchi tekshiruvida)
**Kelib chiqishi:** F-0803-19 tashxisidan keyin foydalanuvchi lavash ipini RAD ETDI («lavash-mavash kerakmas, boshqa yaxshi idea ber») va taklif qilingan uchtadan **🎮 o'yin zarari** ipini tanladi.
**Nega bu ip:** kod raqamli va sodda qoladi (`return kuch * 3`), qayta chaqirish tabiiy (har urish), ikkinchi parametr (krit bonus) o'zidan chiqadi, va JsVars darsidagi «o'yin bali» misoli bilan **bir olamda** — modul-ipi lavashsiz davom etadi.
**Bajarilgan almashtirish (butun dars bo'ylab, `zarar(kuch)` → `kuch * 3`, ikki parametrli shakl `zarar(kuch, bonus)` → `kuch * 3 + bonus`):**
· `s0` hook — buyurtma narxini qo'lda hisoblash → har urishda zararni qo'lda hisoblash (variantlar, mentor, jurnal qatorlari, 🧾 → ⚔️).
· `s1` reja — `zarar()` chaqiruv-pilyulalari · `s2` — 9 qator takror → `function zarar()` 3 urish · `s3` — tuzilma (`zarar` / `kuch` / `return kuch * 3`) + drag-drop bo'laklari (`FN_PIECES`).
· `s5` — parametr: ismlar (`Ali/Laylo/…`) → kuchlar (`4/5/8/12`), natija `kuch * 3` · `s7` — return saqlash: `let ochko = zarar(kuch)` · `s8` — ikki parametr: `qoshish(a,b)` → `zarar(kuch, bonus)`.
· `s9`, `s5b` testlari + ularning RECAP kartalari va **RU tarjimalari** · `s10` — «kassa mashinasi» → «zarar mashinasi» (`NARX`→`BONUS`, `jami`→`ochko`) · `s11` — lavash narx-hisoblagichi → uch xil urish (👊 oddiy · ⚔️ qilich · 🔥 olovli).
· `s14` — AI xatosi (`undefined`) `zarar` ustida · `s15` — yakuniy yozish mashqi (`hasSquare` validatori `kuch * 3` ga moslandi) · yakun-sahifa, **uy vazifasi** (3 band: oddiy urish · krit bonus · uch urish), **flashcardlar**, **arena savollari**, `Q_LABELS`, nishon tavsifi va **P2 praktikasi** (`TASK_KVADRAT` → `zarar(kuch)`, kutilgan natija `25` → `15`).
**Qoldiq-tekshiruvi (butun fayl):** `kvadrat|квадрат|lavash|narxHisobla|qoshish|ayir|salomBer` → **0 topilma** ✅.
**Darvozalar:** esbuild toza ✅ · `vite build` toza (1.52s) ✅ · `lint:til` 0 topilma ✅ · `lint:jsx` 0 ✅.
**Brauzer-skaneri (20/20 ekran, 1280×720):** har ekran render bo'ldi, **sahifa xatolari 0**, ip-qoldig'i **0** (skaner belgilagan 2 ta «ali» mosligi yolg'on-ijobiy bo'lib chiqdi: `hali`, `amaliyot`, `Kalit`).
**⚠️ Qolgan (tuzatilmagan):** `s16` yakun-sahifasida **253px toshish** bor — bu ish BOSHLANMASDAN oldin ham bor edi (birinchi skanerda ham qayd etilgan), alohida ko'riladi.
**Holat:** foydalanuvchi «o'zim tekshiraman» dedi — dars uning qo'lida. UNCOMMITTED.

## 2026-08-03 — F-0803-21: SESSIYA-SABOQLARI QONUNLASHTIRILDI (TMI + bitta ip) — ✅
**Kelib chiqishi:** foydalanuvchi: «darsda ortiqcha joy, keraksiz tekst — jalka UI to'ldirib o'quvchi tushunmasligiga olib keladi. Shu sessiyada to'liq aytdim — endi MD'larimizga QAT'IY saqla».
**Muhrlandi (B-retsept 4-band marshruti bo'yicha, avval korpus):**
· `MATN_KORPUS.md` → **74-bo'lim** (TMI taqiqi: mentor maks 2 gap · reja-ekran ta'rif aytmaydi · olib tashlash testi · sanoq-tekshiruv; misollar shu sessiyadan — JsLoops s7 mentor 4 fikr→2 gap, JsFunctions s1 918→503 belgi) va **75-bo'lim** (DIRECT va POINT: ekran birinchi soniyada nima haqidaligini aytsin; misol-sakrash anti-namunasi).
· `DARS_ETALON.md` → yangi **11-B bo'lim**: **108-qonun** (bir dars — bitta misol-ip; JS oilasida o'yin olami; ip foydalanuvchi bilan kelishiladi — lavash RAD etilgani qayd etildi; grep-tekshiruv bilan) + **109-qonun** (TMI texnik tomoni: tushuntirish ~600 / hook ~500 belgi mezoni, dekorativ blok g'alaba yoniga qo'yilmaydi, 92-qonun bilan juftligi).
· `DARS_ETALON.md` 12-bo'lim bug-jadvali → yangi qator: **«Gate-vidjet ko'rinish-zonasidan tashqarida»** (F-0803-19 sinfi: esbuild/lint toza, dars esa «ishlamayapti» — 1280×720/648 brauzer-tekshiruvi bilan).
· `PM_DARS_ETALON.md` → 108/109 havolasi (PM'da: bitta keys-olam).
· `memory/` → yangi `tmi-taqiq-bitta-ip.md` (feedback-turi, seanslararo) + MEMORY.md indeks-qatori.
**Darvoza:** `lint:prompt` 0 topilma ✅. UNCOMMITTED.

## 2026-08-03 — F-0803-22: VS CODE DARSI HOOK-PANELI YO'QOLISHI (animatsiya-klass to'qnashuvi) — ✅
**Kelib chiqishi:** foydalanuvchi rasm bilan (`feedback/F-0803-22-vscode-hook-yoqolish.png`): m1-15 1-ekranida variant bosilsa, o'ngdagi VS Code paneli yo'qolib qoladi.
**Tashxis:** `VsCodeLesson.jsx:2413` — bir elementda `fade-up` + `demo-swap` birga. `.demo-swap` `animation`ni almashtiradi (`forwards`siz), 0.3s dan keyin element `.fade-up`ning `opacity: 0` asos-holatiga qaytadi → panel miltillab yo'qoladi.
**Tuzatildi:** klasslar shartli qilindi — tanlovgacha `fade-up delay-2 vsc-teaser`, tanlovdan keyin faqat `demo-swap`.
**Residue-grep:** `fade-up.*demo-swap` kombinatsiyasi boshqa darslarda yo'q (GitLesson/DeployLesson'dagi mosliklar — reduced-motion CSS, xavfsiz).
**Muhrlandi:** `darslik-tekshiruvchi.md` adversarial-ro'yxatiga yangi ov-bandi — «ANIMATSIYA-KLASS TO'QNASHUVI (F-0803-22)» (grep-retsepti bilan).
**Darvozalar:** esbuild toza ✅ · `lint:jsx` — VsCodeLesson 0 topilma ✅ (1 error bor, lekin u `PmUserStoryLesson.jsx:373` eski topilmasi — uy-vazifa ikkilanishi, bu ishga aloqasiz) · `lint:prompt` 0 topilma ✅.
**Eslatma:** `src/2-Modull/image.png` — boshqa feedback, foydalanuvchi ko'rsatmasi bilan TEGILMADI. UNCOMMITTED.

## 2026-08-03 — F-0803-25: PracticeLesson1 11-SAHIFA «HECH NARSA O'ZGARMAYAPTI» (forma-darvoza jim qolgan) — ✅
**Kelib chiqishi:** foydalanuvchi: «11-pageda yuboryapman, hech qanday o'zgarish bo'lmayapti, keyingi pagega o'ta olmayapman».
**Tashxis:** 11-sahifa (Screen10, forma-tekshiruv) darvozasi IKKALA holatni (bo'sh→xato, to'liq→yuborildi) ko'rishni talab qiladi, lekin: (1) bir xil holat qayta yuborilsa xabar qayta jonlanmasdi — ekran «o'lik» ko'rinardi; (2) inputda Enter bosish umuman ishlamasdi (submit yo'q); (3) qaysi qadam qolgani aytilmasdi — nav-tugmada umumiy «Bo'sh va to'liq holatni sinang» turardi xolos. Kod-logika buzilmagan (onNext/onAnswer/darvoza to'g'ri) — bu UX-jimlik sinfi.
**Tuzatildi (PracticeLesson1.jsx Screen10):** (1) xabar elementlariga `key={msgKey}` — har «Yuborish»da fade/shake qayta o'ynaydi; (2) `onKeyDown Enter → submit`; (3) nav-tugma yorlig'i dinamik («Endi bo'sh holda yuboring» / «Endi ism yozib yuboring») + ekran ichida bitta yo'l-ko'rsatma qatori (UZ-RU).
**Sinov (playwright, dev-server, real klik):** ikkala tartib ham o'tdi — bo'sh→to'liq va to'liq→bo'sh; Enter ishlaydi; «Davom etish» yoqilib 12/19 ga o'tdi; konsol toza. Skript: scratchpad/test-p11.mjs, test-p11b.mjs.
**Muhrlandi:** `DARS_ETALON.md` 11-C — **110-qonun: GATE-EKRAN JIM QOLMAYDI** (har bosishga reaksiya · Enter=submit · qolgan qadam nomma-nom).
**Darvozalar:** esbuild toza ✅ · `lint:jsx` PracticeLesson1 0 topilma ✅ · `lint:til` PracticeLesson1 0 topilma ✅. UNCOMMITTED.

## 2026-08-03 — F-0803-23: m2-09 FLASHCARD TUSHUNARSIZ SO'ZLAR + TMI KESIMI — ✅
**Kelib chiqishi:** foydalanuvchi (m2-09 = `src/2-Modull/PracticeLesson2.jsx`): «flashcardlarda muammo — loyqa, tushunarsiz so'zlar ishlatilgan»; keyin: «kecha aytgan feedbackim — keraksiz tekst UI'ni egallamasin — shularni ham qarab, darsni o'quvchiga yoqadigan, tushunarli qil».
**Tashxis (2 sinf):**
· **Karta-javobi tarjimasiz chet so'z** — 12 kartadan 5 tasi: `Vibecoding`, `Iteratsiya`, `Promo-landing`, `Agent`, «AI-muhit». Darsning o'zida etalon-naqsh bor edi — `Deploy (nashr qilish)`. Yon-nuqsonlar: izohlar ta'rif-ohangida («to'rttasi bor — buyruq aniq»), 12-karta javobi fe'l edi («Tekshiraman») — qolgan 11 tasi ot, `ta'minlaysiz`/`belgilaydi` rasmiy fe'llari, `minimal` tarjimasiz.
· **Texnik:** `fcIsCode` defis-li oddiy so'zni kod-token deb hisoblardi → `Promo-landing` dasturchi shriftida, `let`/`const` kabi chiqardi (o'quvchi uni kod deb o'qiydi).
· **TMI (74-bo'lim / 109-qonun):** 13 ta mentor/xulosa matni 160–255 belgi, ko'pi ekran o'zi ko'rsatgan narsani qaytarardi.
**Tuzatildi (bitta fayl, PracticeLesson2.jsx):** 12 karta ham `atama (o'zbekcha izoh)` naqshiga tortildi, izohlar bitta jonli misolga aylandi («masalan: o'yin · o'ynoqi · ko'k · tugma va 3 karta»); `fcIsCode` — endi faqat harfsiz belgi-token kod; 13 matn 1–2 gapga qisqartirildi (s0/s1/s2/s3/s5/s6/s8/s10/s11/s12/s13/s14/s15 + 2 test-izohi + s13 prompt-qutisi) — UZ va RU birga.
**Tegilmadi (ataylab):** «ingredient» so'zi — darsning butun ipi (34 o'rin, reja-ekran vizuali, quiz variantlari, RECAP, uy-vazifa) shunga bog'langan; almashtirish alohida qaror talab qiladi. Quiz kalitlari, `correctIdx`, INLINE_KEYS, QUIZ_BANK — TEGILMADI (⚡ Jonli).
**Muhrlandi:** `MATN_KORPUS.md` → **76-bo'lim** (flashcard javobi tarjimasiz chet so'z bo'lolmaydi + izoh=misol + javoblar bir turkumda + fcIsCode yon-ta'siri) · `MATN_ETALONI.md` LUG'AT → 3 yangi qator (chet-so'z javoblar · `ta'minlaysiz`/`belgilaydi` → `qilasiz`/`aytadi` · `minimal` → `sodda`).
**Darvozalar:** esbuild toza ✅ (451.0kb) · `lint:jsx` 127 fayl 0 topilma ✅ · `lint:til` PracticeLesson2 0 error ✅ (2 warn — 1005–1007 `ru:` bloki, false-positive) · `lint:prompt` — quyida. UNCOMMITTED.

## 2026-08-03 — F-0803-26: m2-10 (PERN Stack) TMI-TOZALASH — ✅
**Kelib chiqishi:** foydalanuvchi: «m2-10 ni ko'rib chiq — kecha va bugun 6:30 gacha etalonga qo'shganlarimiz bo'yicha yaxshila; o'quvchi 7-10 soniyada tushunishni boshlashi kerak; kerakli ma'lumot bo'lmasa olib tashlash kerak».
**Usul:** har 20 ekran 1280×773 da skrinshotga olindi (`_tmi-shot.mjs`, shu seansda yozildi) + ekran matni belgida o'lchandi; etalon sifatida m2-06 (JsFunctions, kecha tuzatilgan) bilan yonma-yon solishtirildi.
**Topilgan va tuzatilgan (4 ta):**
1. **Javob-kaliti mashq boshida (109/TMI).** Uch ekranda o'quvchi hech narsa qilmasdan turib javobni aytadigan quti turardi: s14 «Maslahat: ko'rinish — zal, dvigatel — pech, yo'llar — ofitsiant, ombor — daftar» (= topshiriqning to'liq yechimi), s15 «Eslang: chizish — frontend… Saqlash — baza…» (= xato qatorni ko'rsatib turardi), s16 «Maslahat: sayohat foydalanuvchidan boshlanadi…». Uchalasi olib tashlandi; reaksiya endi faqat harakatdan KEYIN. s14 dagi xato-javob matnidan ham javob-kaliti («zal, pech, ofitsiant, daftar») olib tashlandi — faqat harakat qoladi.
2. **s16 sudraladigan bo'laklar KESILGAN.** 5 slot + pool bir ustunda sig'may, chiplar nav-panel ostida qolardi — o'quvchi sudrash uchun hech narsa ko'rmasdi. `DragDropOrder`ga `side` propi + `.dd-wide` grid: slotlar chapda, bo'laklar o'ngda. Yechilgandan keyingi «sayohat xaritasi» endi MUKOFOT sifatida chiqadi (ilgari yechilmasdan oldin 5 ta bo'sh «…» qatori turardi).
3. **s12 vazifa matni ikki marta.** O'ng «Taqsimot» taxtasi chapdagi ayni vazifani so'zma-so'z takrorlar, qolgan 2 tasini esa oldindan o'qitib qo'yardi. Yangi `k` (qisqa yorliq) maydoni + yechilmaganlarga `…` naqshi.
4. **Flashcard'da «sen»-forma** (`Frontend — sen ko'rgan…`) — oldindan bor nuqson, siz-formaga tortildi (`lint:til` 🟡 yopildi).
**Tekshirilgan, TEGILMAGAN:** ekranning pastki ~40% bo'shligi — etalon m2-06 da ham aynan shunday, bu uy-uslubi, nuqson emas. `frame-dash` affordans qutilari (4 ta, 2-3 so'z) — sudrash/bosish taklifi, TMI emas.
**Muhrlandi:** `MATN_KORPUS.md` **77-bo'lim** (javob-kaliti taqiqi + olib tashlash testining mashq-varianti) · `darslik-tekshiruvchi.md` ga 3 ta ov-bandi (sudralish-kesilishi · javob-kaliti · progress-taxtasi takrori).
**Darvozalar:** esbuild toza ✅ · `lint:jsx` butun repo 0 ✅ · `lint:til` 0 ✅ · 20/20 ekran qayta skrinshot — kesilish yo'q, sahifa xatolari 0 ✅.
**⚠️ Seans-eslatmasi:** ish paytida repo'da PARALLEL seans ishlagan (11:13 da barcha modul darslari + `DARS_ETALON.md` tegilgan). F-0803-25 o'sha seansniki (m2-13 + PracticeLesson1) — shu ish F-0803-26 ga ko'chirildi. Qonun-raqami DARS_ETALON'ga YOZILMADI (to'qnashuv xavfi) — topilmalar korpus + rol-fayliga muhrlandi. UNCOMMITTED.

## 2026-08-03 — F-0803-23b: SHRIFT XATOSI 76 DARSGA TARQATILDI (fcIsCode) — ✅
**Kelib chiqishi:** foydalanuvchi: «shrift xatosini to'g'rilash kerak» (F-0803-23 ning m2-09 dan tashqaridagi qismi).
**Muammo:** `fcIsCode` defis ko'rgan bitta so'zni kod-token deb hisoblardi → oddiy so'z flashcard javobida dasturchi shriftida, `let`/`const` kabi chiqardi. Naqsh 76 darsga aynan ko'chirilgan edi.
**Nozik joy (avval o'lchandi):** defisli javoblarning hammasi ham so'z emas — 18 ta defisli javobdan **7 tasi HAQIQIY kod**: `background-color`, `font-family`, `font-size` (CssLesson1) · `align-items`, `justify-content`, `space-between` (CssLesson2) · `background-color` (CssPractice) · `runs-on` (GithubActionsLesson). Ularni ko'r-ko'rona «so'z» qilish teskari regressiya bo'lardi.
**Yechim:** qoida = defis-li so'z kod EMAS, **lekin FC_VOCAB oq ro'yxatidagisi mono bo'lib qoladi**; yuqoridagi 4 darsning FC_VOCAB'iga o'sha 7 token qo'shildi. Codemod 75 faylni yangiladi (m2-09 avval qo'lda tuzatilgan edi).
**Dasturiy tekshiruv (QOIDA 10):** har darsning O'Z FC_VOCAB + qoidasi fayldan o'qib ishga tushirildi — 18/18 javob kutilganday (7 mono · 11 oddiy shrift), nomuvofiq 0. Skript: `scratchpad/verify.js`.
**Darvozalar:** 76 faylga esbuild — hammasi toza ✅ · `lint:jsx` 127 fayl 0 topilma ✅ · `vite build` toza (128 modul) ✅ · `lint:prompt` 0 topilma ✅.
**⚠️ Ogohlantirish (bir fayl — bir muharrir):** ish paytida `PracticeLesson2.jsx` da PARALLEL seans tahriri (F-0803-26 izohlari) ko'rindi — bir lahzada JSX yopilmagan holatda `vite build` sindi (Col/div mos kelmasligi, 1645–1666). Keyingi tekshiruvda o'zi tuzalgan (o'sha seans tahrirni yakunlagan). Hozirgi holat toza, lekin bu fayl bo'yicha ikki muharrir bir vaqtda ishlamasin. UNCOMMITTED.

## 2026-08-03 — F-0803-26: m2-09 (PracticeLesson2) — TMI TOZALASH + BITTA MISOL-IP + DARVOZA KO'RINISHI — ✅
**Kelib chiqishi:** foydalanuvchi: «m2-09 ni ko'rib chiq… ui keraksiz narsalar to'ldirganmiz, o'quvchi ko'rganda 7-10 soniyada sahifa yoqib tushunishni boshlashi kerak… kerakli ma'lumot bo'lmasa olib tashlash kerak».
**Tashxis (o'lchov bilan, 1280×720):** (1) TMI — 4 ekranda mentor 3-4 gap, bir ko'rsatma 4 joyda takror (11-ekran: mentor · yorliq · ipucha · nav tugmasi); reja-ekrani 4 ingredientning TA'RIFINI dars boshlanmasdan aytib qo'yardi (74-bo'lim buzilishi), holbuki 4-ekran aynan shuni misol ustida ochadi. (2) Misol-ipi sakrardi: Texno Fest → Pixel Quest → shaxmat klubi → Focusly → Pixel Quest (108-qonun buzilishi). (3) 🔴 ENG OG'IRI — darvozalar ko'rish zonasidan tashqarida: **1-ekranda** «yuborish»dan keyin savol-variantlari 394px pastda qolardi, ya'ni darsning birinchi sahifasida «Davom etish» hech qachon ochilmasdi; 16-ekranda 341px, 11-ekranda «tuzat» tugmasi 894px da.
**Tuzatildi:** matn — mentorlar 2 gapdan oshmaydi, takroriy ko'rsatmalar/ipuchalar/quyruqlar olib tashlandi, reja-ekrani bitta qoidaga qisqardi (625→471 belgi), «wow» ichki yorlig'i o'chdi, promptdagi o'rgatilmaydigan 5-gap («Mobil va kompyuterda…») olib tashlandi, quruvchi ostidagi takroriy ko'rsatma va 16-ekrandagi qabul-akti+izoh (tugmalar holatini takrorlardi) olib tashlandi, draft-preview'dagi 4 ta pufakcha bittaga yig'ildi. Ip — s2/s6/s8/s14 «Pixel Quest» ga o'tkazildi (13-ekran ataylab ko'p mavzuli qoladi — uning mazmuni shu). Layout — quruvchining 4 guruhi yorliq+tugma bir qatorda, 11-ekranda buyruq va natija yonma-yon, qabul akti 2 ustunda, 1-ekran sarlavhasi bir qatorga.
**O'lchov (belgi · pastga oshgan):** s1 625→471 · s5 961→621·147px→16px · s10 803→509·132px→0px · s11 366→196 · s15 1238→624·341px→0px. Mentor 3-4 gap bo'lgan 4 ekran — endi hammasi ≤2 gap.
**Sinov:** dars 0-ekrandan 17/19 gacha **haqiqiy bosishlar bilan** o'tkazildi (playwright) — 16 qadamning hammasi OK, har bosiladigan element skrollsiz ko'rinadi, konsol toza.
**Muhrlandi:** `DARS_ETALON.md` 11-C ga **110-B** — ko'rinish tekshiruvi dam olgan holatda emas, BOSILGANDAN KEYIN qilinadi (+ joy yetmaganda tuzatish tartibi).
**Darvozalar:** esbuild ✅ · `lint:jsx` 127 fayl 0 topilma ✅ · `lint:til` 0 error (2 warn — HEAD'da 3 ta edi, o'zgarmagan naqsh) ✅ · `lint:prompt` 0 ✅ · `vite build` toza ✅. UNCOMMITTED.
**Eslatma:** seans davomida fayl TASHQARIDAN ham tahrirlandi (mentor matnlari parallel qisqartirilgan) — ishim ustiga qo'shildi, ustidan yozilmadi.

## 2026-08-03 — F-0803-28: 111-QONUN — 7–10 SONIYA TESTI · BO'SH JOY · OLIB TASHLASH SAVOLI — ✅
**Kelib chiqishi:** foydalanuvchi: «o'quvchi bir ko'rganda 7–10 soniyada UI ni ko'rib tushunishi kerak · bo'sh joy qoldi deb uni so'z bilan to'ldirmaymiz — u ma'lumot bermasa, umuman kerak emas · kartani olib tashlashda savol beramiz: bu bo'lmasa o'quvchi ma'noni tushunmay qoladimi? ha bo'lsa olmaymiz, yo'q bo'lsa olib tashlaymiz».
**Tashxis:** qoida qisman bor edi, lekin FAQAT PM kitobida — `PM_DARS_ETALON` 106f (7 soniya testi) va 106c (olib tashlash testi). Texnik `DARS_ETALON.md` da birinchi-qarash mezoni YO'Q edi: 109 (TMI), 110 (gate jim qolmasin), 110-B (ko'rinish bosilgandan keyin), 92 (bir ekran — bir ish) bor, lekin ekranni BIRINCHI KO'RGANDA tushunish KPI si yo'q. Ya'ni texnik darslar auditori bu testni umuman o'tkazmasdi.
**Muhrlandi:**
· `DARS_ETALON.md` → yangi **11-D bo'lim, 111-qonun**: (a) 7–10 soniya testi — uch savol («nima qilishim kerak? · qayerga bosaman? · bu ekran nimani o'rgatyapti?»), bittasi chiqmasa ekran topshirilmaydi, test bosilgandan keyingi holatda ham takrorlanadi (110-B); (b) **bo'sh joy so'z bilan to'ldirilmaydi** — bo'sh joy dizayn elementi, har matn bo'lagi vazifani aytadi / yangi ma'no beradi / javobga yo'l ochadi, aks holda ortiqcha; (c) **olib tashlash savoli** — «bu bo'lmasa o'quvchi ekran ma'nosini tushunmay qoladimi?» HA→qoladi, YO'Q yoki shubha→olib tashlanadi, qaror GAP-hisobotda yoziladi.
· `MATN_KORPUS.md` → **78-bo'lim** (matn-tomoni: ❌/✅ misollar bilan).
· `.claude/agents/role/darslik-auditor.md` → ish tartibiga 5-band (har ekran uchun 7–10 soniya hukmi + bo'sh joy + olib tashlash savoli).
· `.claude/agents/role/darslik-qabulchi.md` → chek-ro'yxatga 17/18-band (yiqilgan ekran = QAYTARISH).
· `memory/tmi-taqiq-bitta-ip.md` → qabul mezoni qo'shildi (seanslararo).
**Qurol repoga kiritildi:** 109-qonun `_tmi-shot.mjs` ga havola qilardi, lekin skript git kuzatuvida emas edi (commitda yo'qolardi) → **`tools/tmi-shot.mjs`** (git add qilindi), etalondagi havola yangilandi. Ildizdagi `_tmi-shot.mjs` nusxasi O'CHIRILMADI — parallel seans undan foydalanayotgan bo'lishi mumkin (keyin tozalanadi).
**Darvozalar:** `lint:prompt` 0 topilma ✅ · dars-fayllariga TEGILMADI (faqat hujjat + rol + tools/). UNCOMMITTED.

## 2026-08-03 — F-0803-27: `<p>` RESETI KLASS-QOIDANI YENGADI — 78 FAYLDA 136 QOIDA JIM BUZUQ EDI — ✅
**Kelib chiqishi:** foydalanuvchi rasm bilan (`src/2-Modull/image copy.png`): PmLesson4 2-ekranidagi imkoniyat-kartalari «buzulib yotibti».
**Tashxis (brauzerda o'lchov bilan):** karta aybdor emas — CSS ANIQLIGI. Reset `.lesson-root p { margin:0; padding:0 }` aniqligi (0,1,1), bitta klassli `.oc-pain { padding: 9px 12px; margin: 0 15px 14px }` esa (0,1,0) → reset YENGADI va padding/margin JIMGINA o'chadi; fon, burchak, rang qolgani uchun blok «yarim buzuq» ko'rinadi. O'lchov: padding 0px · margin 0px · balandlik 20px (mo'ljal 38px) · yon chekinish 0px · past chekinish 0px → sariq chiziq karta eniga yopishgan, `overflow:hidden` + `border-radius:14px` burchaklarini kesgan. esbuild, konsol va `vite build` — hammasi jim.
**Ko'lam:** repo skaneri 78 faylda 136 qoida topdi. Eng ko'p: `.mstats-warn` (79 dars), `.hc-hint` — o'quvchi ko'radigan kompilyator-ipuchasi (14 dars), `.hint`, `.one-line`, `.s3note` (48px chekinish butunlay yo'q edi), `.kp-res` (pill yassilangan), `.oc-pain`/`.cl-pain`/`.swed-fb` (PmLesson4).
**Tuzatildi:** har qoida `.xyz` → `.xyz.xyz` (aniqlik 0,2,0; element to'plami O'ZGARMAYDI, modifikatorlar manba-tartibi bo'yicha ustun qolaveradi). 7 tasi qo'lda + izoh bilan, 127 tasi lint-topilmalari bo'yicha skript bilan. Qo'shimcha: `.oc-pain.empty` / `.cl-pain.none` foni sahifa foni bilan AYNAN bir xil edi (matn kartadan tashqarida suzganday) → shaffof fon + uzuq ramka.
**Darvoza (yangi):** `jsx-lint.mjs` 5-tekshiruvi. Ikki kalibrovka kerak bo'ldi: (a) CSS — JS shablon-satri, `${T.ink}` jingalak qavsi qoida-tanasini bo'lardi → `${…}` tokenga almashtiriladi (busiz darvoza JIM o'tib ketdi, birinchi urinishda 0 topilma bergan edi); (b) selektor qoida boshida turishi shart — `.rel-box .mono` kabi avlod-selektorlari yolg'on-signal bergan edi (allaqachon 0,2,0).
**Tekshiruv:** 136 qoidaning HAMMASIDA haqiqiy padding borligi dasturiy tasdiqlandi (keraksiz o'zgarish yo'q) · kaskad-tartibi o'zgargan joy YO'Q (alohida skript) · PmLesson4 kartalari brauzerda: karta 73→104px, pain 20→38px, past chekinish 0→14px, ekran oshig'i 0px · PmLesson5 `.s3note` chekinishi 48px tiklandi (surat bilan) · `_smoke.mjs`: **109 dars, 0 nosozlik**.
**Yon-tuzatish:** `_smoke.mjs` `comp:` siz placeholder kalitlarni (Demo Day, zaxira dars, 8-modul) endi o'tkazib yuboradi — ular har yugurishda 29 ta soxta «bo'sh ekran» berardi.
**Muhrlandi:** `DARS_ETALON.md` 11-E — **112-qonun** (`<p>` klass-qoidasi resetdan kuchsiz · `.xyz.xyz` naqshi · darvozaning ikki kalibrovkasi). *(Dastlab 111 deb yozilgan edi — parallel seans o'sha raqamni «7–10 soniya testi» ga olgani uchun 112 ga surildi.)*
**ATAYLAB TEGILMADI:** faqat `margin` yo'qotgan ~369 qoida (2–11px). Mahsulot oylar davomida shu holatda sozlangan — ommaviy tiklash 111 faylda oraliqlarni bir vaqtda o'zgartiradi, ya'ni xato-tuzatish emas, alohida dizayn-migratsiya. Resetni `:where(.lesson-root) p` ga o'tkazish ham shu sababdan RAD etildi.
**Darvozalar:** esbuild ✅ · `lint:jsx` 127 fayl 0 ✅ · `lint:til` tegilgan fayllarda 0 error ✅ · `lint:prompt` 0 ✅ · `vite build` toza ✅ · smoke 109/109 ✅. UNCOMMITTED.
**Zaxira:** o'zgarishdan oldingi holat `git stash` da — `stash@{0}` «F-0803-27-oldin».

## 2026-08-03 — F-0803-29: `.hw-note` 11px TIKLANDI + m6-13 uy-vazifa kartasi + LINTERNING KO'R NUQTASI — ✅
**Kelib chiqishi:** F-0803-27 tashxisidan keyin foydalanuvchi so'radi: «margin qoidalarniyam tuzatish kerakmi?». O'lchov bilan javob berildi — 423 margin-qoidaning 43% i (`.hook-ack` 105x, `.fc-done-s` 77x) ota-konteynerda `gap` bor joyda turadi, ya'ni tiklash BO'SHLIQ QO'SHADI (regressiya). Faqat ota-konteyner oddiy blok bo'lgan holat haqiqiy nuqson. Foydalanuvchi qarori: faqat shuni tuzatish.
**Tuzatildi (1):** `.hw-note` → `.hw-note.hw-note` — 91 faylda. Dalil: yakun sahifasida uy-vazifa ro'yxati (`</ul>`) bilan izoh orasidagi oraliq brauzerda **0px** edi (ota `display:block`, gap yo'q), mo'ljal 11px. Tekshiruv: 109 darsdan `.hw-note` topilgan 90 tasida oraliq **11px** bo'ldi; oshiq-toshiqqa ta'siri o'lchandi — aynan **11px**, ya'ni maksimal mumkin bo'lgan qiymat, va yakun sahifasining yagona darvozasi (`Yakunlash ✓`) qo'zg'almas nav-panelida turgani uchun hech narsani berkitmaydi.
**Tuzatildi (2) — yo'l-yo'lakay topildi:** `m6-13` (`FullSystemProjectLesson`) da uy-vazifa kartasining ICHKI stillari (`.hw ul`, `.hw li`, `.hw li b`, `.hw .t`, `.hw-note`) umuman YO'Q edi — ro'yxat qora nuqtalar bilan, oraliqsiz chiqar, izoh esa oddiy matn bo'lib ro'yxatga qo'shilib ketardi. Boshqa 90 darsdagi bilan bir xil qilib qo'shildi (surat bilan tasdiqlandi).
**Tuzatildi (3) — DARVOZANING KO'R NUQTASI:** `jsx-lint` CSS ni faqat `<style>{...}</style>` shaklidan o'qirdi. `m6-13` esa CSS ni alohida o'zgaruvchida saqlaydi (`<style>{LESSON_CSS}</style>`) — natijada bu fayl backtik-darvozasidan ham, F-0803-27 darvozasidan ham BUTUNLAY chetda qolgan edi. Isbot: shu seansda o'sha faylning CSS izohiga backtik tushdi, `esbuild` va `vite build` JIM o'tdi (backtiklar juft edi), darslik esa brauzerda `ReferenceError: note is not defined` bilan qulab tushdi. Linter endi ikkala shaklni ham o'qiydi. Ikkinchi nozik joy: yopuvchi backtikni «birinchi uchragani» deb olib bo'lmaydi — aynan qidirilayotgan adashgan backtik o'shanda yopuvchi deb qabul qilinib, darvoza yana jim qolardi; shuning uchun e'lon oxiri `` `; `` bilan anchorlandi. Yangi darvoza darhol ish berdi — o'sha faylda ilgari ko'rinmagan `.mstats-warn` topildi va tuzatildi.
...
## 2026-08-04 — RELIZ: 1+2-Modul (texnik + PM, UZ-RU) yangi Vercel URL — ✅
**Buyruq:** foydalanuvchi — «1-2-Modullni tex va PM lari bilan birga UZ-RU formatda, oxirgi yangilaganimiz bilan yangi URL qilib deploy qil».
**Manba-holat:** ishchi daraxt `30a21e1` (F-0803-30 Demo Day loyiha-ipi) da, faqat bugungi LMS-TZ fayllari kuzatilmagan — ya'ni deploy AYNAN oxirgi commit holati.
**Qurildi:** `vite build --config vite.m1.config.js` → `dist-m1/` (28 chunk, toza, 526ms). Katalog `src/m1-demo/M1DemoApp.jsx` — 30 dars-yozuv (M1 15 + M2 15), shundan 27 tasi komponentli; kalitlar/tartib `src/App.jsx` bilan dasturiy solishtirildi — AYNAN bir xil (m1-14 Takrorlash 5-o'rin, m1-15 VS Code 10-o'rin).
**Deploy-tuzatish:** vite chiqishi `modul1.html` (index.html EMAS) — statik Vercel'da bosh URL 404 berardi. `deploy-office.sh` naqshi bo'yicha alohida papka: `coddycamp-1-2-modul-senior/` ← assets + `modul1.html`→`index.html` + `vercel.json`. Papka `.gitignore`ga qo'shildi.
...
| 13:00 | **COMMIT (buyruq «commit 3»):** ffc89cc server (0008 + test + katalog) · 4b2a716 darslar (T4 14 · sarlavha 98 · 12 ekran · F-0915-02 22 joy) · 49f7527 hujjatlar. Ishchi daraxt toza; origin/main dan 5 commit oldinda. **PUSH va GitLab SYNC — auto-rejim klassifikatori BLOKLADI** (`git push origin main`, `scripts/sync-dars-api.sh staging`); pull-dars-api staging: begona commit yo'q (origin/staging = c04a84b). Foydalanuvchi o'zi: `! git push origin main` → `! bash scripts/sync-dars-api.sh staging` → (deploy ~5 daqiqa) staging-check → `! bash scripts/sync-dars-api.sh main` → GitLab deploy tugmasi → prod-check --read-only. build:lms + smoke:lms fonda (lokal) |
| 13:19 | **build:lms (prod A):** `npm run build:lms` faqat kompilyator-importli 25 darsni yig'adi → skretch `rebuild-lms.mjs` bilan lms/ dagi HAMMA yig'ma manbasidan qayta yig'ildi: **92** (90 CRM ro'yxati + yangi `lms/PmLesson5.jsx`, `lms/PmLesson6.jsx` — endi kompilyator import qiladi, CRM ro'yxatida yo'q; 12 homework tegilmadi — manbasi o'zgarmagan; `html-compiler.jsx` modul, dars emas). Yig'mada 36px sarlavha CSS bor (tekshirildi). `CHROME=/usr/bin/google-chrome npm run smoke:lms` → **Hammasi ishlaydi** (asl skript Windows Chrome yo'li bilan — Kali'da env shart). DARS_API_URL bo'sh → prod (dars-api.coddycamp.uz). Commit 4: build(lms) |
| 15:08 | **Q1 → B (foydalanuvchi qarori):** PmMetrics + PmJtbd KODING ekranlarida «Bajardim» tugmasi Yordam/⭐ USTIGA, «Bajarildi» chipi o'ng ustunda kod OSTIDA (etalon juftlik saqlandi, 2 fayl, matn o'zgarmagan). Tugma pastki cheti (btn-check.mjs): m8-01 Yordam ochilgach **545 → 545** (oldin 901 ga itarilardi), ⭐ ham ochilsa stage scrollSignal bilan suriladi (tugma 300 da ko'rinadi) · m7-02 **318 → 318**. Done-holat skrinshoti: chip kod ostida, ikkala darsda. Gates 2/2 esbuild ✓ jsx ✓ farq 0 · pm-demo build ✓. Foydalanuvchi: server/GitLab keyin alohida, Axadulla xabari keyin; darslar GitLab/serverga hech qachon chiqmaydi (memory: darslar-gitlabga-chiqmaydi). layout-lint m8-01/m7-02 fonda |
| 15:21 | **layout-lint m8-01/m7-02 (uz, ru; B dan keyin):** xato 0. m8-01 s11 endi pastga tushgan element `div.wsx` (⭐ akkordeon matni: Yordam ochiq 211 · ikkalasi 261) — tugma emas (oldin `button.lp-done-btn` edi); B ning mohiyati shu: tugma joyida, yordam matni skrollda. m7-02 s11: topilma yo'q. Boshqa topilmalar avvalgidek (s6 tegilmaydi, s15 yakun). Fayl: `sweep0916b-{uz,ru}.json`. **Commit 5** |
| 15:33 | **PUSH QILINDI (foydalanuvchi, `! git push origin main`):** origin/main 67bf5a4 → **46b2072** (7 commit: 3a3f51f · 4d4975c · ffc89cc · 4b2a716 · 49f7527 · fff1e54 · 46b2072). Ishchi daraxt toza. Server/GitLab sync — keyin alohida (foydalanuvchi qarori); darslar GitLab/serverga chiqmaydi (qat'iy). Qolgan: CRM'ga lms/ 90 fayl (foydalanuvchi) · KATTA §38/§39 · m1-14 s14 ru · m1-01 s1 · Axadulla xabari |

## 2026-09-16 (kech) — Axadulla 15.09 javobi · F-0916-03 (server `total_questions` ×2) · «har savol sinaldi» dalili (foydalanuvchi tasdig'i bilan, commit KUTADI)

**Kirish:** `JAVOB_DARS_PLATFORM_2026-09-15_UZ.md` — A-variant + arena QABUL, kod/OpenAPI 15.09 tayyor, «`RESULT_DETAILS=a` ni tayyorlik tasdig'imizgacha yoqmang», §5 qo'shma sinov 5 band, §7 rotatsiya rozi. Og'zaki: **MVP = onFinished'dan oladi**, «har bitta savolni sinab ko'rdingizmi?». Foydalanuvchi: «bugun hammasini o'zimiz bajaramiz, ertaga qisqa xabar, keyin prod, 17.09 6 modul CRM'ga». Reja `~/.claude/projects/…/REJA_2026-09-16_AXADULLA_MVP.md` (D1–D3 tasdiqlandi).

**Tashxis (kodga tegmasdan):** unit 53/53 · resultDetails 6/6 · staging/prod health `0.1.0+c04a84b6`, migratsiya 7, `result_details off` · lms 92/92 detallar+arena · 70 lesson_id katalogda · GitLab staging=main=c04a84b (0008 ffc89cc sync'siz) · E2E'da onFinished assert 0 · Docker yo'q.

**🔴 F-0916-03 — `total_questions` 38/70 CRM-darsda oshib ketardi (server).** `INLINE_KEYS`dagi ishtirok-kalitlar (`practice/kadrlar/joy/koding: -1`, s-qolipsiz, PRACTICE_BASE zonasi) `set_quiz_keys` bilan serverga boradi; `lessonQuestions` ularni dars-savoli deb sanardi → PmLesson10: ekranda 4, School API'da 8; `all_correct/first_try/speedster/comeback` hech qachon; arena `order` siljigan (quiz-0 → 9). `answered/correct_answers` to'g'ri edi (`screen_idx ≥ 500` filtri). onFinished'ga ta'sir yo'q. InternetLesson'da ishtirok-kalit yo'q → 09-10 sinovida sezilmagan. **Yechim:** `result-builder.js` `isParticipationKey` (`correct_idx = -1` VA id `s\d+` qolipida emas) → `lessonQuestions` + `questionOrder` chiqaradi; `s16: -1` (yakuniy amaliy ball-ekran, s-qolip) qoladi. Unit 54/54 (yangi test: PmLesson10 kalitlari → total 4, arena order 5, solo payload validate 0) · int **76/76** (lokal PG17 klaster skretchpadda, 5433, `dars_test`) · **`scripts/lint-keys.mjs`** (s-kalitlar to'plami == scored to'plami) 97 dars 0 nomos → `gates.mjs` ga `keys` darvozasi + `npm run lint:keys`.

**«Har savol sinaldi» (Axadulla savoli):** `scripts/smoke-onfinished-all.mjs` (`npm run smoke:onfinished`) — 70 CRM-dars × uz+ru, har ball-savol darsning o'z kalitidan urug'lanadi, «Tamom» bosiladi, 9 invariant (I1 totalQuestions==scored · I2 correctAnswers · I3 questions(test)==MCQ · I4 id/order · I5 matn/kalit/urinish/solved/Z · I6 lang · I7 yutuqlar · I8 arena yo'q · I9 eski maydonlar/pageerror) → **140/140**, 266 s. Dalil: `feedback/lms-sinov-2026-09-16/onfinished-sweep.{json,md}`. Birinchi yugurishda 139/140: PmLesson9 ru — regex `далее` nav-tugmasini bosgan → yakun tugmasi `.last()` + regex toraytirildi. Halol chegara: payload-yig'ilishi sinaladi (bosish yo'li emas).

**E2E jonli onFinished:** `tools/e2e-lms.mjs` 18 → **22/22** (`src/lms-harness/main.jsx` payload'ni `window.__onFinished`ga yozadi): mentor 4-ekran (RPC `advance_session`) → Ali s4 bosadi → `live_answers` · mentor 21 + `quiz_control` lobby → Ali kapsula → 0-savol → `.qz-tile` → quiz-0 serverda · Erkin qilish → sweeper `live_ended` → Ali F5 = ko'rish rejimi, 21-ekran → «Tamom» → payload: s4 `kind: test` 1 urinish server bilan bir xil · quiz-0 `kind: arena` 1 urinish · test soni == serverdagi answered · lang · achievements. Ikki asbob-saboq: (1) `PUT /me/progress` `client_ts` +5000 ms sahifaning keyingi yozuvini «eskirgan» qiladi (s4 yo'qoldi) → +1 ms va kalitni kutish; (2) sessiya yopilgach urinish `finished` bo'lguncha F5 bosilsa join `student` qaytaradi va localStorage klampi 20-ekranga tushiradi → avval `finished` kutiladi. O'quvchi mentorni o'zi bosib ergashadi (avto-sakrash yo'q) — sinovda server-progress bilan ekranga qo'yildi.

**Sinov-kuni asboblari:** `lms-staging/` (gitignored) — Internet + PmLesson10 staging manzili bilan (CRM test-guruh materiali) · `server/tools/resend-event.mjs <api> <event_id> [--mutate]` — aynan takror 200 duplicate / o'zgargan 409 (lokalda soxta School API bilan 200 ✓ / 409 ✓; JSONB'dan, kalit-tartibi worker bilan bir xil).

**Hujjat/muhr:** SINOV_PROTOKOLI §9 (15.09 javob ↔ kod jadvali, §5 ↔ §5.3 xaritasi) + §8-1 yopildi · ov-bandi: `darslik-jonli.md` 2.4b, `darslik-tekshiruvchi.md`, `pm-tekshiruvchi.md` · xabarlar: `feedback/lms-sinov-2026-09-16/xabar-axadulla-2026-09-17.md` (uz), `xabar-kristina-result-details-staging.md` (ru, faqat Axadulla signalidan keyin). CLAUDE.md'dagi «beshalasi» endi oltita (`keys`) — CLAUDE.md foydalanuvchi roziligi bilan yangilanadi.

**Qolgan (buyruq bilan):** commit 3 (server / asboblar+harness / hujjatlar) → push → `sync-dars-api.sh staging` (0008 + F-0916-03) → staging-check → ertaga `sync main` + deploy tugmasi + prod-check → CRM 92 → Axadulla «tayyor» → Kristina staging `RESULT_DETAILS=a` → §5 qo'shma sinov → prod bayroq → rotatsiya.

## 2026-09-17 (sahar) — ERTAGA_TARTIB A-bo'lim: commit 3 → push → sync staging → staging-check 19 ✓ (foydalanuvchi: «boshladik, A → B → C»)

| Vaqt | Nima |
|---|---|
| 07:25 | Commit-oldi: server unit **54/54** · lint:jsx 156 → 0 · `feedback/lms-sinov-2026-09-16/` sir-grep toza (token/parol yo'q). Ishchi daraxt kechagi muhr bilan bir xil (12 M + 4 yangi) |
| 07:28 | **COMMIT 3 (buyruq):** cc67267 fix(server) F-0916-03 + unit + resend-event · cd175e4 test(onfinished) sweep 140/140 + E2E 22/22 + lint-keys (gates 6) · 231c0de docs SINOV §9 + ov-bandlari + jurnal + xabarlar. Ishchi daraxt toza |
| 07:30 | pull-dars-api staging: begona commit yo'q (origin/staging = c04a84b). **PUSH (foydalanuvchi):** origin/main 46b2072 → **231c0de** (4 commit, fcb6efc bilan) |
| 07:36 | **SYNC STAGING (foydalanuvchi):** GitLab staging = **05549db** (manba 231c0de; ichida 0008 migratsiya + F-0916-03). Deploy poll: 07:37–07:41 c04a84b6, **07:41:14 → 0.1.0+05549dbb** (~4.5 daqiqa) |
| 07:41 | **staging-check to'liq: 19 ✓ · 0 ✗ · 0 ⚠ · 1 o'tkazildi (jwt_next — rotatsiya boshlanmagan).** health 05549dbb · **migratsiya 8/8** · katalog 110 · bridge on · worker on · **details off** · mentor_flow pin 111080 ✓ · School API ✓ · p50 142 ms. A-bo'lim YOPILDI |
| 07:43 | B-oldi tekshiruv: GitLab main'da begona commit yo'q (main = c04a84b, bizniki); prod hozir c04a84b6 · migratsiya 7 · details off. `pull-dars-api.sh main` skriptini klassifikator «Production Deploy» deb blokladi → o'sha tekshiruv `git fetch + log` bilan qo'lda (faqat o'qish) bajarildi. **Keyingi (foydalanuvchi):** Axadulla xabari (vaqt joyi) → `! bash scripts/sync-dars-api.sh main` → GitLab deploy tugmasi → men prod-check --read-only → CRM 92 → test-guruh lms-staging 2 fayl |
| 08:00 | **B-bo'lim:** foydalanuvchi Axadullaga xabarni yubordi (`xabar-axadulla-2026-09-17.md`, vaqt to'ldirilgan) · **SYNC MAIN (foydalanuvchi):** GitLab main = **07de86e** (manba 231c0de) · GitLab deploy tugmasi (manual job) bosildi ~08:05 |
| 08:09 | **PROD DEPLOY CHIQDI: 0.1.0+07de86e1** (poll 08:09:52). **prod-check --read-only (`.env.deploy.prod`): 17 ✓ · 0 ✗ · 0 ⚠ · 3 o'tkazildi** (jwt_next · mentor_flow · school_api — read-only). **migratsiya 8/8** · katalog 110 · bridge on · worker on · **details off** · admin navbat bo'sh · p50 131 ms. Staging va prod endi bir xil kodda (F-0916-03 + 0008). Asbob-saboq: prod-check uchun `.env.deploy.prod` (staging env-fayli bilan `env` bandi yiqiladi — birinchi urinish to'xtatildi). **Qolgan (foydalanuvchi):** CRM 92 fayl (lms/ prod manzili bilan, qayta yig'ish shart emas) · test-guruhga lms-staging 2 fayl · Axadulla signali → C-bo'lim |
| 08:30 | **AXADULLA «GO» (C-bo'lim ochildi):** School API prod'da yangi kod · control DB migratsiyasi ✓ · `lang/questions[]/achievements[]` qabul · CRM live-token ✓ · takror 200 / o'zgargan 409 tayyor · «alohida staging endpoint yo'q — sizning staging'dan bizning prod School API'ga test event_id bilan» · «`RESULT_DETAILS`ni test uchun yoqishingiz mumkin». **Tekshirildi (kod o'zgarmaydi):** staging `.env.deploy` `CODDYCAMP_SCHOOL_API_URL=https://school-api.coddycamp.uz` — 09-08 pilotdan beri shu (yagona manzil) · `already_rewarded` o'tkazib yuborish FAQAT solo yo'lida (`enqueueSoloAttempt`) — jonli sessiya har safar yangi hodisa, test-o'quvchilar 31352/31422 qayta ishlatiladi · `event_id` deterministik `sess_<pin>_<isoBasic(startedAt)>` — «maxsus test event_id» = sessiyadan keyin aniq qiymatni aytamiz. Javob-loyiha: `feedback/lms-sinov-2026-09-16/xabar-axadulla-2026-09-17-javob2.md`. **Keyingi:** foydalanuvchi → Kristinaga `xabar-kristina-result-details-staging.md` (ru) → staging `RESULT_DETAILS=a` + restart → men staging-check `details a` (lokal `.env.deploy.staging` ham `a` ga — aks holda features ⚠) → qo'shma sinov |
| 12:58 | **🔴 HODISA — staging eski tasvirga tushdi (F-0917-01, infra):** Kristina `RESULT_DETAILS=a` qo'yib konteynerni QO'LDA qayta yaratdi («готово») → health **0.1.0+47d27f1** (09-08 tasviri: `features`/`checks.migrations`/`client` yo'q, F-0916-03 va 0008 kodi yo'q). Sabab: serverdagi `.env.deploy` da `IMAGE_TAG=latest` + eski `GIT_SHA`; to'g'ri tegni faqat CI `export IMAGE_TAG=$CI_COMMIT_SHORT_SHA` qo'yadi — qo'lda `compose up -d` eski lokal tasvirni oladi. Kod tekshirildi: `RESULT_DETAILS` compose `environment:` blokida yo'q → `env_file` dan to'g'ridan keladi (qator yetarli, lekin konteyner qayta YARATILISHI shart). Prod tegilmagan (07de86e1 · details off). **Yechim:** GitLab staging pipeline 05549db → `deploy` job → Retry (foydalanuvchi, Maintainer). Lokal `.env.deploy.staging` `RESULT_DETAILS=a` ga o'tkazildi |
| 13:20 | Poll 12:59–13:20 (80×15 s): hali 47d27f1 — Retry bosilmagan/yetib kelmagan. staging-check (eski tasvirda): 15 ✓ · **2 ✗** (migrations, catalog — health maydonlari yo'q) · 2 ⚠ · mentor_flow ✓ · School API ✓. Kuzatuv: admin navbat `manual_review` 2 → **3**, `solo 1` faol — qayta deploy'dan keyin admin'da qaysi hodisa ekanini ko'rish (eski kod yuborgan bo'lishi mumkin). **Saboq (runbook'ga):** env o'zgarsa → Retry deploy-job, qo'lda `up -d` EMAS |
| 14:04 | **STAGING TIKLANDI (foydalanuvchi Retry deploy-job, pipeline #2856500842):** 14:04:40 → **0.1.0+05549dbb**. staging-check to'liq: **18 ✓ · 0 ✗ · 1 ⚠ · 1 o'tkazildi** — migratsiya 8/8 · katalog 110 · bridge on · worker on · **details a ✓** (C-10 yopildi) · mentor_flow pin 546808 ✓ · School API ✓. **⚠ proxy_ip (yangi, ertalab ✓ edi):** staging soxta `X-Forwarded-For: 203.0.113.9` ni qabul qilyapti (`client.ip` = soxta qiymat; prod rad etadi — 185.213.229.58) → Kristina bugun `.env.deploy` ni tahrirlaganda `TRUST_PROXY` o'zgargan (hamma zanjirga ishonadi). Ta'siri faqat rate-limit aylanib o'tish, staging'da; sinovga to'siq EMAS. Kristinaga: `TRUST_PROXY=loopback,172.16.0.0/12` (yoki qatorni o'chirish — compose default shu) + Retry deploy-job. Admin navbat: delivered 2 · manual_review 3 · faol live 1 solo 1 — sinovdan oldin `lms-watch --once` bilan ko'riladi |
| 14:20 | **🔴 F-0917-02 TOPILDI (kontrakt, tashxis — [GATE] kutadi, kod o'zgarmagan):** staging navbatidagi 3 ta `manual_review` hammasi **HTTP 422 `The students.0.badges field is required.`** — `solo_31347_internet…0910`, `solo_35813_internet…0908`, `solo_34174_agent-arch…0908` (auto_7d, 09-15 va 09-17 da yuborilgan; uchinchisi yangi kod 05549dbb ostida). Payload: `badges: []`, `badges_count: 0`, answered 0, completed false. **Sabab:** School API (Laravel) `required` qoidasi BO'SH MASSIVNI «yo'q» deb hisoblaydi; bizning §7.3 validator bo'sh massivni to'g'ri deb o'tkazadi. Dalil-juftlik: yetkazilgan 2 hodisada nishon bo'sh emas (`31352:[top_2,graduate,arena_top_1] 31422:[top_1]` · `37069:[top_1,graduate,arena_top_1]`), rad etilgan 3 tasida bo'sh. **Xavf:** `badgesFor` nishonsiz o'quvchiga `[]` qaytaradi (top-3 emas, oxirigacha yetmagan, hammasi to'g'ri emas) — jonli sinfda 4+ o'quvchi bo'lsa bittasi bo'sh chiqishi deyarli aniq → BUTUN hodisa 422 → guruhda HECH KIM natija/tanga olmaydi. Pilotda 1–2 o'quvchi (doim top_N) — shuning uchun sezilmagan. `RESULT_DETAILS`ga bog'liq emas. Prod navbati bo'sh (zarar yo'q, haqiqiy dars hali o'tmagan). **Yechim variantlari:** A) Axadulla: `students.*.badges` → `present\|array` (to'g'ri tuzatish, ularning tomoni) · B) biz: bo'sh qolmasin — hamma qatnashchiga `participant` nishoni (tanga-ma'nosi LMS'da — Axadulla bilan kelishish kerak) · ikkalasi birga eng xavfsiz. 3 hodisa tuzatishdan keyin admin `requeue` bilan qayta yuboriladi. Sinov-ssenariyga qo'shiladi: oxirigacha yetmagan 2-o'quvchi (bo'sh nishon) |
| 14:45 | **F-0917-02 TUZATILDI (foydalanuvchi: «3-variant, Axadullaga xabar yozib ber»; commit KUTADI):** `badgesFor` ro'yxat bo'sh qolsa `participant` (faqat shu holda — kontraktda kalitlar yopiq ro'yxat emas; Axadulla 15.09: «coin formulasi yoqilmagan, `pending_policy`» → hozir tanga bermaydi) + `validatePayload` «badges bo'sh» + soxta School API va int-stub Laravel `required` ni AYNAN takrorlaydi. unit **55/55** · int **76/76** (lokal PG17 yangi skretchpadda, 5433, faqat TCP — socket yo'li 107 baytdan uzun edi) · teskari isbot: tuzatishsiz `results.test.js` 9 ✓ 1 ✗ (auto_7d). Muhr: SINOV_PROTOKOLI §10. Xabar: `feedback/lms-sinov-2026-09-16/xabar-axadulla-2026-09-17-badges-422.md` (event_id + X-Request-Id + `present\|array` so'rovi + `participant` bo'yicha 2 savol; lint:til ✓). **Keyingi (buyruq):** commit → push → `sync-dars-api.sh staging` → staging-check → o'zimiz qo'shma sinov (bo'sh-nishonli 2-o'quvchi bilan) |
| 15:20 | **COMMIT 2 (buyruq) + PUSH (foydalanuvchi):** ef7a5e2 fix(server) F-0917-02 · 42bd48d docs → origin/main = **42bd48d**. Foydalanuvchi badges-422 xabarini Axadullaga yubordi. Eslatma: birinchi «push va sync qildim» xabarida ikkalasi ham masofaga yetmagan edi (`git ls-remote` bilan tekshirildi: GitHub 231c0de, GitLab 05549db) — staging-check o'sha holatda yurgizilmadi, buyruqlar shu oynada qayta berildi |
| 15:52 | **SYNC STAGING (foydalanuvchi):** GitLab staging = **00bb280** (manba 42bd48d) → avto-deploy 15:52:11 **0.1.0+00bb280b**. staging-check: **17 ✓ · 0 ✗ · 2 ⚠ · 1 o'tkazildi** — migratsiya 8/8 · katalog 110 · **details a** · mentor_flow pin 324676 ✓ · School API ✓. ⚠ proxy_ip (ma'lum — Kristina TRUST_PROXY) · ⚠ latency p50 280 / p95 668 ms (restartdan keyingi birinchi daqiqa; qayta o'lchov quyida). Navbat: delivered 2 · manual_review 3 (F-0917-02 ning eski 3 tasi, Axadulla tuzatishini kutadi) · faol 0. **F-0917-02 himoyasi staging'da.** Keyingi: o'zimiz sinov (test-guruh, lms-staging 2 fayl) → sync main → deploy tugmasi → prod-check |
| 16:00 | **SEANS MUHRI (foydalanuvchi: «holatni to'liq saqla, 2–3 soatdan keyin yangi seansda davom etamiz»):** GitHub main = 42bd48d · GitLab staging = 00bb280 (server `00bb280b`, details a, F-0917-02 himoyasi BOR) · GitLab main = 07de86e (prod `07de86e1`, details off, himoya YO'Q). Ishchi daraxtda faqat STATE + `feedback/lms-sinov-2026-09-16/DAVOM_2026-09-17_KECH.md` UNCOMMITTED. Lokal PG17 to'xtatildi (skretchpad seansga xos). **Yangi seans DAVOM faylidan boshlaydi:** 0) lms-staging 2 fayl CRM test-guruhda bormi — javob kerak · 1) o'zimiz sinov (uch oyna; O2 javobsiz → `participant` jonli isboti; resend 200/409; PmLesson10 total 4) · 2) sync main + deploy tugmasi + prod-check (`.env.deploy.prod`) · 3) Kristinaga prod bayroq + staging TRUST_PROXY (Retry deploy-job bilan) · 4) CRM yuklash (parallel; 4+ o'quvchili jonli dars 2-qadamdan keyin) · 5) Axadulla tuzatgach 3 hodisa requeue |

## 2026-09-18 (sahar) — F-0917-02 YOPILDI: Axadulla `present|array` ✓ → 3 eski hodisa requeue 201 ×3 · CRM holati aniqlandi (bo'sh)

| Vaqt | Nima |
|---|---|
| 07:31 | Seans-boshi tekshiruvi (faqat o'qish): GitHub main = 42bd48d · GitLab staging = 00bb280 (server `00bb280b`, details a, migratsiya 8) · GitLab main = 07de86e (prod `07de86e1`, details off, migratsiya 8) — kechagi muhr bilan AYNAN bir xil. Staging admin navbat: delivered 2 · manual_review 3 (o'sha 422-uchlik) |
| 07:35 | **Kirish (foydalanuvchi, Telegram skrinshot):** Axadulla 17.09 16:52 School API `main`ga `fix: accept empty Dars platform badges` (pipeline #2857934700), «10 minutlada prod da boladi». Tashxis: bizning staging o'sha `school-api.coddycamp.uz`ga yuboradi → saqlangan `badges: []` payload'lar tuzatishning eng toza dalili. Taklif (bittasi sinov → qolgani → verify) — foydalanuvchi: «taklifing maqul» |
| 07:40 | **REQUEUE ×3 (staging admin `POST /admin/api/results/:id/requeue`):** `solo_31347_internet-01-v18_…` → 2 s ichida **delivered, HTTP 201** (req `54645ade-…`), payload `badges: [[]]` o'zgarmagan · `solo_35813_…` → **201** (`41d62bed-…`) · `solo_34174_agent-arch-06-04-…` → **201** (`dfe305c6-…`). `GET …/verify` uchalasi: School API `lesson-results/{event_id}` **200 found** (lesson_title, mode solo, vaqtlar `Z`). Navbat: **delivered 5 · manual_review 0 · attention 0.** F-0917-02 A-varianti ISHLADI; B-himoya (`participant`) qoladi. Muhr: SINOV_PROTOKOLI §10 «Yopilish» qatori. DAVOM navbat 5 ✅ |
| 07:42 | **CRM holati (foydalanuvchi javobi, 4-so'rovda):** `lms-staging/` 2 fayl CRM'da YO'Q; umuman hozir CRM'da hech narsa yo'q; «qaysi birini nima qilishni aytsang, qilaman». Ko'rsatma berildi: HOZIR faqat `lms-staging/InternetLesson.jsx` + `lms-staging/4-M/PmLesson10.jsx` → CRM test-guruh (1070/1072) materialiga (staging manzili — oddiy guruhlarga EMAS); `lms/` 102 fayl (prod manzili) → prod-sinovdan keyin. **Keyingi:** foydalanuvchi CRM test-material → o'zimiz sinov (uch oyna, DAVOM 1-qadam) → sync main + deploy → Kristina → CRM 102 |
| 08:10 | **O'zimiz sinov boshlandi.** CRM: «Test uchun» → «sinov test» → 1-sinov dars (InternetLesson.jsx uz+ru, 2848) + 2-sinov dars (PmLesson10.jsx, 2849). CRM'dagi fayl md5 == `lms-staging/InternetLesson.jsx` (staging manzili) ✓. `lms-watch` fonda (`watch-0918.log`), boshlang'ich: faol 0, navbat 5 delivered |
| 08:33–08:47 | **Jadval:** 08:33 Umid 31347 (1-guruh) solo — mentor hali yo'q; «Natijani ko'rish» kutilgan (eski solo natijasi bugun yetkazilgan) · 08:35 **1-guruh mentor: darvoza + «Server javob bermadi (xato 400)»**, jonli sessiya ochilmadi · 08:37:57 **2-guruh (gid 1072, mentor 240): LMS-token bilan avtomat, kod 018937 [1ffe8101]** · 08:38 Nigora 31352 qo'shildi · 5 test (3 to'g'ri), 3 yutuq (packet/router/graduate), 21-ekran arena 3/12, 1-o'rin, oxirigacha ✓ · Sherzod 31422 KIRMADI (`participant` jonli isboti yo'q) · 08:47 «Erkin qilish» → hodisa `sess_018937_20260918T033756Z` → **422 manual_review** · LMS tomonida onFinished yetdi (`question_try` 200: 5 savol, 3 to'g'ri, 60%, passed; `next_lesson_access` completed, coins 0), keyin LMS «Hali bu darsga kelmagansiz» modali (LMS davomat-mantiqi). HAR: `~/Downloads/lms.coddycamp.uz.har` (334 so'rov, 4xx/5xx yo'q, staging 130–250 ms) |
| 09:05 | **F-0918-01 (UX, tasdiqlangan):** noto'g'ri mentor-kod → PG `raise 'Mentor kodi noto''g''ri'` → error-handler 400 `domain_error` → klient `startMentor` faqat 401/403 ni «kod noto'g'ri» deb biladi → «Server javob bermadi (xato 400)». Staging'da takrorlandi (`/api/v1/live/rpc/create_session` soxta kod → 400). 1-guruhda LMS token bermay turganda kod kiritilgan deb taxmin (2 savol foydalanuvchiga ochiq). Yechim: serverda shu PG-xabar → 403 (klient tayyor: «Mentor kodi noto'g'ri.»), darslar qayta yig'ilmaydi |
| 09:15 | **🔴 F-0918-02 (kontrakt, prod `details a` uchun TO'SIQ):** School API 422 — 40 xato = 8 arena-yozuv × 5: `questions.N.question/options/correct_answer/attempts.N.answer` «required» + `attempts.N.option must reference an item in options`. 5 test-yozuv to'liq. **Sabab:** `logArena`/`submit_answer` matn yozmaydi (test-javobda `recordAttempt` texts yozadi), `result-builder` arena-yozuvni matnsiz chiqaradi; `validatePayload` bu maydonlarni ixtiyoriy deb bilardi, soxta API/int-stub Laravel qoidasini takrorlamagan (F-0917-02 bilan bir sinf) → sweep 140/140 va E2E 22/22 tutmadi. Prod bugun xavfsiz (details off → `questions[]` ketmaydi). **Kristina prod-bayroq so'rovi shu tuzatilguncha KUTADI** |
| 09:20 | **Kuzatuv taymautlari (08:22–08:24, 08:47–08:49) server EMAS:** HAR'da o'sha daqiqalarda staging 130–250 ms, admin `sessions?limit=30` 0,5–0,7 s, uptime uzilmagan → asbob/VM-tarmoq. Nishon-mantiq savoli (mashq-yutuq qayta urinishda beriladi): ikki qatlam tushuntirildi (dars-yutuq = mashq-yakun, School API `first_try/all_correct` = birinchi urinish) — qaror foydalanuvchida, KATTA-nomzod |
| 09:30 | **[GATE] foydalanuvchi qarori:** 1) server: F-0918-02 himoya (matnsiz yozuv `questions[]`dan chiqadi) + validator/soxta API/int-stub Laravel-qoidalari + F-0918-01 403 → 2) qayta sinov (Sherzod bilan) → 3) prod → 4) Axadulla xabari **HOZIR** (parallel) → 5) KATTA: darslar arena matnini serverga ham yozadi (Axadulla MVP onFinished'dan oladi — ikkalasi ham beriladi, «istasang ol»). «Shoshilmasdan baglarni fix qilib ishlatamiz». Xabar: `feedback/lms-sinov-2026-09-16/xabar-axadulla-2026-09-18-arena-422.md` (lint:til ✓) |
| 10:30 | **F-0918-02 + F-0918-01 TUZATILDI (server, commit KUTADI):** `result-builder.js` — (1) `isCompleteQuestion` (School API `required`: question · options bo'sh emas · correct_answer · har urinishda answer · option ∈ options) → `buildStudentDetails` matnsiz yozuvni `questions[]`ga KIRITMAYDI (hozir arena shunday); (2) urinishda matn bo'lmasa `answer` va `correct_answer` variantlar ro'yxatidan tiklanadi (`options[option]`); (3) `validateStudentDetails` matn-maydonlarini MAJBURIY qiladi (bo'sh satr/massiv = yo'q, `q option` «must reference an item in options»); (4) `finalizePayload` detallarni O'QUVCHI-darajasida tashlaydi (bittasi buzuq → faqat o'shaniki, qolganlar ketadi; `detailsDropped` ro'yxat). `errors.js` — PG raise «Mentor kodi noto'g'ri» → **403 forbidden** (klient tayyor). `fake-school-api.mjs` + int-stub Laravel-qoidasini AYNAN takrorlaydi (xabar-matni ham). Testlar: unit **57/57** (yangi: isCompleteQuestion 8 holat, arena matn bilan kiradi, o'quvchi-darajasida tashlash, `errors.test.js` 403) · int **76/76** (results_details: s9 matnli, quiz-0 matnli → to'liq arena-yozuv, quiz-1 matnsiz → yo'q; live_api: 403) · oxlint toza (eski 1 ogohlantirish staging-check). **Dalillar:** teskari isbot — filter o'chirilsa validator o'quvchi detallarini tashlaydi (2-qatlam ishlaydi, hodisa 201) · **staging payload `sess_018937` → soxta API: 422, 40 kalit, 5 tur × 8 — staging javobi bilan AYNAN bir xil.** Keyingi: commit (buyruq) → push → sync staging → staging-check → qayta sinov (Sherzod bilan) |
| 09:45 | **1-guruh aniqlandi (foydalanuvchi + DevTools):** mentor darvozada `MENTOR-2026` terdi → `POST /api/v1/live/rpc/create_session` **400**, Content-Length 58 = `{"error":"domain_error","message":"Mentor kodi noto'g'ri"}` (req `84ac48f4-01d5-43b9-9915-8080d42c41cb`, 09:38). Staging `LIVE_MENTOR_CODE` ≠ MENTOR-2026 (demo-kod) → kod haqiqatan noto'g'ri edi, dars esa «server xatosi» dedi — **F-0918-01 to'liq tasdiqlandi** (tuzatish: 403). **F-0918-03 (LMS tomoni):** 1-guruhda LMS `preview` darsga live-token BERMAGAN — mentor-tab tarmog'ida `lms/join` yo'q (20 so'rov: faqat create_session ×2), 2-guruhda (1072) o'sha mentor bilan darhol kelgan. Axadulla xabariga 3-savol qo'shildi (mentor_launch id'lar bilan). Foydalanuvchi izoh-matni bo'yicha maslahat: «prodga chiqarib» EMAS (staging edi), «sizning kamchiligingiz» EMAS (asosiy tuzatish bizda, so'rov ixtiyoriy) |
| 10:05 | **COMMIT 2 (buyruq) + PUSH (foydalanuvchi) + SYNC STAGING (foydalanuvchi):** b188ad9 fix(server) F-0918-02 + F-0918-01 · e9c7c67 docs → origin/main = **e9c7c67** (ls-remote ✓) → GitLab staging = **796cbcd** → deploy 10:03:00 **0.1.0+796cbcd4** (≈4 daqiqa). **staging-check: 18 ✓ · 0 ✗ · 1 ⚠ (proxy_ip, Kristina) · 1 o'tkazildi** — migratsiya 8/8 · katalog 110 · details a · mentor_flow pin 384649 ✓ · School API ✓ · p50 159 ms. **F-0918-01 jonli:** `MENTOR-2026` → **403** «Mentor kodi noto'g'ri» ✓. `sess_018937` requeue → yana 422: payload navbatga tushganda muhrlanadi (`finalizePayload` enqueue'da, yuborishda emas — idempotentlik) → eski hodisa manual_review'da qoladi, faqat yangi sessiya o'tadi (kichik g'oya: admin «requeue --refinalize» faqat yetkazilmagan hodisalar uchun — KATTA emas, keyinroq). Axadulla xabari foydalanuvchi tomonidan yuborilmoqda. **Keyingi:** qayta sinov 2-guruhda (mentor + Nigora + Sherzod javobsiz → arena → Erkin qilish → 201 + participant; resend 200/409; PmLesson10 total 4) |
| 11:00 | **QAYTA SINOV (2-guruh, 1072) — F-0918-02 STAGING'DA YOPILDI.** Noutbuk o'chib qolgan (10:20) → `lms-watch` 10:24 da qayta yoqildi (o'sha `watch-0918.log`ga qo'shib yozadi). Sessiya `cd14a328` · pin **192590** · mentor 240 · o'quvchi Nigora 31352 (crm 12639) · 10:31→10:59. Mentor `lms/join` 200 (token keldi — F-0918-03 bu guruhda takrorlanmadi) · 5 ichki savol (`record_attempt` matn bilan ×5) + arena 4 javob (quiz-0/1/2/11, `submit_answer` — matnsiz, hozircha shunday, KATTA §40) · `end_session` 204 ×2. **Natija `sess_192590_20260918T053145Z`: delivered · HTTP 201 · verify ✓ (LMS tomonida topildi)** — ertalabki `sess_018937` aynan shu ssenariyda 422 ×40 bergan edi. Payload: `total_questions` 5 · `questions[]` = s4·s5b·s9·s12·s15, hammasi matn+options+correct_answer bilan, **arena-yozuv yo'q** (himoya ishladi) · answered 5 · correct 2 · rank 1 · `badges` [top_1, graduate, arena_top_1] · achievements 4. onFinished (HAR → `question_try` q 16594, 200): savollar 9 · elapsed_ms 9/9 · `at` 9 xil · earned_at 4 xil · solved 5/4 · Unicode ✓. LMS `next_lesson_access` → completed, coins 0 (tries 3 · applied_tries 0 — takror urinish); «Hali bu darsga kelmagansiz» modali yana chiqdi (LMS tomoni, Axadullaga savol allaqachon berilgan). **Tarmoq-kuzatuv:** sekin so'rovlar (o'quvchi 10 · mentor 20 ta >2 s, maks 14 s) deyarli butunlay `connect`/`ssl`/`blocked` fazasida, server `wait` ≈ 200 ms; go.coddycamp.uz ham shu paytda p95 5 s → noutbuk tarmog'i, server emas (istisno: 10:32:25 `wait` 5,2 s ×2 bir vaqtda — bir martalik, kuzatiladi). Dalillar: `feedback/lms-sinov-2026-09-16/sinov-0918-192590/` (sessiya · schoolapi-payload · verify · onFinished · xabar-loyiha). **Sinalmadi:** javobsiz o'quvchi → `participant` (Sherzod qo'shilmadi, o'quvchi 1) · resend 200/409 · PmLesson10 total 4. **Keyingi:** shu uchtasi → prod (sync main + Retry deploy-job) |
| 12:10 | **F-0918-04 (foydalanuvchi, retsept B) — AMALIY TOPSHIRIQ NISHONI FAQAT BIRINCHI URINISHGA.** Fikr: «drag-dropda 1-marta xato urindi, 2-sida topdi — nishon shart emas; 1-martada to'g'ri qilsa bersin, shunda nishon qiymatli tuyuladi». **Tashxis:** `InternetLesson.jsx` s13b (o'yin) va s13c (tartiblash) `onAnswer` ni faqat muvaffaqiyatda, doim `correct: true` bilan chaqiradi → xato urinish sanalmaydi, nishon «tekin»; test savoli (s4 firstwin) esa azaldan `firstAttemptCorrect` — bitta darsda ikki o'lchov. Bugungi sinovda Nigora: test 2/5, nishon 4/4. Qamrov: `ACH_TRIGGERS` 98 faylda 343 trigger, **195 tasi test emas (76 fayl)**. **[GATE] foydalanuvchi:** 1 qonun → 2 pilot → 3 KATTA — ma'qul; o'quvchi bemalol qayta urinib to'g'risini topadi, lekin nishon berilmaydi; «Qaytadan» imkonni QAYTARMAYDI. **Qilindi:** (1) `DARS_ETALON.md` **151-qonun** (5 band: birinchi urinish · «urinish» = tekshirilgan TO'LIQ javob, mexanika-jadvali · shart oldindan aytiladi · jazo ohangi yo'q · belgi progressda, F5/«Qaytadan» o'chirmaydi) + 10-bo'limdagi «hammasi REAL ochilsin» jumlasiga aniqlashtirish-ishora (mumkin ≠ kafolat). (2) Pilot `src/1-Modull/InternetLesson.jsx`: `AchMissCtx` + `AchRule` (bitta xira qator, mentor ekranida va nishon olingach yo'q) · ildizda `missedRef/missed/missTry`, `recordAnswer` sharti `!missed`, `progWrite` ga `missed` (effekt-deps'da — xatodan keyin darhol F5 teshigi yopiq) · s13b `bounce` → miss · `DragDropOrder` ga `onWrong` (to'liq xato joylash) → s13c miss. Server/School API/umumiy `src/live/` ga TEGILMADI (`progressSync` o'z maydonlarini oq ro'yxat bilan yuboradi — `missed` serverga ketmaydi). (3) `MATN_KORPUS.md` **§183** — ikki holat uchun oltin-gap uz+ru (hamma darsda aynan shu) + 4 ❌; nishon `desc` o'zgarmadi (§63 48 belgi; §133 — endi rost gap). (4) `KATTA_TOZALASH.md` **§41** — sweep rejasi: avval saralash (61 exploration + 29 case triggerining bir qismi 10-bo'lim taqiqiga zid bo'lishi mumkin → foydalanuvchi qarori ro'yxat bilan). **Dalil:** boshsiz Chrome (playwright-core, `feedback/F-0918-04/ach-test.mjs` + 4 skrinshot) — A: xato server → qator «lost», `missed:[s13b]`, F5 dan keyin turibdi, yutgach `earned:[]`, bayram yo'q · B: birinchi urinishda → `earned:[router]`, bayram bor, qator yo'qoldi · C: xato tartib → tuzatdi → solved, nishon yo'q · D: «Qaytadan» → screen 0, `missed` turibdi · konsol xatosi 0. **Darvozalar:** esbuild ✓ · jsx ✓ · keys ✓ · prompt ✓ · `lint:jsx` 156 fayl toza · **dark 🔴 11 va til 🔴 4 — ESKI QARZ** (HEAD nusxasida aynan 11 va 4; yangi topilma 0; til: «tavsiya etiladi» ×3 q.530/555/2059 + «bosasiz-ku» q.1548 — matn so'roqsiz o'zgarmaydi, qaror kutadi). LMS yig'malari (`lms/`, `lms-staging/`) va CRM nusxasi QAYTA YIG'ILMADI — jonli sinov aralashmasin. Commit YO'Q |
| 13:40 | **F-0918-04 davomi — «BIRINCHI O'TISH — HISOB, QAYTADAN — MASHQ» + server: takror jonli natija yuborilmaydi.** Anglashilmovchilik ochildi: foydalanuvchi «qaytadan» deganda topshiriq ICHIDAGI qayta urinishni nazarda tutgan (u to'g'ri ishlayapti), men esa yakun ekranidagi «Qaytadan» tugmasini so'ragan edim. **Foydalanuvchi qarori:** topshiriq ichi — hozirgidek; yakun ekranidagi «Qaytadan» — mashq, nishon ko'paymaydi/kamaymaydi; asosiysi **«bir darsdan faqat bir marta jo'natamiz, bo'lmasa nishonlar ko'payib ketadi»**; Axadullaga yozilmaydi — «ikkinchi urinishdagini o'zimiz bermaymiz». **Tashxis (jo'natish kanallari):** server→School API solo — tanga-qoidasi azaldan bor (`hasRewardedResult`, tugagan urinishga yozuv 409) ✓ · **jonli — qoida YO'Q edi** (har sessiya hammani yuborardi; Nigora shu dars bo'yicha kamida 2 marta yetkazilgan) · `onFinished` — «Qaytadan» jo'natishdan OLDIN bosiladi, shuning uchun mashq-o'tishining javoblari ketardi · eski teshik: mashq-o'tishida TEST nishoni (`firstwin`) olinardi. **Klient (pilot `InternetLesson.jsx`):** `firstPassRef` — «Qaytadan» bosilgan onda `{answers, durationSec}` muhrlanadi (progressda, F5 o'chirmaydi) → `earn` jim qaytadi (nishonlar muzlaydi) · `AchRule` ko'rinmaydi · `QuestionScreen` mashqda `submitAnswer`/`recordAttempt` chaqirmaydi · `finishLesson` hamma hisobni birinchi o'tishdan oladi. Brauzer-sinov (boshsiz Chrome, `feedback/F-0918-04/ach-test.mjs` + `harness.jsx`): A–C avvalgidek ✓ · **D** «Qaytadan» → screen 0, earned o'zgarmadi, `firstPass` muhrlandi ✓ · **E** mashqda s4 to'g'ri → `firstwin` berilmadi, bayram yo'q, s13c da `AchRule` yo'q ✓ · **F** mashqdan keyin «Darsni yakunlash» → `onFinished` ×1: s4 picked 0 (birinchi o'tish), to'g'ri 1/5, 603 s, nishon `[graduate]` ✓ · konsol xatosi 0. Darvozalar: esbuild ✓ jsx ✓ keys ✓ prompt ✓ `lint:jsx` toza · dark 11 / til 4 — o'sha eski qarz, yangi 0. **Server:** migratsiya **0009** (`result_events.status` ga `skipped`) · `result-service.js` `rewardedStudents` + `enqueueLiveSession`: shu dars bo'yicha oldin TUGALLANGAN natijasi yuborilgan/yuborilayotgan (pending·retry_wait·delivered) o'quvchi jonli hodisadan chiqariladi; hammasi takror → `skipped`/`already_rewarded` (yuborilmaydi, yozuv qoladi, sweeper qayta olmaydi). **To'smaydi:** `completed:false` (uzilgan dars) va `manual_review` (LMS'ga yetmagan — bugungi `sess_018937` holati). Bayroq `RESULT_LIVE_REPEAT=skip|send` (standart skip; send — faqat sinov muhiti) — config · app · worker · `.env.example`. Testlar: yangi `test/integration/results_repeat.test.js` 4 holat; **teskari isbot** — bayroq `send` bo'lsa 2 tasi yiqiladi; `results.test.js` `send` bilan (u 3001 ni ko'p sessiyada qayta ishlatadi). **unit 57/57 · int 80/80** (76 + 4; lokal PG18 5433 skretchda qayta ko'tarildi — noutbuk o'chganda yopilgan edi) · oxlint: eski 1 ogohlantirish. **Hujjat:** `DARS_ETALON.md` 151-qonun — 6 band (5: topshiriq ichi/F5 · **6: birinchi o'tish — hisob**), naqsh va 6 holatli tekshiruv · `BACKEND_REJA_UZ.md` Qoida 3 ostiga 18.09 yangilanishi («jonli har doim ketadi» bekor) · `KATTA_TOZALASH.md` §41 — 6-band HAMMA 98 darsga tegadi (codemod). **E'tibor (staging):** deploy'dan keyin Internet darsini tugatgan test-o'quvchi (Nigora 31352) keyingi jonli sinovda hodisadan chiqadi — kerak bo'lsa staging'da `RESULT_LIVE_REPEAT=send`. LMS yig'malari/CRM nusxasi qayta yig'ilmadi. Commit/deploy YO'Q |
| 14:55 | **COMMIT ×4 (buyruq: «1 dan boshlaymiz») + PUSH + SYNC STAGING (foydalanuvchi):** 963dcb1 server F-0918-04 · aad46b9 m1-01 pilot · 8c71ebf docs · 8eaccc8 DAVOM_2026-09-18 → origin/main = **8eaccc8** → GitLab staging = **0023d0d** → deploy 14:52:54 **0.1.0+0023d0d0** (≈4 daqiqa). **staging-check: 18 ✓ · 0 ✗ · 1 ⚠ (proxy_ip, Kristina) · 1 o'tkazildi** — **migratsiya 9/9** (0009 `skipped` qo'llandi) · katalog 110 · details a · mentor_flow pin 410793 ✓ · School API ✓ · p50 223 ms. Commit-oldi: `vite build` ✓, dalil-papkalarda sir yo'q (tekshirildi). **Foydalanuvchi rejasi:** bugun 2 (3 sinov) → 3 (prod), keyin 4 — 102 faylni TO'LIQ tayyorlash, CRM-yuklash dushanba 21.09 (`feedback/lms-sinov-2026-09-16/DAVOM_2026-09-18.md`). **KATTA §41 1-qadam boshlandi (faqat o'qish):** `feedback/F-0918-04/saralash.py` → 343 trigger: test 148 · A challenge 146 (68 fayl) · C' hisoblangan correct 30 (16 fayl) · B xato qilib bo'lmaydi 19 (18 fayl). Topilma: 4c/5/6-modul darslarida birinchi-urinish halolligi allaqachon bor (`!wrongEverRef.current`, `mistakes === 0`) — ularga faqat `AchRule` + F5-saqlov + 6-band yetishmaydi (`saralash-xulosa.md`). Skript 1-yurishda `ScreenCoding` ni xato B ga tashlagan (regex `miss` ni tanimagan) — tuzatildi, B 37 → 19. **Keyingi:** Sherzod javobsiz → `participant` (+ Nigora hodisadan chiqishi = F-0918-04 jonli isboti) · resend 200/409 · PmLesson10 total 4 |
| 15:10 | **SINOV 1/3 O'TDI (staging 0023d0d0, 2-guruh 1072) — ikki isbot bitta sessiyada.** Sessiya `a323c020` · pin **324458** · mentor 240 · Nigora 31352 (15:03 kirdi, s4 ga to'g'ri javob, yutuq 1) + **Sherzod 31422 (15:05 kirdi, hech narsa bosmadi)** · mentor 15:06→15:08 oxirgi ekrangacha o'tib «Erkin qilish». **Natija `sess_324458_20260918T100327Z`: delivered · HTTP 201 · verify ✓.** (1) **F-0917-02 jonli isbot:** javobsiz o'quvchi → `badges: [participant]`, `badges_count 1`, answered 0, completed false, rank null, questions 0, achievements [] — School API qabul qildi (17.09 da aynan shu holat 422 bilan butun hodisani yiqitgan edi). (2) **F-0918-04 jonli isbot:** Nigora (shu dars bo'yicha bugun 10:59 da tugallangan natijasi yetkazilgan) hodisadan CHIQARILDI — payloadda faqat 31422, `students_count 1`; sessiyada esa ikkalasi ham bor (admin tafsiloti). Dalil: `feedback/lms-sinov-2026-09-16/sinov-0918-324458/`. **Kuzatuv (xato emas, eslatma):** Sherzodning bu jonli natijasi `completed:false` — keyingi JONLI darsni to'smaydi (yangi qoida), lekin keyingi SOLO'ni to'sadi (03.09 Qoida 3: «jonli — har qanday»); ya'ni darsga kelib tugatmagan o'quvchining uydagi qayta o'tishi LMS'ga ketmaydi — «darsdagi natija — hisob» mantiqiga mos, qaror foydalanuvchida. **Qoldi:** resend 200/409 (Axadullaga aytib) · PmLesson10 total 4 |
| 15:45 | **SINOV 3/3 (PmLesson10) O'TDI + ikki kuzatuv + F-0918-05 tashxis.** LMS'da keyingi dars (2849) qulf → foydalanuvchi 2848-dars faylini PmLesson10 ga almashtirdi (jsx `c3732196…`). **2-guruh (1072):** sessiya `7ae983e7` · pin 723255 · mentor 240 avtomat ✓ · Sherzod 31422 avval solo'da edi (15:30) → jonli ochilgach solo `live_started` bilan yopildi, jonliga o'tdi ✓ (F-0910-01 yo'li) · 4 javob (to'g'ri 0) → **`sess_723255_20260918T103413Z`: delivered · 201 · verify ✓ · `total_questions` 4 ✓** (s3·s5·s7·s11) · completed true · badges [graduate] · rank null (to'g'ri 0 — F-0911-02 qoidasi). Natija ketishi TO'G'RI: server darsni fayl ichidagi `lesson_id` (`pm-m3d14-v1`) bo'yicha taniydi, LMS'dagi dars-o'rni (2848) bo'yicha emas — Sherzod uchun bu yangi dars. Dalil: `feedback/lms-sinov-2026-09-16/sinov-0918-723255/`. **Kuzatuv 1 — 1-guruhda mentor darvozasi (token yo'q):** server 15:25:21 da gid 1071 · mentor 239 dan Internet darsi bilan mentor-kirishni KO'RGAN (token kelgan); 15:26 da o'sha preview PmLesson10 fayli bilan — Network'da 14 so'rov, LMS API'ga ham, dars-api'ga ham birorta so'rov yo'q → dars `liveToken` olmagan. Faraz: URL'dagi `mentor_launch` bir martalik, 15:25 da sarflangan; fayl almashtirilib sahifa qayta yuklanganda LMS yangi token bermagan. 2-guruhda guruh sahifasidan YANGI ishga tushirilgan → token keldi. Tekshirish: 1-guruhda darsni guruh sahifasidan qaytadan boshlash (F5 emas). Takrorlansa — F-0918-03 (Axadullaga berilgan 3-savol). **Kuzatuv 2 — o'quvchi ekranida LMS toast'i «Natijani saqlab bo'lmadi. Qayta urinib ko'ring.» ×3:** matn bizning kodda YO'Q (grep src/ + lms-staging/ bo'sh) — LMS frontining o'z saqlovi (onFinished → `question_try` kanali); rasmiy natija School API orqali 201 + verify ✓. Ertalab Nigorada shu saqlov 200 edi → farq: almashtirilgan fayl (PmLesson10 yuki) yoki Sherzod holati. Sabab uchun o'quvchi tabining Network javobi kerak (HAR). **F-0918-05 (yangi, tashxis):** payloadda `lesson_title: 'pm-m3d14-v1'` — dars nomi o'rniga id. Sabab: `scripts/gen-lesson-catalog.mjs` `pick()` faqat bir tirnoqli satrni o'qiydi; apostrofli o'zbekcha sarlavha qo'sh tirnoqda yoziladi (`uz: "…ko'rsatasiz?"`) → null → `title_uz = lesson_id`. `server/data/lesson-catalog.json` da **18 dars** shunday (ru sarlavha joyida). Tuzatish taklifi: `pick` uch xil tirnoqni o'qisin + katalog qayta yaratilsin + generatorga «title_uz == lesson_id → xato» darvozasi; tasdiq kutadi |
| 16:15 | **SINOV 4/4 — RESEND O'TDI + F-0918-05 TUZATILDI + LMS `submission_key_mismatch` tashxisi.** (1) **Resend (JAVOB 15.09 §5-4):** `tools/resend-event.mjs` `sess_192590_20260918T053145Z` → AYNAN o'sha payload **HTTP 200 ✓** (req `8d71a7e2-…`) · `--mutate` (duration_sec 1546→1547) **HTTP 409 ✓** (req `6bc1b6c4-…`). Bugungi 4 sinov yopildi: participant ✓ · takror o'quvchi chiqarildi ✓ · PmLesson10 total 4 ✓ · resend 200/409 ✓. (2) **F-0918-05 tuzatildi (tasdiq bilan):** `scripts/gen-lesson-catalog.mjs` — `pick()` uch xil tirnoqni o'qiydi (', \", backtik), `META_RE` qo'sh tirnoqli oddiy satrni ham; yangi darvoza: `lessonTitle.uz` o'qilmasa `XATO` + exit 1 (jim o'tmaydi). Katalog qayta yaratildi: `title_uz == lesson_id` **18 → 0**; diff = aynan 18 sarlavha + `generated_at`, yutuqlar/versiya/son (110 · 391) o'zgarmadi. Serverga keyingi deploy'da `seed:catalog` bilan tushadi. (3) **«Natijani saqlab bo'lmadi» ×3 — LMS tomoni:** HAR (`~/Downloads/onfinishedda ketmadi.har`, repo'ga KIRITILMAYDI — ichida o'quvchi tokeni bor): `POST question_try` → **409 `{\"error\":\"submission_key_mismatch\"}`**; so'rovda yangi maydon `idempotency_key` (UUID). Ertalabki HAR'da (05:59Z) bu maydon YO'Q edi va 200 qaytgan; LMS front yig'masi ham almashgan (`index.B9TyFiFb.js` → `index.Dt1n9OIm.js`) — ya'ni Axadulla bugun kun davomida idempotentlik qo'shgan. Kalitni dars emas, LMS fronti qo'yadi; biz faqat `onFinished(payload)` chaqiramiz. Ehtimoliy sabab: bir kalit — bir xil `answer` kutiladi, bizning yuk esa har bosishda qayta yig'iladi (`durationSec` o'sadi) → ikkinchi bosish 409. Ikkinchi ehtimol: fayl almashtirilgani (2848: Internet → PmLesson10). Xabar-loyiha: `feedback/lms-sinov-2026-09-16/xabar-axadulla-2026-09-18-submission-key.md` (yuborish — foydalanuvchi qarori). **Biz tomonda taklif (KATTA §41 codemod'iga qo'shiladi, `finishLesson` baribir tegiladi):** yuk birinchi «Yakunlash»da muhrlanadi, keyingi bosishlar AYNAN o'shani qaytaradi — LMS kaliti qanday ishlasa ham zararsiz |
| 19:00 | **PROD'GA CHIQDI — 0.1.0+5ecafd67 (migratsiya 8 → 9/9).** Foydalanuvchi: `git push origin main` (origin/main = **fd58e39**) → `sync-dars-api.sh staging` → GitLab staging **a2e07cf** → deploy ≈4 daqiqa → **staging-check 18 ✓ · 0 ✗ · 1 ⚠ (proxy_ip, Kristina) · 1 o'tkazildi**, versiya `+a2e07cf6`, migratsiya 9/9. **F-0918-05 staging'da tasdiqlandi:** admin sessiyalar ro'yxatida `pm-m3d14-v1` → «Ishlayotgan saytingizni qanday ko'rsatasiz?» (baza `lesson_catalog` dan; staging'da faqat 3 xil dars bo'yicha sessiya bor — qolgan 17 sarlavha lokal katalog faylidan tasdiqlangan: `title_uz == lesson_id` 0/110). Keyin `sync-dars-api.sh main` → GitLab main **5ecafd6** → `deploy` job (foydalanuvchi) → **prod `--read-only`: 17 ✓ · 0 ✗ · 0 ⚠ · 3 o'tkazildi** — versiya `+5ecafd67` = kutilgan · migratsiya **9/9** · katalog 110 · bridge on · worker on · **details off** (Kristina: `RESULT_DETAILS=a`) · proxy_ip ✓ · admin navbat bo'sh · p50 98 ms. Prodda endi F-0918-01/02/04/05 bor. **Kuzatuv (to'siq emas):** katalogda 7 PM darsda `title_ru: null` (pm-m5d2/d8/d11 · pm-m6d2/d6/d12/d14) — tuzatishdan OLDIN ham shunday (8eaccc8 da ham 7); bu darslar hali ruschaga o'girilmagan, LMS yukiga faqat `title_uz` ketadi. **Eslatma (muhit):** avto-rejim klassifikatori prod `health` ni fon-poll qilishni «Production Deploy» deb rad etdi; bir martalik `curl` va `--read-only` tekshiruv o'tdi. **KATTA §41 B savat (fon-agent, faqat o'qish):** `feedback/F-0918-04/b-savat-takliflar.md` — 19 triggerdan 15 tasi haqiqatan tekin (ko'chirish 5 · shart 2 · yakun nishoniga aylantirish 6 · «mehnat» nishoni 2), **4 tasi aslida B emas** (CssLesson2 s7 · PmLesson8 s4 · ApiPostman s3 · NodeServer s14 — xato-yo'l bor, A savatga); skript `hint`/`reject`/`frame-warn` ni xato-belgi deb tanimagan → A savatda teskari xato bo'lishi mumkin. Brauzerda ochilmagan, faqat kod o'qilgan. 3 ta «ha/yo'q» foydalanuvchida. **Qoldi:** Kristinaga xabar (foydalanuvchi) · B savat qarorlari · §41 codemod |
| 19:05 | **[GATE] KATTA §41 B savat — foydalanuvchi qarori + F-0918-06 (bonus-nishon tamoyili).** Kristinaga xabar yuborildi (foydalanuvchi). Uch savolga javob: **1 — ha** (6 darsda tekin nishon yakun nishoni `graduate` ga aylanadi: PmLesson4/5/17/19/21 · DbSqlNosql) · **2 — ha** (151-qonunga «mehnat nishoni» bandi: erkin yozma ish ekranlari mustasno — PmLesson1 s6 · PmMetrics s10) · **3 — ha** (o'zgaradigan matnlarni uz + ru men taklif qilaman, kodga kirishdan oldin foydalanuvchi tasdiqlaydi — 150-qonun). **F-0918-06 (foydalanuvchi tuzatishi):** «To'g'ri o'ylagansan, faqat juda qismaylik — ba'zida bonus berib turaylik, juda qiynab zeriktirmaylik; vaziyatdan kelib chiqib halol ishla». Ma'nosi: 15 tekin nishonning HAMMASI ham olib tashlanmaydi/ko'chirilmaydi — o'rinli joyda nishon ochiq «bonus» bo'lib qoladi (tavsifi nima uchun berilganini rost aytadi, mahorat da'vo qilmaydi). Qaysi ekran bonus bo'lib qolishi — dars-badars, vaziyatga qarab; ro'yxat matnlar bilan birga tasdiqqa chiqadi. Muhrlanadigan joy: DARS_ETALON 151-qonun (bonus-band, «mehnat» bandi bilan birga) — ro'yxat tasdiqlangach |
| 19:45 | **F-0918-06 YOPILDI — B savat: 12 bonus · 1 ko'chirish · 2 mehnat · 4 → A savat; 152-qonun muhrlandi.** **[GATE] foydalanuvchi:** «1-A, 2-A, 3-C, 4-A — ha, ma'qul; halol, ehtiyotkorlik va aniqlikda ishla» (4-qarorda avvalgi «1 — ha» (`graduate`) o'rniga bonus tanlandi: 47 PM darsdan 41 tasida `graduate` yo'q — oltitasi qardoshlaridan ajralmasin; katalog kalitlari o'zgarmaydi). **O'lchov:** 7 texnik darsning 6 tasida tarkib 1 tekin + 2 haqiqiy + `graduate` → bonus qolsa 2 kafolatli / 2 haqiqiy; istisno `Htmllesson2` (2 tekin) → biri testga. **Kod (4 fayl, 5 qator):** `Htmllesson2.jsx` — `ACH_TRIGGERS` `s5` → `s5b` (`struktura` endi test savolida, `QuestionScreen` `correct` = birinchi urinish) + tavsif; `BotIntroLesson.jsx` `keyMaster`, `PmLesson4.jsx` `pairFinder`, `PmLesson5.jsx` `splitter` — faqat tavsif (uz + ru). Matnlar foydalanuvchi tasdig'i bilan; bitta aniqlik: «oltita» → «olti» (49 belgi → 47, §63 chegarasi 48). **Darvozalar:** `gates` to'rt faylda — esbuild ✓ jsx ✓ keys ✓ prompt ✓ · dark/til 🔴 — **eski qarz, HEAD bilan son-ma-son bir xil** (Htmllesson2 til 3/dark 9 · BotIntro 5/4 · PmLesson4 2/2 · PmLesson5 4/3; yangi 0) · `lint:jsx` 156 fayl toza · qoldiq-grep: eski tavsiflar faqat `lms/` yig'malarida (oxirida qayta yig'iladi) va `saralash.json` da (tarixiy o'lchov). **Katalog** qayta yaratildi: diff = aynan 4 tavsif (uz + ru) + `generated_at`; 110 dars · 391 yutuq, kalitlar o'zgarmadi → serverga keyingi deploy'da tushadi (shoshilinch emas: tavsif faqat ko'rsatish uchun). Server unit 57/57. **Brauzer (boshsiz Chrome, `Htmllesson2`):** A s5 da 3 bo'lim bosildi → javob yozildi, nishon YO'Q, bayram yo'q ✓ · B s5b birinchi urinishda `<header>` → `struktura` + bayram «Room by Room! · Logotip va menyu joyini to'g'ri topdingiz» ✓ · C `<footer>` → `<header>` → nishon YO'Q (`correct:false, solved:true`) ✓ · D s7 forma → `forma` bonusi joyida ✓ · konsol xatosi 0. Qolgan uch darsda faqat satr o'zgargan — brauzerda ochilmadi (esbuild ✓). **Muhr:** `DARS_ETALON.md` **152-qonun** (6 band + reyestr + tekshiruv; 151 ga ikki yo'llanma) · `MATN_KORPUS.md` **§184** (4 juftlik) · `KATTA_TOZALASH.md` §41 (B savat ✅ + A savatda teskari xato ogohlantirishi + 3 yo'l-yo'lakay topilma) · xotira `nishon-bonus-qismaslik`. **Commit YO'Q (buyruqsiz).** LMS yig'malari qayta yig'ilmagan. **Keyingi:** §41 codemod — yukni muhrlash + 6-band (98 dars), avval quruq o'lchov |
| 20:05 | **F-0918-07 — `onFinished` YUKINI MUHRLASH: 1-bosqich (markaz + pilot) ✓.** **[GATE] foydalanuvchi:** «Ma'qul, 1-bosqichni boshladik, birin-ketin qilaveramiz, kutish shart emas — dushanbani bemalol, maksimal sifatli chiqaraylik». Quruq o'lchov (fork, `feedback/F-0918-04/codemod-quruq-olchov.md`): 98 fayl = pilot 1 · G1 to'liq mexanik 69 · G2 parametrli 22 · G3 qo'l ishi 5 · arxiv 1; prototip 91 nusxada 91/91 (faqat sintaksis darajasi). **Loyihaga tuzatish (bosh agent):** fork muhrni faqat dars-ID bo'yicha saqlashni taklif qilgan — yuk ichida sessiyaga xos maydonlar bor (`livePin`, `liveMode`, `nickname`), sahifa qayta yuklanmasdan boshqa sessiya ochilsa (mentor ikkinchi guruh; umumiy kompyuterda boshqa o'quvchi) ESKI yuk ketib qolardi. Uch qavat himoya: (1) kalit = dars-ID + PIN + rejim; (2) `useLiveSession` har mount'da `unsealPayload` (dars ochilishi = toza muhr); (3) JSON-nusxa saqlanadi va har safar yangi nusxa qaytadi (qabul qiluvchi obyektni o'zgartirsa ham muhr butun); `resetResultDetails` ham tozalaydi (LMS «toza boshlash», solo → jonli). **Umumiy fayl — ikki bosqich:** ishoralar ro'yxati (`resultDetails.js` ← `index.js`, `useLiveSession.js` 308/346, 97 dars `buildResultDetails` import qiladi) → tuzatish: `src/live/resultDetails.js` (`sealPayload`, `unsealPayload`) · `index.js` (eksport) · `useLiveSession.js` (mount-effekt) → `vite build` ✓. **Unit:** `resultDetails.test.mjs` 11/11 (6 eski + 5 yangi: aynan birinchi yuk · mutatsiyaga chidamli · boshqa PIN = yangi yuk · unseal/reset tozalaydi · darslar aralashmaydi, yaroqsiz/siklik kirish yiqitmaydi). **Pilot `InternetLesson.jsx`:** 2 qator (import + `onFinished(sealPayload(LESSON_META.lessonId, payload))`); gates — esbuild ✓ jsx ✓ keys ✓ prompt ✓ · til 4 / dark 11 — eski qarz, o'zgarmadi. **ANIQLIK (brauzerda topildi):** qayta bosiladigan tugma — yakun ekranidagi «🎉 Darsni yakunlash» EMAS (u faqat oynani ochadi), balki oyna ichidagi **«Tamom»**: u `finishLesson` ni chaqiradi va oyna yopilmaydi → o'quvchi LMS xatosini ko'rib «Tamom»ni qayta bosgan (18.09 dagi toast ×3). **Brauzer (boshsiz Chrome, `seal-test.mjs` skretchpadda):** S1 «Tamom» ×3 — birinchi · 4 s dan keyin oyna yopilmasdan · oyna ✕ bilan yopilib qayta ochilgach → `onFinished` ×3, **uchala yuk harfma-harf teng** (1591 bayt, durationSec 604) ✓ · S2 nazorat: dars qayta ochilgach yuk tabiiy farq qiladi (604 → 620 s) — ya'ni tashxis to'g'ri va mount-tozalash ishlaydi ✓ · konsol xatosi 0. Regress: `ach-test.mjs` olti holat (A–F) avvalgidek ✓. `lint:jsx` 156 toza. **Chegara (halol):** F5 dan keyin muhr yo'q (xotirada) — LMS kaliti nimaga bog'langani noma'lum; `review` rejimi, uy-vazifa fayllari (12), 7-modul (12) + PmLesson7 hali ko'rilmagan. **Keyingi:** 2-bosqich — 3 namuna dars (texnik · PM · 6-modul) codemod + brauzer D/E/F. Commit YO'Q |
| 20:25 | **§41 A to'lqin — 2-bosqich (3 namuna) ✓ va 3-bosqich (G1, 69 dars) yozildi.** **Vosita:** `scripts/codemod-first-pass.mjs` (fork prototipidan; T1–T12 transformlar aynan; qo'shilgan himoyalar: takror yurishda SKIP · `saved` borligi · React import'ida ishlatilgan har hook borligi — esbuild yo'q import'ni tutmaydi · standart rejim QURUQ, yozish faqat `--write` · muhrlash qatoriga izoh qo'shilmaydi, F-0802-15 sinfi). **Sinov vositasi:** `scripts/smoke-onfinished-all.mjs` ga `--seal` rejimi — **I10** (yakun tugmasi 1,3 s dan keyin yana bosiladi → ikkala yuk harfma-harf teng) · **I11** (toza sahifa → «Qaytadan» → progressda `firstPass` muhri, javob kalitlari urug' bilan teng, nishonlar «Qaytadan»dan OLDINGI holat bilan teng → oxirgi ekran → yakun: `correctAnswers`, `durationSec`, `answers` soni = birinchi o'tish). Sinovning tishi tekshirildi: tegilmagan `GitLesson` I10 (91→93 s) va I11 da yiqildi, pilot o'tdi. (Sinovdagi o'z xatom: nishonlarni urug' ro'yxati bilan solishtirganman — yakun ekranida `graduate` qonuniy qo'shiladi; «Qaytadan»dan oldingi holat bilan solishtirishga o'tkazildi.) **Bazaviy smoke** (markaz o'zgargach, darslar tegilmagan): 70/70 ✓. **2-bosqich — `GitLesson` · `PmLesson10` · `AgentArchitectureLesson`:** har biri +20 qator, diff pilot naqshini aynan takrorlaydi · gates: esbuild ✓ jsx ✓ keys ✓ prompt ✓, til/dark — eski qarz (faqat qator raqamlari +3 ga surilgan) · `--seal` smoke uz + ru **8/8** (pilot bilan) · **E holati** (dev-server, boshsiz Chrome, nazorat bilan): oddiy o'tishda test savoliga to'g'ri javob → nishon + bayram; mashq-o'tishida (firstPass muhrlangan) o'sha javob → `earned` bo'sh, bayram yo'q — `GitLesson` (`quizace`) va `AgentArchitecture` (`theAgent`) ✓, konsol xatosi 0. **3-bosqich — G1:** quruq yurish 66 mos / 3 SKIP / 0 xato → `--write` 66 fayl (+1320 qator). Tekshiruv: `lint:jsx` 156 toza · `lint-keys` 73 dars nomos 0 · **til/dark HEAD bilan solishtirish (qator raqamlarisiz): 73 dars, farq 0** · `vite build` ✓ · unit 11/11. G1 `--seal` smoke — yurmoqda (natija keyingi qatorda). G2 quruq yurish: 22/22 mos. Commit YO'Q |
| 20:50 | **§41 A TO'LQIN YOPILDI — 97 dars: yukni muhrlash (F-0918-07) + 151-qonun 6-band. Brauzer-smoke 194 yurishda I10/I11 yiqilishi 0.** G2 (22) skript bilan; **G3 (5) qo'lda:** `JsIntroLesson` · `PmLesson5` · `FullstackFeedbackLesson` — `reset` dan `earnedRef.current = new Set(); setEarned(new Set())` olib tashlandi («Qaytadan» nishonni kamaytirmaydi ham; `trkRef`/`setResolved` — dars holati, qoldi) → keyin skript; `FullstackFeedbackLesson` da nishon ichki shartda beriladi (`if (ACH_TRIGGERS[_m.id]) earn(…)`) — skriptga T12b ning ikkinchi shakli qo'shildi; `EdgeCasesTestLesson` · `JestUnitTestLesson` — ikkinchi test-komponent `Screen16` (yakuniy karta-test) ga ham `fpPractice` + `if (!fpPractice) live.submitAnswer(…)` (langar — `twist` holati, faylda yagona), keyin skript. **Qamrov:** `firstPassRef` 97 fayl · `onFinished(sealPayload(` 97 fayl · `ACH_TRIGGERS` bor-u 6-band yo'q — faqat arxiv (`src/eski/…/PmAudienceLesson`). **Statik:** `lint:jsx` 156 toza · `lint-keys` 97 dars nomos 0 · til/dark HEAD bilan (qator raqamlarisiz) 97 dars **farq 0** · `vite build` ✓ · unit 11/11. **`--seal` smoke (boshsiz Chrome, uz + ru):** G1 + pilot 134/140 (1074 s) · G2 + G3 51/54 (782 s) → **jami 185/194; I10 va I11 bo'yicha yiqilish 0.** 9 ta yiqilishning hammasi **I6 `lang uz ≠ ru`** — ruschaga o'girilmagan PM darslar (PmLesson19–25 · PmMetrics · PmJtbd; `ru:` satrlari 0–1 ta, HEAD da ham aynan shunday) — eski holat, bu o'zgarishga aloqasi yo'q (avvalgi 70 darslik ro'yxatda bu darslar ru bilan yurgizilmagan). **Yo'l-yo'lakay yopildi:** uy-vazifa fayllari (18) — hammasida `if (finished) return; setFinished(true)`, natija bir ochilishda bir marta ketadi → muhrlash kerak emas. **Qoldi (KATTA §41 da):** B to'lqin (`AchRule` + `miss()` — 76 dars, o'lchanmagan) · `PmLesson7` + `7-Modull` 12 dars (muhrsiz, `lms/` da yo'q) · F5 dan keyingi muhr (Axadulla) · `review` rejimi · **`lms/` qayta yig'ish**. Commit YO'Q (buyruqsiz); ishchi daraxtda ~110 fayl |
| 21:30 | **§41 B TO'LQIN — INVENTAR + TO'LIQ REJA (kodga tegilmadi).** **Foydalanuvchi:** «B variantni shoshilmasdan qilamiz, maksimal sifat; dushanbani o'ylama, faqat sifatni o'yla; to'liq reja tuz». **Usul:** 178 topshiriq-trigger (75 dars) 6 parallel fork bilan BITTALAB ochib o'qildi (`feedback/F-0918-04/b-tolqin/inventar-P1…P6.{json,md}`, birlashma `inventar-JAMI.json`) — brauzerda emas, kodda. **Natija:** A-qo'l ishi 62 · A-umumiy komponent 21 (`DragDropOrder` · `DebugChallenge` · `PickLines` · `NightShift`) · C-halol 21 · **ishlanadigan jami 104 ekran / 65 dars (~540 qator)** · MEHNAT 39 · TEKIN 24 · NOANIQ 9 (asosan PM koding) · pilot 2. **Avtomatik saralash ishonchsiz chiqdi:** «A challenge»ning ~40% i aslida tekin/mehnat (skript `tries`/`tekshir`/`miss`/`hint` ni xato-belgi deb olgan); «C' halol»dan kamida 6 tasi halol emas (AuthEnv s7/s13 `restart` hisobni nollaydi; ClaudeSkills s7/s13 har bosishda `onAnswer`; VsCode s2/s3 `correct: all`). **O'z xulosamga tuzatish:** F-0918-06 da «Htmllesson2 da xato qilsa bo'ladigan yagona ekran — s14» deb yozilgan edi — kod bo'yicha u ham TEKIN (faqat xato qator bosiladi, Mentor javobni oldindan aytadi) → darsda hozir 3 kafolatli nishon; W6 da tuzatiladi. **Uch yangi teshik (o'zim o'lchadim):** (1) **BALL halolligi** — 143 «custom test»dan 80 `QuestionScreen` (halol) · 18 hisoblangan · **45 tasi (44 dars, asosan yakuniy s15) DOIM `correct: true`** (13 `DragDropOrder`, qolgani yozma/regex) → LMS `correctAnswers`/`finalScore` oshib ketadi (`ball-custom-ekranlar.json`); (2) `ACH_TRIGGERS` dan tashqari 17 nishon (16 darsda to'g'ridan-to'g'ri `earn('…')` + PmLesson25 `ACH_EXTRA`) — hech bir o'lchovda yo'q; (3) 34 ekranda Mentor/audio/maslahat javobni urinishdan OLDIN aytadi. **Infratuzilma o'lchovi:** `AchRule` o'rnatish skript bilan mumkin (97/97 da tayanchlar bor; 9 dars `tr()` siz — uz-variant; 2 darsda `<style>` bir nechta). **Reja:** `feedback/F-0918-04/b-tolqin/REJA.md` — 8 qaror (Q1 koding = mehnat · Q2 o'z-qaror = mehnat · Q3 ko'p-bandli qattiqlik · Q4 PM s4 = bonus · Q5 «bitta bosiladigan qator» debug → haqiqiy topshiriq · Q6 matn to'lqini · Q7 ball · Q8 §183 uchinchi matn), 10 to'lqin (W0–W9), sifat: statik + yangi `smoke-achrule` (hamma ekran) + **ekran-probi 100% qamrov** + rol-zanjir + regress; hajm ≈ 75–100 soat sof ish; xavflar. **Kutiladi:** A to'lqin commit buyrug'i + Q1–Q8 javoblari |
| 21:40 | **Jurnal vaqtlariga tuzatish (o'z xatom):** 19:05 dan keyingi olti qatorning vaqt-yorlig'ini soatga qaramay TAXMIN bilan yozganman («22:10», «23:20», «00:40 (19.09)», «03:10 (19.09)» va h.k.) — haqiqiy vaqt 21:39 edi. Yorliqlar fayl-vaqtlari (mtime) va `087b4ee` commit vaqti (19:07) bo'yicha to'g'rilandi: 19:05 · 19:45 · 20:05 · 20:25 · 20:50 · 21:30. Mazmun o'zgarmadi. Saboq: jurnalga vaqt yozishdan oldin `date` |
| 21:50 | **TUNGI ISH BOSHLANDI — [GATE] foydalanuvchi:** 10 savolga javob — 1-A (tunda lokal commit; push/deploy yo'q) · 2-A (PM koding = mehnat) · 3-A (o'z-qaror mashqi = mehnat) · 4-A (ko'p-bandli topshiriq: bitta bilim-xatosi = nishon yo'q; sirpanish sanalmaydi) · 5-A (PM tekin 4-ekran = bonus) · 6-A (faqat xato qator bosiladigan debug → haqiqiy topshiriq; matn tasdiqlandi: «Bu qatorda xato yo'q — yana qarang.» / «В этой строке ошибки нет — посмотрите ещё раз.») · 7-A (tunda matn — faqat taklif-ro'yxat) · 8-A (ball: tunda faqat tartiblash testlari) · 9 — uchinchi matn ma'qul; «Nishon emas, Badge deylik» → «A boshla»: tunda «nishon» qoladi (238 marta ishlatilgan — izchillik), almashtirish KATTA §42 · 10-A + «vaziyatdan kelib chiqib halol va yaxshi yo'lni tanlab hal qilsang mayli». Noutbuk uxlamaydi. Reja: `feedback/F-0918-04/b-tolqin/TUNGI_REJA.md` (T0–T13), hisobot: `TUNGI_HISOBOT.md`. **T0 ✅:** `16791ee` feat(live) muhrlash · `9eda330` feat(lessons) 97 dars + B savat + katalog + skriptlar (100 fayl) · docs (shu qator bilan). Commitdan oldin: vite build ✓ · lint:jsx toza · unit 11/11 · sir-qidiruv (JWT/Bearer/parol) — topilmadi. Push YO'Q |
| 01:16 (19.09) | **TUNGI ISH — §41 B TO'LQIN YOPILDI (T0–T13).** Foydalanuvchi 18.09 21:35: 10 qaror (1-A … 10-A; 9 — «nishon» qoladi, «Badge» → KATTA §42), «ertalabgacha ishla, hisobot to'liq tursin». **Natija:** 151-qonun **100 ekran / 66 dars** (6 partiya parallel agentlar, har ekran `scripts/ach-probe.mjs` 7 holat bilan isbotlangan, bosh agent har partiyani mustaqil qayta tekshirgan) · Q6 5 debug-ekran haqiqiy topshiriq · ball (8-A): 15 tartiblash testi birinchi to'liq urinishga (kalit -1 → 0 — 4 dars) · tashqi nishonlar: BotIntro `neverSilent`, PmLesson25 `proofFinder`, PmJtbd `jobHunter` · 152-qonun reyestri (bonus 28 dars — hammasida ≤ 1 · mehnat 56) · KORPUS §183 uchinchi matn, §185 · 2 adversarial tekshiruv: **Y1, Y1b** (`onFinished` detallarida shartnomaga zid variantsiz/`correctIndex`siz yozuv — T9 va undan oldin) → `src/live/resultDetails.js` filtri + unit + smoke I12. Topilmalar: pilot qatori kontrasti 2.22:1 edi → rang kontrast bo'yicha; **solo ball teshigi** (uyda yakuniy maxsus test sanalmaydi — kod-zanjir tasdiqlangan, E2E yo'q; `solo-ball.md`). **Yakuniy regress:** prob 131/131 (118 ekran · 76 dars) · `--seal` CRM uz+ru 140/140 · gates 75 dars · til/dark tun boshiga nisbatan 0 · lint-keys 97 · unit 12 · server 57 · vite build ✓. Commitlar `16791ee` … (lokal, push yo'q). ⏸ 8 ekran · `MATN_TAKLIFLAR.md` 49 · 7 diskret + 23 yozma test — qaror kutadi. Hisobot: `feedback/F-0918-04/b-tolqin/TUNGI_HISOBOT.md` |

| 05:28 (19.09) | **[GATE] foydalanuvchi — QARORLAR.md:** «Q1-A, Q2-A, Q3 tavsiya bo'yicha, Q4-A, Q5-A, Q6-A». Push ✓ (GitHub = 8bd0eeb). **Q1-A:** solo ball teshigini tuzatamiz (63 ekran / 62 dars) — lokal sinov + staging'da haqiqiy solo o'tish · **Q2-A:** foydalanuvchi `MATN_TAKLIFLAR.md` ni partiya bo'yicha tasdiqlaydi → kiritish → metodist → 👦 2-o'qish → lint:til · **Q3:** a) CssLesson1 `bezak` → s12 test + «Ichki bo'shliq xususiyatini topdingiz» · b) DbSql s3 → s3b test + yangi tavsif (matn tasdiqqa) · c) BotApiButtons: s12 `neverSilent` bonus, s9 → s10, s11 → s14 (tavsiflar matn-P6 da) · d) PmLesson19 s9 `kamKordi` sharti (tavsif aniqlashtirish — tasdiqqa) · e) PmLesson20 s4 → 151-naqsh, s9 bonus · **Q4-A:** 7 diskret test birinchi urinishga + Routing s15 yuborilishi; 2 debug-test F5; 23 yozma — «bajarildi», 151-qonunga ochiq yoziladi · **Q5-A:** BotIntro ikki nishon qoladi · PmLesson15 s4 `if (done) return;` · o'lik `earn` (4) tozalanadi · §42 Badge — CRM dan keyin · **Q6-A:** Q1 → Q2 → to'liq sinov → `lms/` → server-deploy (katalog) → CRM |
| 06:35 (19.09) | **ERTALABGI ISH (Q1–Q6 bo'yicha) — kod qismi yopildi.** **Q1 solo teshigi:** `ach-probe --solo` (soxta HTTP-server har so'rovni yozadi) — tuzatishdan OLDIN 15/15 tartiblash testida serverga so'rov umuman ketmagan (MCQ nazorati — `record_attempt` ketgan) → `scripts/codemod-solo-submit.mjs`: 97 dars ildizi `recordAnswer` ga blok (solo · mashq emas · ball-ekran · yakunlandi · bir marta → `submit_answer`, `picked` kalitdan) — server `submit_answer` sessiya holatiga qaramaydi, `on conflict do nothing` → **63/63 maxsus test-ekranda isbotlandi** (`9cdf279`, isbot `c0e51d5`); `--seal` CRM uz+ru 140/140. **Q3/Q5** (`193632a`): bezak → s12, buttonMaster → s10, PmLesson20 s4 151-naqsh (qator ustun oxirida), PmLesson15 s4 `done`-qulf, o'lik earn 4. **M2/M3** (`df11830`, foydalanuvchi «M2 ok · M3 ok, uz ru da»): rightEnvelope → s14 «Command Spotter» ⌨️; fullHouse — kam beradigan joy = xato, tavsif `{uz, ru}` + `achDesc()`. **Q4** (`c0e51d5`): 7 diskret test birinchi urinishga, Routing s15 jonli yuborish, NestArch s19/s17 F5 — 12 ta kalit `-1 → 0` (11 dars). **153-qonun** (ball halolligi, `036ce83`). **F-0919-01 (foydalanuvchi):** «Qadoqxona — o'quvchiga juda notanish»: tashxis — «Qadoqxona» faqat kod-nomi (o'quvchi ko'rmaydi; men uni xabarimda ekran nomi deb xato ishlatganman), lekin «qadoq» DbSql audio-matnida 4 marta → almashtirish taklifi tasdiq kutadi (M1 bilan). **K1 3-tekshiruv:** YUQORI/O'RTA yo'q, 2 PAST tuzatildi (`0df4ed1`). **Staging-sinov yig'masi** (AgentArchitecture, staging manzili; `LMS_OUT_DIR` bilan — `lms/` ga tegilmadi). Kechqurun uchun: `feedback/F-0918-04/b-tolqin/SAVOLLAR_VA_HOLAT.md` (S1 qadoq+M1 · S2 matnlar 49 · S3 staging solo sinovi · S4 jobHunter · S5 chiqarish · S6 keyinga) |
| 07:43 (19.09) | **YAKUNIY REGRESS (K4) ✅ + hodisa.** 06:30 dagi birinchi yurish «ENOSPC / Page crashed» bilan yiqildi: `scripts/ach-probe.mjs` va `scripts/smoke-onfinished-all.mjs` vaqtinchalik papkalarini hech qachon o'chirmagan — 166 papka (≈10.6G) `/tmp` (tmpfs 12G) ni 99% ga to'ldirgan. Dars xatosi emas. Papkalar o'chirildi; ikkala skriptga chiqishda (SIGINT/SIGTERM bilan ham) `rmSync(TMP)` qo'shildi (1 holatli sinov: qolgan papka 0); regress 06:44 dan noldan: **prob 156/156** (143 ekran · 83 dars) · **solo 67/67** · **`--seal` CRM uz+ru 140/140** · gates 97 dars — esbuild/jsx/keys/prompt ✓, til (240 🔴 · 65 dars) va dark (280) — eski qarz, asos `655cd93` bilan farq 0 · lint-keys 97 · lint:jsx toza · unit 12/12 · server 57/57 · vite build ✓. `SAVOLLAR_VA_HOLAT.md` yakunlandi (S6 ga til/dark qarzi qo'shildi). Kunduzgi taymer to'xtatildi |
| 21:25 (19.09) | **[GATE] foydalanuvchi 20:40 + BAJARILDI (F-0919-02/03, UNCOMMITTED).** Javoblar: S1-A · S2 1/2/4/5-guruh ✓ · **3-guruh (7 nishon-tavsifi) RAD — «o'quvchiga tushunarsiz, hozirgisi qolsin»** · S3 hozir · S4-A · S5 keyin · S6 — soddaroq qayta tushuntirish · S7 ovozga tegilmaydi («ovoz umuman kerak emas»). «Maslahat 10 xatodan keyin» — 1 deb talqin qilindi (3–4 variantli ekranlar; tasdiq so'raldi). **Kiritildi (17 dars):** DbSql `packageMaster` s3 → s4 testi (+ tavsif, katalog) · 20 matn (javob urinishdan oldin aytilmaydi — CssLesson2, Htmllesson2, JsConditions, JsLoops, PracticeLesson3, ReactCrud, ReactIntro, ReactRouter, ApiPostman, BackendCrud, DbSql, NodeServer, PostgresCrud, FullPipeline; FullPipeline maslahati yorliqqa moslab qisqartirildi) · maslahat faqat 1-xatodan keyin (AuthEnv s14 + «Bu qatorda xato yo'q», NodeServer s13; DbSql s14 boshidagi maslahat-qutisi olib tashlandi — xatodan keyingi frame-warn takrorlardi) · 4-guruh (CssLesson2 s7 «nishon» ikki ma'nosi, s3b tartib, AuthEnv s13 yakun) · 5-guruh (BotIntro `=&gt;`, PmLesson17 ru). **Tekshiruv:** gates 17 (esbuild/jsx/keys/prompt ✓; til/dark HEAD bilan farq 0) · lint:jsx toza · prob 40/40 + `probe/K19.json` (4 yangi spetsifikatsiya; tish: eski nusxada 3 maslahat-tekshiruvi yiqildi) · solo 12/12 · seal uz+ru 34/34 · server 57 · unit 12 · vite ✓ · metodist + 👦 o'quvchi-o'qish. Eslatma: `solo-yozma.json` oddiy rejimda 6 ✗ — spetsifikatsiya faqat solo uchun (HEAD nusxada ham aynan shunday). **Yangi topilmalar N1–N9** (tasdiqsiz tegilmadi): ApiPostman «(s)» → «(c)» faktik xato · JsLoops yon quti/konsol · ReactRouter/ReactCrud/BackendCrud Mentor · ReactIntro AI-izohi · 25 s tiqilish-maslahati (ApiPostman, AuthEnv) · packageMaster 49 belgi (§63) · FullPipeline «eski yuk». **S3 tayyorgarlik:** staging sog' (16 ✓); agent-arch kaliti staging'da YO'Q (mentor hech ochmagan — ertalabgi «kalit bor» gapim xato) → qadamlar: yuklash → mentor ochib «🔓 Erkin qilish» → Sherzod/Nigora solo → natija `staging-sinov/s3-natija.mjs`. Qonun: KORPUS §186 (javob yashirinadigan joylar ro'yxati) · §187 (tavsif-rad saboq-i) · DARS_ETALON 152 ⏸ yopildi. Hisobot: `SAVOLLAR_VA_HOLAT.md` |
| 11:10 (20.09) | **[GATE] foydalanuvchi: D1/D3 + N1–N9 (F-0919-02 davomi).** Javob: «D1 maqul · **D2 ataylab qo'yilgan — qolsin** · D3 bonus qil · D4 hozircha qoldiramiz · yangi topilmalar albatta tuzatilsin». **Bajarildi:** N1 ApiPostman «(s)» → «(c)» (manzilda `/produts` — tushgan harf c) · N2 JsLoops yon quti («CHEKSIZ! — mashina to'xtamayapti») va konsol («5 ga hech yetmaydi — cheksiz!») · N3 ReactRouter Mentor («menyudagi havolalardan birini bosganda…», «qaysi qator bunga sabab?») · N4 ReactCrud Mentor + izoh (`// ro'yxatni yangiladi`) · N5 ReactIntro AI-izohi · N6 BackendCrud Mentor (xato matnini o'zi o'qisin) · N7 13-band tiqilish-maslahati (ApiPostman, AuthEnv) faqat xatodan keyin · N8 packageMaster 45 belgi (§63) · N9 FullPipeline «eski yuk» → «ishlagan yuk». **D1:** Jest s9 · EdgeCases s9 uyumi aralashtirildi (barqaror tartib; oxirgi yozuvda vergul yo'qligi sintaksisni buzdi — esbuild tutdi) → **154-qonun**. **D3:** PmLesson6 s2 `jargon` BONUS (ekran `scored: false` — ballga ta'sir yo'q), `miss()` va shart-qatori olindi; 152-reyestr; **probga `bonus` rejimi** qo'shildi (S1a/S1b teskari kutilma). **👦 2-o'qish topdi:** N5 dan keyin xato qator yagona izohsiz qator bo'lib qolgan (3-vs-1 shakl-telli) → izoh neytral qaytarildi (`// sahifa`); JsLoops o'ng ustunidagi maslahat urinishdan oldin chiqardi → endi faqat tanlovdan keyin. **Tekshiruv:** gates 20 (esbuild/jsx/keys/prompt ✓, til/dark farq 0) · lint:jsx toza · solo 14/14 · `--seal` uz+ru 40/40 · oddiy prob — quyidagi qatorda. Qonun: KORPUS §186 (ikkinchi aylanish jadvali) · DARS_ETALON 154-qonun + 152-reyestr. Qoldi: S3 (foydalanuvchi staging'da), commit/push buyrug'i |
| 14:29 (20.09) | **2-to'lqin regressi yopildi.** Oddiy prob **48/48** (PmLesson6 s2 bonus · Jest/EdgeCases s9 aralashtirilgan uyum ham) · solo 14/14 · seal uz+ru 40/40 · gates 20 dars ✓ (til/dark farq 0) · lint:jsx toza · vite build ✓. Prob yurganida tahrirlangan 2 fayl (JsLoops, ReactIntro) alohida qayta sinaldi — **3/3** ✓. **Muhit-saboq:** `until ! pgrep -f "<nom>"; do sleep; done` shaklidagi kutuvchi O'Z buyruq-satrini ko'radi (satrda o'sha nom bor) → tsikl hech qachon tugamaydi va keyingi buyruq umuman ishga tushmaydi. Bu safar qayta sinov 3 soat «ishlayapti» bo'lib turdi, aslida boshlanmagan edi. To'g'risi: kutuvchida boshqacha naqsh (`node scripts/ach-probe`) yoki to'g'ridan-to'g'ri `run_in_background`. **Kechki mavzu tayyorgarligi:** `feedback/F-0918-04/b-tolqin/YANGI_FORMAT_ANALITIKA.md` — Supabase kod-bog'liqligi YO'Q (faqat izoh-tarix); ma'lumot yig'iladi, hisobot yo'q (guruh/o'qituvchi kesimi, savol-qiyinchiligi, tashlab ketish, mentor-jimligi — jadvallarda bor, ekran yo'q); nishon-statistikasi va `onFinished` umuman yig'ilmaydi; V1/V2/V3 variantlari + 5 savol |
| 15:48 (20.09) | **TO'LIQ REGRESS (barcha darslar, 2-to'lqindan keyin) ✅:** brauzer-prob **160/160** (144 ekran · 83 dars — hamma spetsifikatsiya + yangi K19/bonus/aralashtirish tekshiruvlari) · `--seal` butun CRM ro'yxati uz+ru **140/140** · solo 14/14 (o'zgargan darslar) · gates 20 dars ✓ (til/dark farq 0) · lint:jsx toza · lint:prompt toza · vite build ✓ · server 57/57 · unit 12/12. Vaqtinchalik papka qolmadi (`b389442` tuzatishi ishlayapti). Holat: **31 fayl UNCOMMITTED**, commit rejasi `SAVOLLAR_VA_HOLAT.md` §4b da (3 commit), push va deploy buyruq kutadi. Ochiq: S3 (staging solo sinovi — foydalanuvchida), kechki «yangi format» qarori (`YANGI_FORMAT_ANALITIKA.md`: V1 tavsiya, so'rov-loyihalari §7 da) |
| 19:20 (20.09) | **F-0920-01 — «Natijani saqlab bo'lmadi» (409) sababi topildi va yopildi.** Foydalanuvchi staging'da 2848-joyda jonli + solo sinov qildi; o'quvchi har yakunlashda qizil xato ko'rdi. **HAR tahlili:** `POST go.coddycamp.uz/app/index.php?action=question_try` — bitta kalit (`91b56f81…`) ostida **23 so'rov → 409 `submission_key_mismatch`**; LMS yangi kalit bergan bitta so'rov (`737a1ef2…`) → **200**; keyin o'sha kalitda yana 409. Farq — faqat mazmun: `durationSec` 473→475→476→516→654→864. Ya'ni LMS qoidasi «bir kalit — bir mazmun», bizda esa har bosishda yuk qayta yig'ilardi (2848-dagi fayl 18.09 kunduzgi yig'ma — muhr unda yo'q; muhrning o'zi ham faqat sahifa ochiq turganda ishlardi). **Tuzatish:** `src/live/resultDetails.js` — muhr `localStorage` (`ccSeal:<darsId>`) da, kalit `PIN|rejim|attemptId` (`liveSession:<darsId>` dan); F5/qayta kirishda AYNAN o'sha bayt, «Qaytadan boshlash» da esa server yangi urinish ochadi → yangi muhr. `unsealPayload` endi faqat xotirani bo'shatadi, `resetResultDetails` saqlovni ham. Unit 13/13 (yangi sinov: F5 va urinish-almashuvi). **Server dalili:** o'sha o'quvchining jonli natijasi **delivered 201** (3/4, `top_1/graduate/arena_top_1`), solo urinishi «completed» (4 javob, 4 nishon) — LMS'ga yuborilmadi, chunki «bir o'quvchi — bir dars — bitta natija» (to'g'ri ishladi). **F-0920-02:** `smoke-lms`/`smoke-shared` uyga-vazifa paketlarini xato «sindi» deb ko'rsatardi — ular `.hw-root` chizadi va kompilyatorni ishlatmaydi; ikkala skript tuzatildi. **Yig'ish:** 105 yig'ma tuzatish bilan qayta yig'ildi, smoke **yakka 70/70 · shared 34/34**. Staging sinov-fayli yangilandi (`staging-sinov/AgentArchitectureLesson.jsx`, md5 `108e2a3434c953fb2c3ff3c75c3c98fe`). Axadullaga xabar-loyihasi: `feedback/lms-sinov-2026-09-16/xabar-axadulla-2026-09-20-409.md` (3 savol + o'quvchiga xato ko'rsatilmasligi). Kutilmoqda: foydalanuvchi sinovi (1–2 soat), commit buyrug'i |
| 01:45 (21.09) | **KATALOG PRODGA CHIQDI.** GitHub push ✓ (`31cdf72..b2da94e`). GitLab: staging `8c773b6d` (qabul 16 ✓ · 1 ⚠ proxy_ip — staging env'iniki), keyin **prod `0.1.0+f4876f99`** — migratsiya 9/9, katalog 110, `--read-only` qabul **17 ✓ · 0 ✗ · 0 ⚠**. Xavf oldindan o'lchangan: prod'dagi `fd58e39` bilan HEAD orasida server kodida **bitta ham o'zgarish yo'q**, faqat `server/data/lesson-catalog.json` (10 nishon tavsifi, uz+ru). Yig'malar uchun `CRM_YUKLASH_MD5.md` yaratildi (102 fayl md5 bilan; umumiy modul o'zgarmagan — qayta yuklash shart emas). Qoldi: CRM'ga 102 fayl (foydalanuvchi, bugun) · staging sinovi (ertaga: 409 tuzatilgani + yakuniy test bali) · Axadulladan javob (kalit qoidasi, o'quvchiga xato ko'rsatmaslik) |
| 02:25 (21.09) | **TUN: 1–4c modullar LMS'ga tayyorlandi (F-0921).** Foydalanuvchi 01:50: «bitta papka, yangi avtomatlashtirishga to'liq mos; ertalab yuklayman» (javoblar 1-A…5-A) + **PM uyga-vazifasi topshirilganda `onFinished` avtomat ketsin**. **F-0921-01:** 18 tadan 18 uyga-vazifa paketida `onFinished` FAQAT «Vazifani topshirish» tugmasida ketardi — tugma bosilmasa LMS ptichkani olmasdi, qayta ochilganda ham yuborilmasdi. Tuzatildi (`scripts/codemod-hw-finish.mjs`): bosqichlar bajarilganda avtomat topshirish · yuk `ccHwSeal:<HW_ID>` da muhrlanadi (409 dan himoya) · qayta ochilganda bir marta qayta yuborish · bo'sh vazifa yuborilmaydi. Yangi sinov `scripts/smoke-homework.mjs` — **36/36** (18 × uz/ru). **Yuklash papkasi:** `yuklash-2026-09-21/` — 7 modul, **88 fayl** (70 dars + 18 uyga-vazifa), nomlari `NN-Dars.jsx` (tartib `src/App.jsx` registridan), har modulda `ROYXAT.md` (ikki nom: dars ichidagi sarlavha = LMS materiali nomi · kursdagi nom; `lesson_id`, md5), ildizda README. **Sifat:** brauzer smoke 88/88 · statik 88/88 (lesson_id katalogda, prod manzili) · nishon↔katalog 70/70 (uz+ru tavsif) · ruscha qoplama 70/70 · katalogda ruscha sarlavha 70/70 · yakun-yuki (seal) 70/70 · prob 160/160. **F-0921-02:** yangi `scripts/smoke-rejim.mjs` — dars self/mentor/jonli/solo rejimlarida ochiladi (mentor va jonli yo'l ilgari faqat kod o'qish bilan tekshirilgan edi): **70/70 toza** (uz), ru yurishi ketmoqda. **Aniqlik:** `PmLesson7` yuklanmaydi — eski versiya, o'rnini `PmUserStoryLesson` egallagan (`src/App.jsx:45`), registrda ham yo'q. `lms/` to'plamidagi 12 uyga-vazifa yig'masi ham qayta qurildi (12/12) + `CRM_YUKLASH_MD5.md`. Commitlar: `7740e4d` · `ba71cee` · `1ff36a1` · `7cf6713` · `72063af`. Hisobot: `feedback/F-0921-yuklash/ERTALABKI_HISOBOT.md` |
| 02:33 (21.09) | **Rejim-sinovi ruschada ham toza + yuklash ro'yxati yakunlandi.** `smoke-rejim` ru yurishi: **70/70** (self · mentor · jonli o'quvchi · solo) — ya'ni ikkala tilda ham hamma dars to'rt rejimda ochiladi, mentor paneli chiqadi, sahifa/konsol xatosi yo'q. Arena banki: 70/70 (12 savol, `correct`/`opts` mos, indeks chegarada). `yuklash-2026-09-21/` qayta qurildi — `ROYXAT.md` endi **uz va ru sarlavha** + belgilash ustuni (☐) bilan; qayta tekshiruv 88/88 (lesson_id katalogda, prod manzili, uyga-vazifa fayllarida F-0921-01 tuzatishi bor) |
| 03:15 (21.09) | **👦 o'quvchi-o'qishi: 1- va 2-modul (F-0921-03).** **TO'SIQ topildi va tuzatildi:** JsFunctions yakuniy amaliy — Mentor va tekshiruvchi `kuch * 3` ni kutadi, yorliq/maslahat/natija esa eski `n * n` ni ko'rsatardi; maslahatga ergashgan o'quvchi «Davom etish» ni ocholmasdi. Eski formula izlari 5 joyda tozalandi (uz+ru), s5b izohlarida `n` → `kuch`, return-demo muvaffaqiyat matni ekrandagi kod bilan moslandi (saqlangan natija 25 → 15), 2-parametrli misolning ruscha hisobi to'g'rilandi (`3 - 10 = -7` → `3 * 3 + 10 = 19`). Yana: HtmlTakrorlash ruscha matni o'zbekcha tugma nomini aytardi — «Скопировать» ga almashtirildi. Tekshiruv: gates (til/dark farqi 0) · rejim-sinovi 2/2 · yakun-yuki 4/4 (uz+ru) · commit `a67d19f`. **Tasdiq kutadigan 5 taklif** ertalabki hisobotga yozildi (Q1 VsCode faqat Windows — Mac/Linux o'quvchisi to'xtaydi · Q2 Deploy AI'siz zaxira yo'l · Q3 CssPractice Mentor javobni aytadi · Q4 CssLesson1 yakuniy namunani ko'chirish · Q5 Htmllesson1 maslahat darhol javob beradi). 3- va 4-modul o'qishi ketmoqda |
| 03:35 (21.09) | **👦 3- va 4-modul o'qishi (F-0921-04).** Uchta «qotib qolish» tuzatildi (matn tegilmadi): DbSqlNosql s7 — ochilish sharti raqamga bog'langani uchun tugma umuman ochilmasdi (1 240 504 < 1 240 505), endi oqim tugashiga bog'landi · PmLesson8 s8 — joylashgan kartani qaytarib bo'lmasdi, uchala ishni «Darrov»dan boshqa katakka qo'ygan o'quvchi qotib qolardi, endi bosib qaytariladi · PostgresCrud s15 «50 000» (probel) va FullstackFeedback s16 `confirm()` endi qabul qilinadi. Tekshiruv: gates 6/6 · til/dark farqi 0 · rejim-sinovi 4/4 · P4 probi o'zgarmagan · commit `c111157`. **Q6 (qaror kerak):** ReactApiGet/ReactApiPost amaliy qadamlari `https://robo-api.uz/games` ga so'rov yozishni talab qiladi — domen **javob bermaydi** (48 joyda), lokal zaxira ham yo'q; variantlar (bizning serverda `/demo/games` · loyihadagi `games.json` · ochiq test-API · tegmaslik) hisobotda. Boshqa 6 ta matn-topilmasi ham hisobotga yozildi |
| 04:00 (21.09) | **👦 4a/4b/4c o'qishi — qotirib qo'yadigan TO'SIQ yo'q.** Tashqi repo (`Azizbekcrypto/IntroNestArxitechture`) tekshirildi — tirik (200), 4a amaliyoti joyida. **Tuzatildi:** FullPipeline s13 tetik maydoni faqat aynan `push` ni olardi; `push:` va `on:push` jim rad etilardi (izohsiz) — endi qabul qilinadi (gates 6/6). **Tasdiq kutadi (Q7–Q10):** NestArchPractice «agentga playbook yuboring» — qaysi dastur ekani aytilmagan (xotira: `gemini.google.com`), «agent/playbook» izohsiz · FullPipeline s6 qulf-yorlig'i noto'g'ri qadamni aytadi · GithubActions amaliyoti reposiz o'quvchi uchun zaxira yo'lsiz · AiPipeline s15 da tiqilish-maslahati yo'q. Yuklash papkasi tungi 5 tuzatish bilan qayta qurildi (5/5 smoke) — commit `d1cda83` |
| 08:20 (21.09) | **Q1–Q10 YOPILDI — tungi 👦 o'qishining 10 ta taklifi tasdiqlanib bajarildi (F-0921-05…14).** Foydalanuvchi qarori 21.09 ~07:50: Q6 → **GET=B, POST=A** (POST keyingi navbat), qolgan to'qqiztasi → **hammasi ha**. **Bajarildi:** Q1 VsCode s2 «🛟 Boshqa tizimda? (Mac yoki Linux)» paneli + mentor gapida yo'l · Q2 Deploy s5 «🛟 Ochilmadimi?» — nusxa tugmali tayyor `index.html` + `style.css` (AI'siz to'liq yo'l) · Q3 CssPractice s7 Mentordan `display: flex` olindi · Q4 CssLesson1 yakuniy (BALLLI) — Mentor endi faqat selektor+xususiyatni aytadi, maydon ipuchasi bo'shatildi (§32) · Q5 Htmllesson1 s7 (BALLLI) — maslahat zinapoyasi, to'liq javob faqat tugallangan xato urinishdan keyin · Q6 ReactApiGet s15 → `public/games.json` (o'lik `robo-api.uz` o'rniga; dars ichidagi soxta-server sahnalari TEGILMADI — ular tarmoqqa chiqmaydi) · Q7 NestArchPractice — `gemini.google.com` nomi + «agent»/«playbook» izohlari · Q8 FullPipeline s6 qulf-yorlig'i haqiqiy shartni aytadi (`seenAll`) · Q9 GithubActions «🛟 Repongiz yo'qmi?» — brauzerda repo + `package.json` namunasi + mentor bilan variant · Q10 AiPipeline s15 — **faqat ipucha** klapani (kalitli ekran: `rescue` ULANMAGAN, ball yo'li tegilmagan, §157/136-qonun). **Darvozalar:** 10/10 faylda esbuild·jsx·keys·prompt ✓; til/dark — Q6…Q10 fayllarida **6/6 toza**, 1-modul beshtasida bazaga nisbatan **farq 0** (eski qarz). `lint:jsx` 156 fayl 0 topilma · `lint:prompt` 0. **Sinov:** `smoke-rejim` 10 dars × 4 rejim — **uz 10/10 ✓ · ru 10/10 ✓**. **Muhrlandi:** `DARS_ETALON.md` **155-qonun** (o'quvchi bajara olmaydigan qadam qolmaydi — tashqi manzil tirikligi, 🛟 panel, dars to'xtamaydi) · `MATN_KORPUS.md` **§188** (zaxira-panel matni: ayblamaydi → ishlaydigan yo'l → ruxsat) + **§186 uchinchi aylanish** (Q3/Q4/Q5 — javob Mentor va ipucha orqali ikki kanaldan kelardi) + **§10** (qulf-yorlig'i ayni shu daqiqadagi ishni aytadi) · `MATN_ETALONI.md` lug'at: agent · playbook · «AI yordamchisi (nomsiz)». **Ochiq qoldi:** `ReactApiPost`/DELETE uchun A varianti (bizning serverda `/demo/games`) — keyingi navbat; yuklash papkasi qayta qurilishi kerak; commit buyruq kutadi. |
| 09:05 (21.09) | **1-MODUL YUKLASHGA MUHRLANDI (foydalanuvchi «to'liq tugat» dedi).** `yuklash-2026-09-21/1-Modul/` — 14 dars + 3 uyga-vazifa. **Tekshiruv:** yig'ma fayllar HAQIQIY brauzerda bittalab (`smoke-lms`) — **uz 17/17 ✓ · ru 17/17 ✓** · `ROYXAT.md` md5 **17/17 mos** · `lesson_id` 17 noyob · **prod katalogida 14/14 dars bor** (`/api/v1/health` → catalog 110, lokal `server/data/lesson-catalog.json` bilan bir xil) · probda 1-Modul ekranlari tahrirdan keyin qayta o'tdi (CssLesson1 ×2, Htmllesson1 ×2). **Aniqlangan tuzilma (xato EMAS):** uyga-vazifa paketlari (`pm-m1-02/06/14`) katalogda yo'q va bo'lishi shart emas — ular dars-api'ga bitta ham so'rov yubormaydi, `HW_ID` faqat localStorage kaliti va LMS'ga ketadigan `onFinished` yukining maydoni. **Papkada qimirlagani:** faqat 5 dars (03-Htmllesson1 · 07-CssLesson1 · 10-VsCode · 11-CssPractice · 13-Deploy) + ROYXAT md5'lari; qolgan 12 fayl tungi holida baytma-bayt. **Asbob:** `scripts/smoke-lms.mjs` ga **`--lang uz\|ru`** qo'shildi (ilgari `lang` qat'iy `uz` edi — yig'malarning ruschasi brauzerda hech qachon ochilmagan). ⚠️ Yig'ma (prod manzilli) fayllarni `smoke-rejim` bilan tekshirib bo'lmaydi: u `file://` dan ochadi, mentor/jonli rejimda CORS to'sadi — bu dars xatosi emas, asbob nomosligi. |
| 09:22 (21.09) | **BUTUN YUKLASH PAPKASI MUHRLANDI — 7 modul, 88 fayl (avtopilot).** Papka Q1–Q10 tuzatishlari bilan qayta qurildi. **Brauzer (`smoke-lms`, bittalab, uz va ru):** 1-M 34/34 · 2-M 32/32 · 3-M 36/36 · 4-M 38/38 · 4a 10/10 · 4b 8/8 · 4c 18/18 — **jami 176 yurish, yiqilish 0**. **md5 butunligi:** 88/88 mos. **Katalog:** 70/70 dars prod katalogida (`/api/v1/health` → 110 aktiv); 18 uyga-vazifa paketi katalog talab qilmaydi (dars-api'ga so'rov yubormaydi). **Bugun papkada o'zgargani — 10 fayl:** 1-M 5 (03-Htmllesson1 · 07-CssLesson1 · 10-VsCode · 11-CssPractice · 13-Deploy) · 3-M 1 (08-ReactApiGet) · 4a 1 (04-NestArchPractice) · 4c 3 (03-GithubActions · 04-FullPipeline · 05-AiPipeline). **Prob-teshigi topildi va yopildi (F-0921-15):** solo yurish 26/27 — `CssLesson1 s15` spetsifikatsiyasi yozuv-maydonini ESKI ipucha matni (`h1 { color: red; }`) bilan topardi, Q4 uni bo'shatgach selektor sinди. Darsga barqaror sinf-ilgak `.css-rule-input` berildi (boshqa darslardagi `.yz-input`/`.text-input` naqshi), spetsifikatsiya sinfga bog'landi → **solo 27/27 ✓**. Sabog'i: prob selektori O'QUVCHI MATNIGA bog'lanmaydi — sinf yoki barqaror atributga bog'lanadi. **Qayta-prob (tahrirlangan 10 dars qamrovi):** 69/69 ✓. **Ochiq:** commit (buyruq kutadi) · push · `ReactApiPost` A varianti (`/demo/games`). |
| 11:10 (21.09) | **A1 (⏸ 8 ekran) — TEKSHIRUV: yangi kod-ishi yo'q, ro'yxat eskirgan edi (F-0921-19).** `TUNGI_HISOBOT.md` dagi «⏸ 8 ekran» 19.09 dan keyin yangilanmagan. Kodda birma-bir tekshirildi: **oltitasi 19.09 da hal qilingan** — `CssLesson1` s13→s12 test (Q3-a) · `DbSqlNosql` s3→s4 test (S1-A) · `BotApiButtons` s9→s10, s11→s14 test (Q3-c) · `PmLesson19` s9 `kamKordi` ulangan (M3) · `PmLesson20` s4 151-naqsh (Q3-e). **Ikkitasi bonus bo'lib qoladi** (foydalanuvchi qarori 21.09): `BotApiButtons` s12 `neverSilent` · `PmLesson20` s9 `sharpSifter` — ikkalasida ham `AchRule` yo'q (152-qonun 4-band) va tavsif qilingan ishni aytadi (3-band). **152-qonun bo'yicha beshala dars qayta sanaldi — har birida aynan bitta bonus**, qolgani test · 151-naqsh · mehnat nishoni (5-band, bonus hisobiga kirmaydi). Holat `holat-P1/P4/P6.json` da 8 yozuv ⏸ → ✅; `TUNGI_HISOBOT.md` ga tuzatish-eslatmasi qo'yildi. **Sabog'i:** ⏸ ro'yxati tuzatishdan keyin yopilmasa, o'sha savol qayta ko'tariladi — holat-fayli tuzatish bilan bir vaqtda yangilanadi. |
| 12:05 (21.09) | **A2 · A3 · A4 yopildi (F-0921-20).** **A2 — yangi ish yo'q:** yettala diskret test (`PracticeLesson1`/`PracticeLesson3`/`ApiPostman`/`DbSqlNosql` s15 · `DataIntro` s15/s15b · `Routing` s15) da 151-naqsh allaqachon ulangan; `Routing` s15 ham serverga ketadi (ekran `solved: true`, ildiz `scored && scope==='final'` bo'yicha uzatadi, solo yo'li ham bor). Isbot — yettalasi `Q4.json` da `test: true` va bugungi 160/160 probda o'tgan. **A3 — nuqson emas:** 23 yozma test «bajarildi» bo'lib qolishi 136-qonunga mos; diskret urinish faqat «Tekshirish» tugmasi bilan paydo bo'ladi (22 ekran mexanikasi+matni) — qaror sifatida ochiq. **A4 — HAQIQIY NUQSON topildi va tuzatildi:** `BotFeedbackIterationLesson` da 4 nishon e'lon qilingan, ildiz faqat `ACH_TRIGGERS` (s15 `loopCloser`) ni berardi — o'quvchi hisoblagichda DOIM «1/4» ko'rardi va 100% ga yetolmasdi. Markaziy s7 uch bosqich bayrog'ini (`signalFinder`·`funnelReader`·`rightFixFirst`) `onAnswer` bilan yuborardi, lekin ildizda ularni `earn` ga aylantiradigan qator yo'q edi. Ulandi + **151-qonun**: `FeedbackSort` ga `onWrong` prop, voronka va tuzatish tanlovida xato yoziladi, **har bosqich alohida** (voronkadagi xato saralash nishonini o'chirmaydi), F5 dan keyin ham eslab qoladi (`achMiss.missed`). Darvozalar 4/6 ✓ (til/dark bazadan farq 0) · `smoke-rejim` 4 rejim **uz 1/1 · ru 1/1** ✓. **N10/N11/N12 probda tasdiqlandi: 64/64 · yiqilish 0** — `JestUnitTest` s9 va `EdgeCases` s9 (ikki bosish), `ApiPostman` s14 (4 qator), `FullPipeline` s6/s10 hammasi S1a/S1b bilan. Spetsifikatsiya `P2.json` ikki bosishga o'tkazilgan (24 katak-bosishi). **Ochiq qaror:** `BotIntro` s7 da ikki nishon (`sheetMaster` + `neverSilent`) qolsinmi. |
| 13:20 (21.09) | **PM KEYSLARIGA BREND-IZOHI — 1-qadam bajarildi, 2/3-qadam muhrlandi (F-0921-21/22).** Foydalanuvchi topilmasi: «Facebook–Garvard mavzusida o'quvchi Garvard nima ekanini tushunmaydi». **O'lchov:** 35 PM darsida jami **35 ta `<img>` — hammasi mentor avatari**; biznes-keyslar faqat emoji+matn (solishtirish: `Htmllesson2` da 19 rasm). Tekshiruvda IKKINCHI bo'shliq chiqdi — brendlarning ko'pi **izohlanmagan** ham edi. **Sanoq (tuzatilgan):** PM darslari 35 · biznes-misoli bor **30** · yo'q **5** (PmLesson2·12·18·23·34). Birinchi o'lchov 27 chiqqandi — `Bolt`=`CsNeonBolt`, `Zoom`=`Zoomable` soxta topilmasi va ro'yxatda Cyberpunk/Microsoft yo'qligi sabab. **1-qadam (bajarildi):** 16 darsda 25 tahrir — Garvard · Airbnb (6·10·14·20·28·30·32·33) · Snapchat · Netflix · Amazon · Duolingo (21·Metrics) · Tesla · Dropbox · Uber · Spotify · Notion. Foydalanuvchi qarori: izoh **har darsda takrorlanadi** (darslar alohida ochiladi), shakli — qavs ichida yoki Mentor gapida. `PmLesson25` tegilmadi (K12 slaydida izoh bor edi). **§186 ehtiyoti:** `PmLesson28` s0 da Uber javobning o'zi — izoh variantga EMAS, javob ochilgandan keyingi qatorga qo'yildi. **Darvozalar:** 16 faylda esbuild·jsx·keys·prompt ✓, til/dark bazadan farq 0 · `smoke-rejim` 4 rejim **uz 16/16 · ru 16/16** ✓. **2-qadam:** `feedback/F-0921-rasm/RASMLAR.md` — A (5 eng kerakli: Garvard · Altair 8800 · Airbnb havo-matrasi · Tesla bir varaqli reja · Dropbox flashka) · B (8) · C (rasm shart emas); ulash naqshi `PHOTO_SET`+`Photo` (rasm yuklanmasa emoji+gradient, dars to'xtamaydi), `alt` uz+ru, faqat o'z media-kutubxonasidan. **3-qadam:** `DARS_ETALON.md` **156-qonun** + `MATN_KORPUS.md` **§189**. Rasmlar foydalanuvchidan kutiladi. |
| 16:05 (21.09) | **PM KEYSLARIGA MAKET — 2-qadamning uch bandi bajarildi (F-0921-23).** Foto kutmasdan, loyihaning o'z maket-an'anasi bilan (`BrowserWin`/`PhoneMock`/`inst-setup` kabi): `PmLesson22` s6 **Altair 8800 old paneli** (lampochka + kichik kalit, ost-yozuv «ekran ham, klaviatura ham yo'q») · `PmLesson24` s6 **bir varaqli reja** · `PmLesson6` s5 **taqdimot maketi** (10 varaq). Afzalligi: mualliflik muammosi yo'q · tez ochiladi · qorong'i rejimda to'g'ri · LMS'ga qo'shimcha hech narsa kerak emas. **§186 ehtiyoti (o'z-o'zini tuzatish):** Tesla varag'iga uchala bosqich yozilgandi — keyingi slayd aynan shuni so'raydi, ya'ni javob oldindan ko'rinardi. Tuzatildi: 1-slaydda qatorlar YOPIQ («uch qator — bitta betda»), to'liq varaq 3-bosqichda; `PmLesson6` da birinchi varaq nomi javobdan keyin chiqadi. **Matn:** «tumbler» → «kichik kalitlar» (13 yoshli o'quvchiga tushunarsiz). **Qilinmadi (qaror):** `PmLesson28` Dropbox flashkasi — flashka tanish narsa, hikoya matni yetarli; bezak uchun maket qo'shilmaydi. **Kutiladi:** Garvard fotosi (joy — chizib bo'lmaydi), foydalanuvchidan. **Asbob tuzatildi:** `scripts/shot-screen.mjs` — Chrome yo'li qattiq yozilgan edi (Kali'da ishlamasdi) va 900 ms kutardi, kirish-animatsiyasi tugamasdan suratga olib **bo'sh ekran** berardi; endi `CHROME` va `SHOT_WAIT` env. **Darvozalar:** 3 faylda esbuild·jsx·keys·prompt ✓, til/dark bazadan farq 0 · `smoke-rejim` 4 rejim **uz 3/3 · ru 3/3** ✓. Har maket skrinshot bilan ko'z orqali tasdiqlandi. |
| 17:15 (21.09) | **KUN YAKUNI — PUSH ✅ va hamma narsa lokalda muhrlandi (F-0921-24).** Yuklash papkasi bugungi 20 dars o'zgarishi bilan qayta qurildi; qabul-tekshiruvi (`yuklash-2026-09-21/TEKSHIRUV.log`): brauzerda bittalab uz va ru da — 1-M 34/34 · 2-M 32/32 · 3-M 36/36 · 4-M 38/38 · 4a 10/10 · 4b 8/8 · 4c 17/18 → **amalda 176/176**; md5 **88/88**; katalog **70/70 dars**. 4c dagi yagona yiqilish dars xatosi EMAS — sahifa chizilgan (291 belgi), `page.screenshot` 30 s ga sig'magan (parallel Chrome yuki); fayl alohida ikki marta qayta yurgizilgan, ikkalasi ham toza. **Yakuniy darvozalar:** `lint:jsx` 156 fayl 0 · `lint:prompt` 0 · `vite build` ✓. **PUSH: 20 commit → `origin/main` = `8813f74`** (avval `b2da94e` edi). **Seanslararo muhr** (foydalanuvchi API kalitini almashtiradi): `feedback/F-0921-yuklash/DAVOM_2026-09-21.md` (yangi seans shu yerdan boshlanadi — holat, ochiq qarorlar, ish-uslubi 8 band, 5 sabog'i) · `scripts/yuklash-tekshir.sh` (to'liq qabul-tekshiruvi endi repo'da) · `arxiv/memory-nusxa-2026-09-21/` (xotiraning 63 faylik nusxasi + tiklash yo'riqnomasi) · xotirada `holat-2026-09-21` va yangi `ish-uslubi-halol-tekshiruv`. |

## 2026-09-22 — PM KEYSLARIGA MAKET: 2-qadamning B ro'yxati (F-0922-01)

| Vaqt | Nima |
|---|---|
| 08:56 (22.09) | **2-QADAM DAVOM ETTIRILDI — B ro'yxatidan uch maket (F-0922-01).** Foydalanuvchi: «PM darslaridagi 3 qadamni eslab, shuni qilaylik, keyin tilga o'tamiz». Reja tiklandi: 1-qadam (brend-izohi) ✅ `1b87acc` · 3-qadam (156-qonun + KORPUS §189) ✅ `cd08cd4` · ochiq qolgani — **2-qadam**. **Filtr (yangi qaror):** 8 bandning hammasi bir xil emas — maket **o'qitadigan** joyga qo'yiladi, bezakka emas (21.09 dagi Dropbox qarori bilan bir xil mantiq). Tasdiqlangan qamrov — **3 maket**. **Bajarildi:** `PmLesson11` s6 ikki bosh sahifa yonma-yon (Siz: kulgili ↔ Sinfdoshingiz: qo'rqinchli) · `PmLesson21` s6 streak qatori (🔥 7 yashil ↔ 🔥 0, uzilgan kun qizil ramkada) · `PmLesson31` s0 kesish ro'yxati (Burbn 5 band, `rasm` yashil → Instagram 3 band). **Qilinmadi (filtr bo'yicha):** B3 Stories · B4 Uzum ilova ekrani · B8 milkshake. **§186:** uchala maket ham javob/bashoratdan KEYIN chiqadi — `PmLesson31` da `picked !== null` bloki ichiga qo'yildi (savol yonida tursa «hammasini kesishdi» javobi ko'rinib qolardi). **Ko'z bilan tutilgan 3 nuqson** (darvozalar ko'rmaydi): (1) 🌑 qorong'i plitkada ko'rinmasdi, 😂 rangsiz chiqdi → emoji almashtirildi + plitka foni yorug'roq; (2) ruscha «Вы · смотрел» grammatik xato va «Одноklassник» ostida jinsni majburlardi → jinssiz «просмотрено»; (3) `PmLesson31` da ustunlar markazga tekislanib, `BURBN`/`INSTAGRAM` sarlavhalari bir qatorda emasdi → `flex-start`. **Tuzatildi (kechagi qarz):** `PmLesson6` `DeckMock` `aria-label` qattiq o'zbekcha edi — ikki tilli darsda ruscha rejimda ekran-o'quvchisi o'zbekcha eshitardi; endi `tr({uz,ru})`. **Gumon rad etildi:** `PmLesson21/22/24/31` da `tr({` = 0 — bu darslarda ruscha UMUMAN yo'q, ya'ni kechagi maketlarning bir tilli matni to'g'ri. **Asbob (`scripts/shot-screen.mjs`):** `CLICK='<sel1>,<sel2>'` — ekran ICHIDAGI bosqichga bosib kirish (`ccProgress` faqat ekranga olib keladi) · `SHOT_LANG=ru` · rasm-importlari uchun dataurl loader (`.png` bo'lgan darsda «No loader is configured» deb yiqilardi). **Darvozalar:** 4 faylda esbuild·jsx·keys·prompt ✓; til/dark **bazadan farq 0** (har fayl uchun `git show HEAD:` bilan o'lchandi — `PmLesson11` dark 2=2 · `PmLesson21` 2=2 · `PmLesson31` til 4=4, dark 1=1 · `PmLesson6` til 23=23, dark 3=3). **CSS to'qnashuvi yo'q:** `.nf-`/`.st-`/`.cut-` prefikslari tekshirildi. **Sinovlar:** `smoke-rejim` 4 rejim — `PmLesson11` uz+ru ✓ · `PmLesson21` uz ✓ · `PmLesson31` uz ✓ · `PmLesson6` uz+ru ✓ · ekran-probi tegilgan 4 spetsifikatsiyada **4/4 · 0 yiqilish** · `lint:jsx` 156 fayl **0** · `lint:prompt` **0** · `vite build` ✓. Har maket **skrinshot bilan ko'z orqali** tasdiqlandi (uz va ru). **Muhrlandi:** `DARS_ETALON.md` 156-qonun — 4-band (maket fotoni kutmaydi) + **MAKET FILTRI** jadvali (o'qitadi ↔ bezak) + **MAKET JOYI** (§186 bilan juft) + maket matni ikki tilli; `feedback/F-0921-rasm/RASMLAR.md` — bajarilganlar va filtr bo'yicha rad etilganlar. **Commit YO'Q** (buyruq kutiladi). |
| 09:30 (22.09) | **`PmLesson6` TIL-QARZI: 23 🔴 → 2 (F-0922-02).** Foydalanuvchi: «PmLesson6 dan boshla, halol ishla». **Tashxis (kutilgandan boshqacha):** 23 topilmaning **21 tasi bitta so'z va faqat RUSCHA matnda** — darsning o'z atamasi «kasbiy so'z» ruschaga «профессиональное слово» deb o'girilgan (21 joy). O'zbekcha matn butunlay toza. `professional-sozi` qoidasi esa `KORPUS §87` ga tayanadi, u **bo'sh maqtov sifati** uchun yozilgan («Professionallar kodni qayerda yozadi?») — bu yerda ma'no boshqa («kasbga tegishli so'z», darsning o'zida izohlanadi: «жаргон — профессиональное слово»). Ya'ni **soxta topilma sinfi**, va u bitta faylda PM til-qarzining chorak qismini ko'rsatib, haqiqiy topilmalarni ko'mib turardi. **[GATE] foydalanuvchi qarori:** ruscha atama **o'zgarmaydi**, qoidaga CHEGARA-istisno yoziladi. **Bajarildi:** `til-lint-rules.json` → `professional-sozi.except = профессиональн[а-яё]*\s+слов` + `suggest` ga chegara-izohi. **Sabog'i (birinchi urinish yiqildi):** istisno `\w` bilan yozilgandi — JS'da `\w` faqat LOTIN harfini oladi, kirillni emas; raqam umuman o'zgarmadi va shu bilan tutildi → `[а-яё]`. **Isbot (oldin/keyin hisobotlari solishtirildi):** jami 336 → **315**; yo'qolgan **21**, yangi paydo bo'lgan **0**, hammasi `PmLesson6` da va hammasi shu qoidada — boshqa fayl tegilmagan; qolgan 14 faylda **31 hodisa hali ham tutiladi** (jumladan haqiqiy «профессиональные проекты»); istisno butun QATORGA qo'llangani uchun o'sha 21 qator alohida tekshirildi — ortida yashiringan qo'llanish **0**. **Qolgani:** `PmLesson6` da 2 🔴 — «tavsiya etiladi» (445·467), u 45 darsdagi 107 lik umumiy sinf; alohida tuzatilmadi, til-to'lqinining birinchi yurishida bir xil so'z bilan yopiladi. **Muhrlandi:** `MATN_KORPUS.md` §87 ga CHEGARA (✅/❌ juftligi + nega yozilgani + kirill-istisno sabog'i). **Yangi topilma (hali qaror yo'q):** `sheva-toldiruvchi` qoidasi ham shu kasallikka uchragan — repo bo'ylab 4 hodisa, 3 fayl, **to'rttasi ham «…» iqtibos ichida** (tinglovchining ovozi, dars ovozi emas); `sheva-yuklama-ku` da bunday chegara §159 da bor, bunda yo'q. 🟡 daraja — darvozani to'smaydi. **Dars fayliga TEGILMADI** — shuning uchun brauzer-tekshiruvi bu qadamda o'tkazilmadi (o'zgargan narsa: qoida-fayli va hujjat). `lint:prompt` ✓. **Commit YO'Q.** |
| 11:38 (22.09) | **ARENA AVTO-O'TISH — 97 dars (F-0922-03) + 157-qonun.** Foydalanuvchi feedbacki: «CodeStrike mentor rejimida keyingi savolni avtomatlashtirish; 15 s tugadi — o'quvchilarda avto o'tsin; bir tugma qo'ysak mentor qo'lda davom etadi». **Tashxis:** savol vaqti (`QUIZ_MS` 15 s) va vaqt tugaganda javob ochilishi ALLAQACHON avto edi — qo'lda qolgan yagona o'tish «javob ochildi → keyingi savol». Serverga tegilmaydi (`quizControl` bor; migratsiya/deploy yo'q). **Uch e'tiroz aytildi, [GATE] foydalanuvchi tasdiqladi:** (1) 2 s QISQA — poll 1200 ms + 700 ms kompensatsiya sabab o'quvchi javob ekranini 1 s'dan kam ko'rardi → **6 s**; (2) kerak bo'lgani «davom etish» emas, **«to'xtatish»** — javob ochilishi tushuntirish payti; (3) to'xtatish **YOPISHQOQ** (arena oxirigacha), aks holda mentor har savolda taymer bilan kurashadi. Qo'shimcha: oxirgi savolda avto YO'Q (podium mentorniki) · solo rejimda YO'Q · ikki marta o'tish qulfi. **Qurilish:** mantiq `src/live/useAutoNext.js` (umumiy — vaqtni keyin BITTA faylda o'zgartirish mumkin), darslarga `scripts/codemod-auto-next.mjs` bilan; langarlar oldin o'lchangan — to'rttasi ham **97/97 bir xil**. Yangi CSS KERAK EMAS: `.qz-btn.ghost` 97/97 da bor; sinov-selektori `qz-auto` (CSS'siz, barqaror — matnga bog'lanmaydi). **Ko'z bilan tutildi:** `⏸` belgisi shriftda yo'q, quti («▮») bo'lib chiqdi → matn «To'xtatish · 5» / «▶ Avto» (`▶` 107 faylda sinalgan). **Yangi darvoza `scripts/smoke-arena.mjs`** — arena uchun brauzer-sinovi YO'Q edi (`smoke-rejim` faqat chizilishni ko'radi): soxta server sessiya holatini saqlaydi, dars mentor rejimida ochiladi, T1 javob-ochildi · T2 avto-o'tish · T3 yopishqoq to'xtatish o'lchanadi. **To'liq yurish: 95/97**; ikkala yiqilish ham **ESKI NUQSON** bo'lib chiqdi (quyida), tuzatilgach alohida qayta sinovdan o'tdi. **Hookdagi tuzatish:** React effektni chizilgandan KEYIN yurgizadi → sanoq birinchi kadrda `null` bo'lib tugma raqamsiz turardi (CssLesson1 da tutildi) — ko'rsatiladigan qiymat hookda hisoblanadi. **Muhr:** `DARS_ETALON.md` **157-qonun** (5 band + `⏸` taqiqi + mexanizm bitta joyda). **Commit YO'Q.** |
| 11:38 (22.09) | **ESKI NUQSONLAR — yangi arena-darvozasi birinchi yurishidayoq ikkitasini tutdi.** **F-0922-06 `PmLesson4`:** `QuizArena` faylda aniqlangan, lekin **hech qayerda chizilmagan** — mentor CODE STRIKE gerbini bosadi, gerb yonadi va hech narsa bo'lmaydi; arena butunlay yetib bo'lmaydigan edi. 97 darsdan faqat shu bittasi; `git show HEAD` bilan tasdiqlandi — eski. Foydalanuvchi tasdig'i bilan qolgan 96 dars bilan bir xil qator qo'yildi; sinov ✓. **F-0922-07 `BotAiProjectLesson`:** javob (reveal) fazasida `fmtCode(Q.q)` va `fmtCode(o)` — `tr()` TUSHIB QOLGAN (savol fazasida bor). Natija: React «Objects are not valid as a React child (found: object with keys {uz, ru})» va **oq ekran** — arena javobi ochilgan zahoti dars qulardi. Bazada ham shunday (nusxa bilan tasdiqlandi). Repo bo'ylab o'lchov: 97 arenadan **1 tasida**. Tuzatildi, `smoke-arena` ✓ va `smoke-rejim --lang ru` 4 rejim ✓. **Sinf qonunlashtirildi:** `darslik-tekshiruvchi` rol-fayliga ov-bandi — «ikki fazadan birida `tr()` tushib qoladi», grep-retsepti bilan (esbuild ham, `lint:jsx` ham, `lint:til` ham ko'rmaydi — jim o'tadi). |
| 11:38 (22.09) | **MENTOR PANELI OHANGI — 240 almashtirish, 72 dars (F-0922-04) + KORPUS §190.** Til-to'lqinining birinchi yurishi. **O'lchov aniqlashtirildi:** darvoza «107» deydi, chunki bir qatorda bitta topilma sanaydi — HAQIQIY hodisa soni **141**, shundan **32 tasi kod izohida** (o'quvchi ko'rmaydi, darvoza sanamaydi), ko'rinadigan matn **108**. **[GATE] foydalanuvchi qarori:** buyruq shakli + **ruscha ham** tuzatilsin. **Bajarildi:** o'zbekcha 108 (2 shakl) → «…qisqa takrorlab oling» · «Qayta tushuntiring»; ruscha **132** (20 xil shakl: «Рекомендуем…», «Рекомендуется…», «Стоит…») → «Объясните ещё раз» · «Перед продолжением коротко повторите». **🔴 Regex EMAS, aynan-satrlar jadvali** (`scripts/codemod-mentor-ohang.mjs`): «рекоменд» va «стоит» dars MAZMUNIDA ham bor — «Netflix рекомендует похожие», «из рекомендаций», «Стоит на месте клавиатуры», «состоит SKILL» — regex ularni buzardi. **Natija:** `tavsiya-etiladi` 107 → **0**; til qarzi **315 → 208**. Qoldiq grep bilan tekshirildi (ko'rinadigan matnda 0). `lint:jsx` 156 fayl 0 · `vite build` ✓ · `smoke-rejim` namuna 3 dars uz+ru 4 rejim ✓. **Muhr:** `MATN_KORPUS.md` **§190** (✅/❌ juftligi, ruscha juftligi, sweep sabog'i). |
| 11:38 (22.09) | **UYGA VAZIFA → LMS «completed» — tekshirildi (F-0922-05).** Foydalanuvchi savoli: «vazifani topshirish bosilganda `onFinished` ketadimi, LMS ptichka qo'yishi uchun?». **Javob: biz tomondan KETADI — 18/18 paket.** Uch tetik: tugma (`finish()`) · **avto-topshirish** (to'rttala bosqich bajarilsa, tugma bosilmasa ham — bu kechagi F-0921-01) · **qayta yuborish** (vazifa keyin ochilsa, muhrlangan yuk yana bir marta). Yuk: `{kind:'homework', done:true, lessonId, stages, durationSec}`. Statik tekshiruv: `HW_PASS_MIN` (4) `STAGES` (4) dan katta emas — avto yetib boradigan, 18/18. **🔴 O'Z XATOM (22.09 kech tuzatildi):** «bu yo'l brauzerda bir marta ham sinalmagan» deb yozgandim va yangi `smoke-hw-finish.mjs` qurdim — ХАТО edi. `scripts/smoke-homework.mjs` **21.09 da allaqachon yozilgan** (F-0921-01) va u mennikidan kuchliroq: ikki holat (A topshirilgan — qayta yuboriladi · B toza — yubormasligi SHART) × uz/ru = **36 yurish**. Takror skript o'chirildi; mavjud sinov qayta yurgizildi — **36/36 o'tdi**. To'g'ri gap: `smoke-onfinished-all` uyga vazifalarni qamramaydi, lekin `smoke-homework` qamraydi. **Sabog'i:** yangi darvoza qurishdan OLDIN `scripts/` va STATE'dan o'sha nom bo'yicha qidirish shart. **O'z xatom:** birinchi yurishda 18/18 «yiqildi» chiqdi — sinovda `ccHwSeal:` urug'langan, lekin `finished` holati `ccHomework:` kalitidan o'qilar ekan; mahsulot to'g'ri ishlagan, sinov noto'g'ri edi. **ARXITEKTURA TOPILMASI:** uyga vazifada server bilan aloqa **0/18** — darsda ikki kanal (onFinished + jonli sessiya → server → LMS natija-endpointi), vazifada **yagona kanal** (`onFinished`). Ya'ni LMS sahifasi uni o'tkazib yuborsa, zaxira yo'q. Foydalanuvchi: «IT komandaga aytaman, qabul qilishadi». **Chegara (halol):** sinov «muhrlangan yuk → host» yo'lini isbotlaydi; bosqichlarni to'ldirib tugma bosish yo'li sinalmadi (har paketda o'z shartlari), lekin tugma ham, avto ham AYNAN o'sha `finish()` ni chaqiradi. |
| 12:03 (22.09) | **RU-TESHIKLARI — mentor paneli ruschada o'zbekcha ko'rsatardi (F-0922-08).** Topilish yo'li: ohang-yurishidan keyin panelni **ko'z bilan ko'rish** uchun `scripts/shot-mentor-panel.mjs` yozildi (panel faqat mentor rejimida, javoblar kelgach, «Natijani ochish» bosilgach chiqadi — `shot-screen` uni ololmaydi, `smoke-rejim` faqat yiqilmasligini ko'radi). Ruscha suratda **uchta o'zbekcha qoldiq** ko'rindi: (1) hukm-matni butunlay `tr()` siz — «⚠️ Faqat 20% to'g'ri…» ruscha rejimda ham o'zbekcha chiqardi (4 daraja: need·maybe·good·few); (2) hisoblagich «4 **o'quvchi** · 80%»; (3) «**To'g'ri javob**: B —» sarlavhasi va yakka «To'g'ri». **Ko'lam o'lchandi:** 108 ikki tilli darsdan hukm-matni **2 tasida** (`PmLesson5`, `PmLesson6`), hisoblagich **2 tasida**, «To'g'ri javob» **1 tasida** — qolgan 86 tasida `tr()` joyida. Tuzatildi; ruscha matnlar `PmLesson8` (to'g'ri shakl) dan olindi. **Qo'shimcha:** ruscha son-shakli — «4 ученик» xato, `ruPl(n)` yordamchisi qo'shildi (1 ученик · 2-4 ученика · 5+ учеников); skrinshotda tasdiqlandi («3 ученика · 60%»). **Natija:** `PmLesson6` til-qarzi **23 → 0**. Darvozalar: esbuild·jsx·keys·prompt ✓, til/dark bazadan farq 0 · `smoke-rejim` 4 rejim **uz 2/2 · ru 2/2** ✓ · mentor paneli uz va ru da skrinshot bilan ko'z orqali tasdiqlandi. **Sinf allaqachon qonunda:** `darslik-tekshiruvchi` ov-bandi (F-0922-07) — «ikki tilli darsda `{uz, ru}` olgan HAR render nuqtasi `tr()` dan o'tadi». |
| 13:20 (22.09) | **KUN YAKUNI — to'liq regress va yuklash papkasi (F-0922).** **Prob:** standart **160/160 · 0 yiqilish** + solo **27/27 · 0**. **O'z xatom yo'lda tutildi:** birinchi yurishda barcha spetsifikatsiya fayllari birga berildi (187) va 23 tasi «yiqildi» ko'rindi — hammasi `solo-yozma.json` dan, u esa `--solo` bayrog'i bilan yurgizilishi kerak ekan; to'g'ri yurgizilganda 27/27 o'tdi. Standart 160 (qolgan 14 fayl) hammasi toza. **Arena-sinovi:** to'liq yurish **95/97**, ikkala yiqilish ham eski nuqson (F-0922-06/07), tuzatilgach alohida ✓. **Uyga vazifa:** 18/18. **Darvozalar:** `lint:jsx` 156 fayl **0** · `lint:prompt` **0** · `vite build` ✓ · til qarzi **315 → 208**, 🟡 319 (o'zgarmadi — yangi shovqin qo'shilmadi). **Yuklash papkasi `yuklash-2026-09-22/`** — 88 fayl · 7 modul; qabul-tekshiruvi: brauzerda bittalab uz+ru **176/176 · fail 0**, md5 **88/88 mos**, katalog **70/70 dars**. Eski `yuklash-2026-09-21/` joyida qoldirildi (o'chirish buyruq bilan). **113 fayl UNCOMMITTED — commit buyrug'i kutiladi.** |
| 13:40 (22.09) | **UYGA VAZIFA — QA KO'RIK SAYTI qurildi (F-0922-09).** Foydalanuvchi: «Tex darslar vazifasi md da edi — savoli va turini dars mavzusi bilan aniq qilib, uz-ru da QA uchun sayt bersak; QA kirib darsni bosib vizual ko'rib feedback aytadi». **[GATE] to'rt qaror:** fidbek sayt ichida + eksport · qamrov faqat 52 texnik paket (PM lar .jsx, alohida demo bor) · UZ|RU yonma-yon · **AI prompt KO'RSATILMAYDI**. **O'lchov:** `uyga-vazifa/*/*.md` = **52 paket** = aynan 52 texnik dars (34 Kod + 18 Proyekt) — teshik yo'q; turlar Text 20 · Text (kod) 18 · Kompilyator 12 · Text (SQL) 1 · Fayl yuklash 1; 26 namuna-rasm. **Ikki manba (nega):** paket sarlavhasidagi kod eskirgan — `M1-06` (CSS) CRM'da **1-07**, `M1-14` (HTML takrorlash) **1-05**, `M1-15` (VS Code) **1-10**; jami **8 dars M1 da**. Shuning uchun dars nomi va tartibi `yuklash-2026-09-22/*/ROYXAT.md` dan olinadi (uz+ru), paket kodi esa saytda ogohlantirish-chipi bo'lib qoladi. **Qurildi:** `scripts/gen-hw-qa.mjs` (ikki manbani qo'shadi → `src/hw-qa/data.js`, qo'lda tahrirlanmaydi) · `src/hw-qa/main.jsx` + `style.css` (yon ro'yxat · qidiruv · 5 filtr · UZ|RU ustun · namuna-rasm · holat ✅/⚠️/❌ + izoh · `.md` hisobot eksporti · hash-havola `#slug` · ← → klaviatura) · `hw-qa.html` · `vite.hwqa.config.js` → `dist-hwqa` · `npm run gen:hwqa` / `build:hwqa`. Saqlov `localStorage.ccHwQa-v1` — backend yo'q, Vercel'da darrov ishlaydi. **Halol tekshiruv:** 52 dars × 2 til = **104 matn-blok** generatordan MUSTAQIL qayta ajratilib manba `.md` bilan solishtirildi — **farq 0**; bo'sh matn/nom/tur 0; takroriy slug 0. **Brauzerda ko'z bilan:** desktop + telefon, konsol xatosi **0**, 52 qator · 7 modul · rasm yuklanishi (naturalWidth 1053) · fidbek saqlovi · eksport hisoboti · filtr 51 · qidiruv (react 10 · Kompilyator 12) — hammasi tasdiqlandi. **Ko'z bilan tutilgan 3 nuqson** (darvozalar ko'rmaydi): filtr chiplari yon panelda ikkinchi qatorga tushardi · telefonda sarlavha uch qatorga bo'linib tugma ekranni bosib ketardi · favicon yo'qligidan konsolda 2× 404 → uchalasi tuzatildi (inline SVG nishoncha). **Darvozalar:** `gates -- src/hw-qa/main.jsx` **6/6 toza**. Yo'lda ikki til-topilmasi tuzatildi (qiyshiq apostrof · «quyidagi» kantselyarizmi). **Asbob nuqsoni (tuzatilmadi, xabar):** `scripts/lint-keys.mjs` **papka argumentida yiqiladi** (EISDIR) — `src/1-Modull` bilan ham shunday, ya'ni eski va umumiy; shuning uchun `gates` papka bilan chaqirilganda `keys` doim qizil ko'rinadi. **Commit YO'Q · deploy YO'Q** (buyruq kutiladi). |
| 14:23 (22.09) | **GARVARD FOTOSI + `robo-api` NOMI (F-0922-09/10).** **Garvard (A1 yopildi):** foydalanuvchi rasmni media-kutubxonaga yukladi va havolasini berdi. `PmLesson1` keys-slaydiga (bashoratdan KEYINGI slayd — §186 xavfsiz) `PHOTO_SET`+`Photo` naqshi bilan ulandi: `alt` uz+ru, rasm yuklanmasa 🎓 emoji qoladi va dars TO'XTAMAYDI (156-qonun 4-band). Skrinshot bilan tasdiqlandi — rasm yuklanadi, matn ustida, izoh bilan juft turadi. **`robo-api` (Q6 qoldig'i):** tekshiruvda ma'lum bo'ldiki POST darsi **hech qachon tarmoqqa chiqmaydi** — `robo-api.uz` faqat matn/sxema va kod-namunada; haqiqiy `fetch` yo'q. Shu sababli «uchi qayerda tursin» va «ro'yxat umumiymi» savollari **tushib qoldi** — ular faqat haqiqiy POST qurilganda kerak. **[GATE] foydalanuvchi qarori: 2-yo'l** — nom `robo-api.uz` → **`robo-api.example`** (`.example` — hech qachon ro'yxatdan o'tmaydigan standart test-domeni, ya'ni «bu o'ylab topilgan manzil» degani). **68 joy, 2 dars** (`ReactApiGet` 41 · `ReactApiPost` 27); qoldiq 0. **Darvozalar:** ikkala darsda **6/6 toza** (dark ham) · `PmLesson1` til bazadan 4 → 2, dark 3=3 · `smoke-rejim` 4 rejim **uz 3/3 · ru 3/3** ✓ · ekranlar skrinshot bilan ko'rildi (`ROBO-API.EXAMPLE — server jadvali` · Garvard fotosi). |
| 16:37 (22.09) | **MENTOR FIDBEKLARI — CSS darslari, 6 topilma + `.row` (F-0922-11…13).** Foydalanuvchi mentorlardan tushgan fidbeklarni birma-bir berdi; har biriga tashxis → variant → [GATE] tasdiq → bajarish. **1) `.row` (A varianti):** `CssLesson2` `.row` ni so'raydi, `CssLesson1` esa selektorni faqat TEG deb o'rgatadi — nuqtali selektor va uning HTML manbai (`class="row"`) hech qayerda aytilmagan (o'lchov: CSS-2 3-ekranidan oldin `.row` 7 marta, izoh 0). Selektor ta'rifiga bir gap qo'shildi. **2) «ko'ndalang o'q» → «vertikal»:** 12+2 joy, ruschasi ham («поперёк» → «по вертикали»). **Juftlik masalasi:** «asosiy o'q» ni qoldirsak diagrammada «asosiy o'q ↔ vertikal» mos kelmaydigan juft chiqardi — ikkalasi birga **gorizontal ↔ vertikal** qilindi (foydalanuvchiga aytildi). Ustiga bir uzilish tuzatildi: «aynan shu **o'q** bo'ylab» → «shu **yo'nalish** bo'ylab» (ishora bo'sh qolgandi). **3) TASK_CENTER — HAQIQIY BUG:** topshiriq `display: flex` ni so'raydi, shartlar ro'yxatida esa faqat `justify-content` va `align-items` bor edi → o'quvchi «2/2 bajarildi» olib «Davom etish» bosardi, **quti markazga tushmasa ham**. Qolgan uch praktikada (`TASK_FLEX`·`TASK_COLUMN`·`TASK_HW`) bu shart bor — bu yagona istisno. Shart 1-o'ringa qo'shildi, ipuchasi «`display: flex` bo'lmasa ikkalasi umuman ishlamaydi». **Dasturiy isbot:** `checks.cssValue` skrinshotdagi chala kodga qarshi yurgizildi — **BLOKLADI**; `display` qo'shilsa — **O'TDI**. **4) 3-ekran, «konteyner»:** ta'rif diagrammani bosganda chiqardi, o'tish uchun esa faqat `flex` yetardi — ta'rif o'qilmay qolardi (mentor «container tushuntirish kerak» dedi, holbuki kodda bor edi). Endi ikkala bo'lakni bosish SHART; tugma «Konteyner va ichki elementni bosing» deb turadi. **5) Uch flashkarta qayta yozildi:** «qator bo'ylab (chapdan o'ngga)» → «gorizontal yo'nalishda joylashtirish» · «chetdan chetga teng yoyish» → «bo'shliq teng, birinchisi chap chetda, oxirgisi o'ng chetda» · «tom o'rtaga» → «gorizontal ham, vertikal ham markazga»; align-items kartasi ham «vertikal» ga o'tdi. **Darvozalar:** 3 faylda esbuild·jsx·keys·prompt ✓; til bazadan **yaxshilandi** (CssLesson1 2→0 · CssLesson2 3→0 · CssPractice 8→5), dark o'zgarmadi (8/9/4). **Sinovlar:** `smoke-rejim` 4 rejim **uz 3/3 · ru 3/3** · ekran-probi **5/5** · solo-prob **2/2** · oltala o'zgarish **skrinshot bilan ko'z orqali** tasdiqlandi (eng uzun flashkarta 3 qatorda sig'di). **Muhr:** `MATN_KORPUS.md` **§191** (atama so'ralgan joyda yoki undan oldin ta'riflanadi) · **§192** (izoh ixtiyoriy bosish ortida qolmaydi) · **§193** (gorizontal/vertikal, juftlikni buzmaslik + column chegarasi); `darslik-tekshiruvchi` ga ov-bandi (praktika sharti topshiriq matnidan kam bo'lib qolishi — jim o'tadigan sinf). |
| 18:19 (22.09) | **MENTOR FIDBEKLARI — m1-08 savol tuzilishi va sarlavha fe'li (F-0922-14/15).** Foydalanuvchi ikki juft skrinshot berdi (uz+ru). Dars: `src/1-Modull/HtmlPractice.jsx` — **m1-08 «Praktika: portfolio strukturasi»**. **1) F-0922-14 «yuriladi» (qator 636):** «Bo'limlar orasida qanday **yuriladi**?» — fe'l harakatga mos emas (ekranda bosiladi, yurilmaydi) va **juftlik buzilgan** edi: ruschasi «переходить» (o'tish) derdi. O'lchov: shu ma'noda 1 joy (`NodeServerLesson:239` «node bilan yuriladi» — boshqa ma'no, tegilmadi). **[GATE] 1-B tanlandi:** «Bo'limdan bo'limga qanday **o'tamiz**?» / «Как **перейдём** из раздела в раздел?» — `-amiz` keyingi qatordagi Mentor gapiga («menyu **qo'shamiz**») ergashadi; egasiz «o'tadi» «kim o'tadi?» savolini qoldirardi. **2) F-0922-15 savol tuzilishi (671):** mentor aytdi «rus tilini biladigan bolalarimam tushunmadi». **Tashxis — til emas, qurilish:** bitta gapda majhul (`yaratiladi`/`создаётся`) + vosita kelishigi oldinda (`Каким тегом…`) + vergul ortidan sifatdosh oborot (`, ведущая…`) / ikki sifatdosh ketma-ket (`o'tkazadigan, bosiladigan`) — o'quvchi gap egasini oxirigacha topolmaydi. **[GATE] 2-A tanlandi** (vaziyat ayrim gap + qisqa aniq savol): «Menyudagi yozuv bosilsa, boshqa bo'limga olib boradi. Bunday **havolani** qaysi teg **yasaydi**?» / «Надпись в меню при клике ведёт в другой раздел. Какой тег **делает** такую ссылку?» — `yasaydi`/`делает` shu darsning flashkartasida (1504) allaqachon ishlatilgan, ya'ni fayl ichida izchillik tiklandi. **3) 4-savol ham (773, foydalanuvchi «ha»):** aks holda bir dars ichida savollarning yarmi majhul, yarmi aniq qolardi — «…ro'yxat qaysi teg bilan yaratiladi?» → «…ro'yxatni qaysi teg yasaydi?» / «Какой тег делает…». Audio-matnlari (669·771) shu bilan moslandi. **Darvozalar (bazaga solishtirildi):** esbuild·jsx·keys·prompt ✓; `til` **8🔴 → 2🔴** (qolgan 2 — eski `jon-kiritish` 983/1023, bu ishga aloqasi yo'q), 🟡 27=27 o'zgarmadi; `dark` **4=4** (eskidan). **O'Z XATOM yo'lda tutildi:** «tegishdan oldingi» nusxani teskari almashtirish bilan qurganda **faqat o'zbekcha yarmini qaytarganman** — ruscha yarmi yangi bo'lib qolgan, shuning uchun birinchi tekshiruvda RU qoidasi 0 topilma berdi va men uni «ishlamadi» deb o'yladim. Nusxa to'liq (uz+ru birga) qayta qurildi va o'shanda RU qoidasi **2 joyni (671·773) tutdi**. Sabog'i: baza-nusxa **juftlikni butun** qaytarishi shart, aks holda darvoza-solishtiruvi yolg'on gapiradi. **Ko'z bilan:** `shot-screen` bilan 3 ekran × uz+ru = **6 skrinshot** tasdiqlandi (s5 sarlavha · s6 2-savol · s10 4-savol). Yo'lda asbob-kuzatuvi: `SHOT_WAIT` sukut 900 ms m1-08 s5 uchun **yetmaydi** — sarlavha/Mentor/kod-kartasi `fade-up` ostida ko'rinmay qoladi va surat «bo'sh ekran» bo'lib chiqadi (ikki marta takrorlandi); `SHOT_WAIT=2500` bilan to'liq chizildi. Bu **asbob timing'i, darsda nuqson emas** — RU suratda 900 ms da ham to'liq chiqqan. **Muhr:** `MATN_KORPUS.md` **§194** (savol so'raydi — hisobot bermaydi: majhul→aniq, oborot→ayrim gap, bir darsda bir ohang) · **§195** (harakat fe'li real harakatga mos, til juftini birga tekshirish, sarlavha fe'lining shaxsi Mentor gapiga ergashadi); `til-lint-rules.json` → **`majhul-savol`** (uz) va **`majhul-savol-ru`** (ru), ikkalasi 🔴 error. **Qoida qarz tashlamadi:** qo'shishdan oldin o'lchandi — butun `src/` da ikkala naqsh **0 hodisa**; qo'shilgandan keyin `lint:til src` bo'ylab `majhul-savol*` **0**. Qoida haqiqatan tutishi eski nusxada isbotlandi (uz 4 joy · ru 2 joy). **Qilinmadi (foydalanuvchiga aytildi):** «bosiladigan havola / кликабельная ссылка» — 3 faylda 25 joy, ikkinchi to'lqin, buyruq kutadi; sifatdosh uyumi qoidasi qo'yilmadi (2 hodisa qolardi, biri 7-Modulda — u chetga surilgan). **Commit YO'Q.** |
| 19:25 (22.09) | **🔴 LMS: «Natijani saqlab bo'lmadi» — o'quvchilar darsni yakunlay olmayapti (F-0922-18). USTUVOR.** Rasm: `lms.coddycamp.uz/course/20/module/70/2417` (= `Htmllesson1`, m1-03), konsol `lesson_runner_result_not_passed` (`LessonRunnerQuestion.CGrLJfOl.js`). **Tashxis — ikkala tomonning DEPLOY QILINGAN kodidan o'qildi** (LMS bundle'lari `/assets/` dan yuklab olindi, `rW` = `question_try`): runner `onFinished` yukidagi `passed` ni `correct: passed?1:0` qilib CRM'ga yuboradi, javobda `correct !== true` bo'lsa **xato tashlaydi** → toast «saqlab bo'lmadi» (natija aslida 200 bilan SAQLANGAN, matn yolg'on). Bizda `passed = final-savol ≥60%, birinchi urinish` (110 dars, 04.07 dan); **o'lchov: 97 darsdan 96 tasida final savol BITTA** → `passed` = «bitta savolni birinchi bosishda topdi». Kuchaytiruvchilar (18.09 §41): yuk muhri → qayta bosish o'sha `correct:false` ni keshdan oladi; «Qaytadan» → birinchi o'tish ketadi → **abadiy qulf**; uyga vazifa yukida `passed` YO'Q (18 paket) → runner'da hammasi yiqilardi. Ilgari ko'rilmagan: 21.09 sinovda 3/5 = aynan 60%; `smoke-onfinished` `passed` ni tekshirmaydi; server `passed` ga qaramaydi. **Hujjat:** `muammoga-yechim.md` (Axadullaga: zanjir · kim-nima · LMS'dagi hozirgi yuk jadvali · 5 so'rov · tartib). **Codemod QILINDI va QAYTARILDI:** `passed: true` 110 dars + uyga vazifa `passed` 18 paket aynan-satr bilan qo'yildi, keyin **foydalanuvchi to'xtatdi** («LMS'dagi to'plam qolsin — Axadulla shunga qarab fiks qilyapti, aralashib ketadi») → aynan teskari qaytarildi: 110/110 · 18/18, qoldiq 0, `lint:jsx` 157 fayl 0, esbuild ✓. **HOLAT: dars-kodi MUZLATILGAN** — Axadulla runner'ni tuzatib xabar beradi, 5.4 javobi (CRM `correct` ni nimaga ishlatadi) keladi → foydalanuvchi o'zgartirish/o'zgartirmaslikni aytadi. Taklif (kutmoqda): `passed` = «tugatdi», ball alohida maydonlarda; uyga vazifaga `passed`. **Commit YO'Q.** |
| 19:25 (22.09) | **m1-08 flashkarta fidbeklari — kod tayyor, muhr keyin (F-0922-16/17).** `<nav>` s5 Mentor gapiga ta'rif (1-A, §191 sinfi — asosiy oqimda nomi aytilmagan yagona teg, `src`/`alt` induktiv ekranlarda o'rgatiladi — teshik emas); footer/header izohlari «sahifaning eng oxirgi/birinchi qismi» (2-C, «sayt» emas — m1-03 4 sahifali sayt quradi); mailto kartasi allaqachon o'zgargan (0 joy). Darvozalar bazadan farq 0, smoke uz/ru 4/4, 4 skrinshot ✓. Rol-fayli ov-bandi va §191 ikkinchi hodisa yozuvi — LMS ustuvorligi sabab keyinga. |
| 19:35 (22.09) | **Axadulla «fixed» — deploy qilingan kod o'qildi (F-0922-18 davomi).** LMS qayta deploy: `index.DpMLTxDq`→`C2KOEQk5`, runner `LessonRunnerQuestion.CGrLJfOl`→`BCb6IIxO` (eskilari 404). Ikki runner to'liq matni solishtirildi — **yagona ma'no-farqi bitta token:** `Q(…, !!(s?.passed), …)` → `Q(…, !0, …)`, ya'ni LMS endi CRM'ga **har doim `correct: 1`** yuboradi; `passed` maydonimiz **o'qilmaydi**. Qolgani aynan eski: `r.correct !== true → throw not_passed` (endi yetib bo'lmaydigan shox), toast «saqlab bo'lmadi» (haqiqiy xatolar uchun qoladi), kalit bir ochilishda bitta. `LessonRunner.CMEVHH6P` (dars-yuklovchi H) da manba/yukni o'zgartiruvchi joy YO'Q — `onFinished` to'g'ri uzatiladi. **Natija:** o'quvchi ochiladi (bizning `passed:false`, «Qaytadan», muhr, uyga vazifadagi `passed` yo'qligi — hammasi endi ta'sirsiz), lekin CRM `question_try` da har urinish `correct=1` bo'lib yoziladi — o'tmagan ham. Ball haqiqati faqat `answer` JSON ichida (`scorePercent`/`questions[]`). **Tekshirilmadi (imkon yo'q):** bizning `.jsx` serverda o'zgartirilganmi — `course_artifacts/<nom>.jsx` nomi kontent-md5 EMAS (3 namuna bilan isbotlandi), `jsx_url` faqat auth-API'da; foydalanuvchiga DevTools Network'da solishtirish uchun lokal md5/hajm berildi (21.09: 575144 b `b7f7a95e…` · 22.09: 577026 b `74dc5ca5…`). **Bizning kod tegilmagan.** Ochiq: §5.4 — CRM `correct` ni nimaga ishlatadi; javobga qarab `passed` ma'nosi (foydalanuvchi qarori). |
| 19:42 (22.09) | **Axadulla JAVOB 2026-09-22 keldi (`~/Downloads/Telegram Desktop/JAVOB_DARS_PLATFORM_2026-09-22_UZ.md`) — deploy-koddan o'qiganimizga AYNAN MOS.** §1 School API: `attempts.at`/`elapsed_ms` qat'iy o'sish talabi olib tashlandi (commit `85a7567`, 124 test); 12 `manual_review` hodisa qayta yetkazildi, hammasi 201 — bu bizning `buildResultDetails` zaxirasi (`baseAt` — ikki urinish bir xil `at`, `elapsed_ms: 0`) tufayli edi, bizdan o'zgarish talab qilinmaydi. §2 LMS: sabab-zanjirini biz topganday tasvirlagan (`passed:false` → `question_try.correct` → toast); fiks: `correct: 1` doim = «JSX dars yakunlandi» signali; `answer` ichidagi `passed`/`scorePercent`/savollar o'zgarmaydi; **CRM javobidagi yuqori `passed` ham shu yakunlash qiymatidan** — §5.4 javobi shu. Frontend main `d7db365`, staging `13470a9`; prod'da 2374 eski `passed:false` payload → `question_try` 200 `correct:true` · `next_lesson_access` 200 `completed`. §4 bizdan: (a) `onFinished` FAQAT haqiqiy yakunda chaqirilsin, (b) `passed/correct/solved` ni soxta `true` QILMANG — **bizning codemod-qaytarish to'g'ri bo'ldi**, kod tegilmaydi. **O'lchov (a uchun):** 110/110 darsda `onFinished` aynan 1 joyda — `finishLesson`, u faqat yakuniy ekrandagi «Keyingi dars →» tugmasidan (`onFinish={finishLesson}` 110/110; useEffect'da avto-chaqiruv 0). Uyga vazifa (18): avto — 4/4 bosqich bajarilganda (`doneCount >= HW_PASS_MIN`), qo'lda tugma YO'Q; qayta kirishda muhr qayta yuboriladi (18/18). **Aytiladigan chegara:** `review` (tugagan urinishni ko'rish) rejimida yakuniy ekran tugmasi bloklanmagan → o'quvchi qayta bossa `onFinished` ikkinchi marta ketadi (yangi ochilish = yangi kalit → CRM'da ikkinchi `correct:1` yozuv); uyga vazifa ham har qayta ochilishda muhrni yuboradi. Bu «tugallanmagan urinish» EMAS (ikkalasi ham tugagan), lekin takror — Axadullaga aytiladi, qaror uniki. `muammoga-yechim.md` yuborilmagan — asosiy savoliga javob berilgani uchun ENDI KERAK EMAS; o'rniga qisqa javob (§4 ga dalil + takror-chegara + retest). **Kod o'zgarishsiz. Commit YO'Q.** |
| 19:55 (22.09) | **m1-08 flashkarta fidbeklari — MUHR YOPILDI (F-0922-16/17).** LMS ustuvorligidan keyin qaytildi; holat tekshirildi: 3 o'zgarish joyida (1·2·1), darvozalar bazaga teng (til 2🔴/27🟡 · dark 4 · esbuild/jsx/keys/prompt ✓). **F-0922-16 `<nav>`:** mentor «header/footer o'rgatilgan, nav yo'q edi» — **haq**: o'lchov — `<header>` s3 va `<footer>` s12 Mentor gapida nomi bilan, `<nav>` s5 kod-oynasida shunchaki turardi; ta'rif faqat xato-javob izohida (674) va ixtiyoriy «Qayta tushuntirish» panelida (RECAPS[6]) — to'g'ri javob bergan o'quvchi ko'rmaydi; yakuniy RECAP flashkartadan KEYIN. **[GATE] 1-A:** s5 Mentor gapiga bir jumla «Menyu havolalari `<nav>` ichida turadi — bu menyu idishi» (uz+ru). Butun karta-to'plami o'lchandi: 12 javobdan faqat `<nav>` teshik; `src`/`alt` avto-grepda «teshik» ko'rindi, lekin s7/s8 da savolning to'g'ri javobi (induktiv) — teshik EMAS, tekshiruv-usuli shunga aniqlashtirildi. **F-0922-17 footer kartasi:** foydalanuvchi «saytning eng oxirgi qismi» dedi; **[GATE] 2-C** (juftlik): izohlar «sahifaning eng **oxirgi**/eng **birinchi** qismi» (ru «самая последняя/первая часть страницы») — «**sayt**» emas: m1-03 (`Htmllesson1`, 5 dars oldin) 4 sahifali sayt qurdiradi, footer sahifaniki; foydalanuvchiga aytildi. **mailto kartasi:** rasmdagi matn butun `src` da 0 joy — ikki oyda allaqachon o'zgargan, tegilmadi. **Tekshiruv:** smoke-rejim uz 4/4 · ru 4/4; 4 skrinshot (s5 uz/ru, flashkarta header · footer — 11 «Bildim» bosib yetildi, `CLICK` zanjiri) ✓; P1 prob 14/14 (s2/s14). **Muhr:** `darslik-tekshiruvchi` → ov-bandi «flashkarta javobi asosiy oqimda o'rgatilmagan» (o'rgatilgan = Mentor nomlaydi YOKI savolning to'g'ri javobi; hisoblanmaydi: kod-oyna, xato-izoh, ixtiyoriy panel, keyingi RECAP; avto-grep soxta teshik ogohi) · `MATN_KORPUS.md` §191 ga ikkinchi hodisa + tekshiruv-usuli aniqligi. `lint:prompt` 0. **Eslatma (foydalanuvchi qoidasi, xotiraga yozildi):** fidbek rasmlari ~2 oylik — faqat aytilgan so'z tuzatiladi, dizayn/mantiq hozirgi versiyada qoladi. **Commit YO'Q.** |
| 21:28 (22.09) | **🔤 LIGATURA SUPURISHI — 115 fayl, 158-QONUN (F-0922-19).** Foydalanuvchi skrinshoti: `PracticeLesson1` s6 da `if (rejim === "yorug'")` o'rniga uch chiziqli begona belgi. **Tashxis:** kod TO'G'RI yozilgan — `JetBrains Mono` dasturchi-shrifti `===` ni bitta glifga qo'shib chizadi; muammo o'z renderimda takrorlandi (skrinshot). **Ma'lum sinf:** F-0808-02 → F-0812-03, yechimi `JsConditionsLesson.jsx:2588` izohida (taqqoslash-rasmi bilan), lekin faqat **3 darsga** qo'yilgan edi. **O'lchov:** 126 fayl · 2500 e'lon ochiq; shundan ~94 faylda ko'rinadigan kodda operator bor. **[GATE] foydalanuvchi: B varianti (to'liq supurish), 7-Modul TEGILMASIN.** **Asbob:** `scripts/codemod-ligatura.mjs` (`--dry` · `--check` · fayl-ro'yxati; 7-Modul va arxivni o'zi chetlab o'tadi). Shakl-tahlili oldindan qilindi: CSS 4 shakl (`, monospace;` 1686 · `;` 807 · `,monospace;` 14 · **nuqta-vergulsiz `}` 1**) + inline 3 shakl (63); bir qatorda ikkita e'lon — **0**. **Bajarildi: 115 fayl · 2402 CSS + 63 inline** (avvaldan yopiq 106 tegilmadi). **ANIQLIK ISBOTI:** codemod `HtmlCompiler` (siqiq CSS + `}`-yakun — eng qiyin holat) saqlangan nusxaga qarshi teskari qaytarildi → **bayt-babayt bir xil**, ya'ni FAQAT xossa qo'shilgan. Yo'lda topilgan yagona ortiqcha o'zgarish — siqiq CSS'da `font-family:'` → `font-family: '` (9 qator) — asl holiga qaytarildi; `}`-yakunli qator faylning siqiq uslubiga moslandi. **Hisob-kitob:** 2571 mono-e'lon = 2571 xossa; ortiqcha 9 ta — HEAD'da ham bor bo'lgan guruh-qoidalari (7 fayl) va JS o'lchov-probi. **Darvozalar:** `lint:jsx` butun loyiha **0** · esbuild **118/118** · `vite build` ✓ · `codemod --check` **qoldiq 0** · `smoke-rejim` 10 dars (1·2·3·4·4a·5·6·pm) to'rt rejimda **10/10**. **Ko'z bilan:** `PracticeLesson1` s6 **oldin/keyin** juftligi (`≡` → `===`) + `AuthEnvLesson` s8 · `ReactApiPost` s9 · `Htmllesson2` s7 (ru) — buzilish yo'q. **7-Modul tegilmagani md5 bilan tasdiqlandi** (`PmLesson31` farqi — bugun ertalabki F-0922-01 ishi, ligatura-xossasi 0). **Muhr:** `DARS_ETALON.md` **158-QONUN** (uch qattiq shart: `font-variant-ligatures` ishlatilmaydi — Chrome qatorni tashlaydi · guruh-selektorga yozilmaydi · ildizdagi `ss01/cv11` yetmaydi; darvoza — `--check`); `KATTA_TOZALASH.md` → 7-Modul qoldig'i (12 fayl · 88 e'lon, bir buyruq). **Commit YO'Q.** |
| 21:53 (22.09) | **m2-12 MATN FIDBEKLARI — «pardoz» va deploy glossi (F-0922-20/21).** Mentor skrinshotda ikki joyni tagiga chizgan: «Oxirgi **pardoz**» va «Deploy — **dunyoga chiqarish**». Dars: `src/2-Modull/PracticeLesson4.jsx` (m2-12 «Ishlab chiqish — 2: MVP tayyor»). **F-0922-20 «pardoz»:** o'zbekchada birinchi ma'nosi — yuzga qo'yiladigan bo'yoq; ruschasi («последний штрих») to'g'ri edi, ya'ni **juftlik teng emas**. O'lchov: 10 joy, faqat shu darsda; 7 tasi ko'rinadi. **[GATE] 1-A:** → «**oxirgi yaxshilanish**» — shu ekranning Mentori o'zi «kichik **yaxshilanishlar** qo'shamiz» deydi, ya'ni bir ekranda ikki so'z turgan edi. Ruscha «штрих» tegilmadi (muammosi yo'q). Test savolidagi ortiqcha «(jilolash)» glossi olib tashlandi. **F-0922-21 deploy glossi:** bitta ekranda ikki xil — Mentor «(internetga chiqaramiz)», ro'yxat «dunyoga chiqarish». O'lchov: UZ «internetga» 7 · «dunyoga» 10 (2 tasi `<span>` ichida bo'lingan — birinchi grep ko'rmagan); RU «в интернет» 12 · «в мир» 8. **[GATE] 2-A:** hammasi «**internetga chiqarish**» / «**в интернет**» — UZ 11 · RU 7 almashtirildi. **Nishon tegilmadi:** «Shipped It! — MVP'ni dunyoga chiqardingiz» codemod paytida himoyalab qo'yildi (3-savolga javob kelmagan — bayram matni, atama o'rgatmaydi; bir so'z bilan o'zgartiriladi). **ANIQLIK:** fayl oldindan saqlandi; 21 o'zgargan qatorning **21 tasi ham** kutilgan almashtirish bilan izohlandi (871-qator «boshqa farq» ko'rindi — mening teskari-tekshiruvim o'sha qatordagi AVVALDAN turgan «internetga»ni ham buzgani uchun; alohida tasdiqlandi). **Darvozalar:** esbuild·jsx·keys·prompt ✓; til **3🔴/6🟡 = baza**, dark **7 = baza**. **Sinov:** `smoke-rejim` uz 4/4 · ru 4/4; **4 skrinshot** (reja uz+ru · oxirgi yaxshilanish uz · deploy ru) — barchasi to'g'ri, buzilish yo'q. **Muhr:** `MATN_KORPUS.md` **§196** (atama bir darsda ikki xil izohlanmaydi + ikki tilni alohida sanash usuli + nishon istisnosi) · **§197** («pardoz» sinfi: birinchi ma'nosi boshqa sohadan bo'lgan so'z darsga kiritilmaydi); `til-lint-rules.json` → **`pardoz-sozi`** 🔴 (qo'shishdan oldin o'lchandi — butun `src` da qarz **0**; eski matnda 9 joyni tutishi isbotlandi). **Tegilmadi (aytilmagani uchun):** «jilolash/jilolangan» — shu faylda 2 joy, KORPUS §197 da yozib qo'yildi, qaror foydalanuvchida. `KATTA_TOZALASH.md` → 7-Modul qoldig'i (`MvpBuild2Lesson:792`, 1 joy). **Commit YO'Q.** |
| 22:10 (22.09) | **m2-02 ATAMA ALMASHTIRISH — «qiyinchilik/imkoniyat» → «muammo/yechim» (F-0922-22).** Mentor: «Har bir yechimni muammoga moslab qo'ying». Dars: `PmLesson4` (m2-02 «Muammodan yechimga») + uy vazifasi. **Tashxis — bitta sarlavha emas:** `imkoniyat` **210** · `qiyinchilik` **160** hodisa, 9 faylga tarqalgan; ikki tilda izchil juftlik (`возможность`/`трудность`). **Uch dalil:** (1) mexanika — chapda muammolar (CSS sinfi `mt-pain`), o'ngda yechim-kartalari; (2) **dars o'z nomiga zid** — katalogda va fayl-izohida «MUAMMODAN YECHIMGA», matnda «qiyinchilik→imkoniyat»; (3) faqat sarlavhani almashtirish bugungi **§196 ni buzardi**. **[GATE] foydalanuvchi: B** (butun dars + uy vazifasi), «aniqlik, ehtiyotkorlik, halollik bilan». **HALOL OGOHLANTIRISH berildi:** `imkoniyat` shu darsda TA'RIFLANGAN atama edi — «Sayt beradigan har bir aniq foyda — imkoniyat (feature) deyiladi»; endi «yechim (feature)». Foydalanuvchi to'xtatmadi. **Bajarildi:** 2 fayl, **449 almashtirish** — o'zbekchada 17 shakl (k→g o'zgarishi bilan: `qiyinchiligiga`→`muammosiga`), ruschada **kelishik-jadvali** bilan (`трудность` 3-turlanish → `проблема` 1-turlanish: nom≠acc). **Regex EMAS — aynan-ibora jadvali.** **13 KELISHUV XATOSI tutildi va tuzatildi:** 8 tasi avtomatik qidiruv bilan (`которая`→`которое` · `должна`→`должно` · `одна проблему`), **5 tasi FAQAT MATNNI O'QIGANDA** (uzoqdagi olmoshlar: `она убирает`→`оно` · `с её проблемой`→`с его` · `на каждую — под ней`→`на каждое — под ним` · `нужна ли это решение`→`нужно ли`) + **3 ta O'Z KELISHIK XATOM** (`тяжёлой/одной/найденной проблеме` → genitiv `проблемы`). **Darvozalar:** esbuild·jsx·keys·prompt ✓ ikkala faylda; til **0🔴/5🟡 = baza**, dark **2 = baza**. **Sinov:** `smoke-rejim` uz 4/4 · ru 4/4 · `smoke-hw` ✓ · **4 skrinshot** (juftlash uz+ru · ta'rif uz+ru). **Muhr:** `MATN_KORPUS.md` **§198** (atama mexanika bilan bir gapirsin + «dars nomi · fayl-izohi · mexanika · matn — to'rttasi bir so'znimi?» tekshiruvi) · **§199** (ruscha atama almashsa rod/kelishik/olmosh birga o'zgaradi — 6 sinfli jadval + «oxirgi qadam matnni O'QISH»); `KATTA_TOZALASH.md` → qolgan **7 fayl · 74+56 hodisa**, 🔴 **avval qaror** (PmLesson5 da «imkoniyat» boshqa ma'noda bo'lishi mumkin). **Commit YO'Q.** |
| 22:24 (22.09) | **YAKUNIY REGRESS — ekran-probi 160/160 · 0 yiqilish.** Bugungi butun ishdan keyin to'liq standart yurish (14 spetsifikatsiya, solo'siz): ligatura supurishi (115 fayl · 2465 e'lon), m1-08 va m2-12 matn-fidbeklari, m2-02 atama-almashtirishi (449), mentor ohangi, arena avto-o'tish — **hech biri regress bermadi**. Yo'l-yo'lakay kuzatuv: `ach-probe` ni fonda kutganda `until ! pgrep -f "ach-probe"` o'z satrini ko'rib abadiy aylanadi — `ach-prob[e]` qavs-hiylasi bilan yechildi (xotiradagi «fon-buyruq o'zini ko'radi» sabog'i). |
| 23:33 (22.09) | **m2-02 MENTOR FIDBEKLARI — «juftlik» olib tashlandi, sarlavha, CodeStrike tashxisi (F-0922-23).** Foydalanuvchi 12 rasm berdi. **(1) Atama (20·21·24–31-rasm):** «qiyinchilik/imkoniyat» — oldingi raundda yopilgan deb hisoblagandim, **NOTO'G'RI**: ustaxona yorliqlari `lbl: { uz: 'QIYINCHILIK', ru: 'ТРУДНОСТЬ' }` **BOSH HARFLARDA** yozilgan, mening qoldiq-tekshiruvim registrga sezgir edi → ikki tilda ham qolib ketgan, faqat **skrinshotda** ko'rindi (6 ko'rinadigan yorliq + 7 kod-izohi tuzatildi). **(2) [GATE] 3-C:** «**Ishga oladigan** uch muammoni belgilang» → «**Uch muammoni tanlang**» (o'zbekchada «ishga olmoq» = odamni ishga qabul qilish; ruschasi to'g'ri edi, juftlik teng emasdi) → ru «Выберите три проблемы». **(3) [GATE] 4-C «juftlik»:** 51 hodisa (46 ko'rinadigan) + ruscha «пара» **45 hodisa** olib tashlandi — **103 almashtirish** ikki to'lqinda. Ma'no joylarida «**muammo va yechim**» / «**проблема и решение**», UI-hisoblagichlarda «**karta**» / «**карточка**» (dars uni allaqachon shunday ataydi: nishon «Card Writer!», `juftlik-karta`) — **bu 4-C dan chetlanish, foydalanuvchiga aytiladi**. Test sarlavhasi foydalanuvchi so'zi bilan: «**Qaysi muammoga yechim to'g'ri yozilgan?**». Ekran-eyebrow'i «Juftlash» → «**Moslash**». **(4) CodeStrike bug — kod emas, yuklangan nusxa:** `yuklash-2026-09-21` (LMS'da shu) da `{arena && <QuizArena` **0 marta**, `yuklash-2026-09-22` da **1 marta** — ya'ni bugun 11:38 da tuzatilgan F-0922-06 hali yuklanmagan. Foydalanuvchi: «bugun fidbeklar tuzatilgan holda yuklanadi». **Ikkinchi to'lqin kerak bo'ldi:** birinchi jadval `juftlarini` ni o'tkazib yuborgan (o'zagi `juft`, mening naqshim `juftli` talab qilardi) va 21 ruscha joy qolgan edi. **Yakuniy qoldiq (registrga BEFARQ):** `qiyinchilik/imkoniyat` **0** · `трудность/возможность` **0** · `juft/пара` ko'rinadigan matnda **0** (4 kod-izohi qoldi, ataylab). **Darvozalar:** esbuild·jsx·keys·prompt ✓ ikkala faylda; til **0🔴/5🟡 = baza**, dark **2 = baza**. **Sinov:** smoke uz 4/4 · ru 4/4 · smoke-hw ✓ · **8 skrinshot** (s7·s8·s9 uz+ru + yorliq-tuzatishidan keyin s8 qayta uz+ru). **Muhr:** `MATN_KORPUS.md` **§200** — qoldiq-tekshiruv registrga befarq bo'lsin (kichik·Bosh·KATTA) + o'zak-qidiruvi qo'shimchani qamrasin (`juft` vs `juftli`) + yakuniy dalil skrinshot. **Commit YO'Q.** |
| 23:54 (22.09) | **m1-06 GOOGLE FONTS — YANGI EKRAN `s7b` (F-0922-24).** Mentor: «Google Fonts dan foydalanishni qo'shib ketish kerak. 1-modul CSS». **Tashxis:** Google Fonts butun kursda o'quvchiga **hech qachon o'rgatilmaydi** (ko'rinadigan matnda 0 joy; topilgan `@import` lar — bizning o'z darslik shriftimiz). `CssLesson1` 7-ekranida faqat uch TIZIM shrifti bor (sans/serif/mono) — o'quvchi shrift tanlashni biladi, yangi shrift **olib kelishni** bilmaydi. **Joyi tayyor edi:** shu darsning **3b-ekrani** aynan «CSS'ni HTML'ga ulash» ni o'rgatadi, ya'ni `<link>` mexanizmi tanish; darsda `3b`·`5b`·`15b` qo'shimcha-ekran naqshi ham bor. **[GATE] A varianti + interaktiv** (foydalanuvchi: «o'quvchilar dars qilmayotgan paytda yuklayman»). **Tavsiyam o'zgartirildi va sababi aytildi:** Roboto RAD etildi — u tizim `sans-serif` dan deyarli farq qilmaydi, bola o'zgarishni sezmaydi; o'rniga keskin farq qiladigan uchtasi: **Montserrat** (zamonaviy) · **Playfair Display** (klassik) · **Lobster** (yozma). Uchalasi ham **kirillni qo'llab-quvvatlaydi** — ru-rejimda skrinshot bilan tasdiqlandi (quti-harf yo'q). **Mexanika (192-qonun):** ikki qadam ATAYLAB ajratilgan — `<link>` (olib kelish) va `font-family` (ishlatish); **havola-uzgichi MAJBURIY**, aks holda asosiy tushuncha ixtiyoriy bosish ortida qolardi. Havola uzilganda: `<link>` qatori chizib tashlanadi, matn oddiy shriftga qaytadi, CSS esa hali ham `'Lobster'` deb turadi — o'quvchi «CSS yolg'iz yetmaydi» ni **ko'zi bilan** ko'radi. **🔴 INDEKS SILJISHI tutildi:** `RECAPS = { 5, 7, 11, 14 }` — raqamli kalit; `s7b` qo'shilgach 11·14 siljidi → **12·15** qilindi (tekshirildi: to'rttala kalit ham test-ekraniga tushadi). `INLINE_KEYS` string-id bilan — xavfsiz; `ach-probe` ham `ids.indexOf(sid)` — xavfsiz. **Ball tegilmadi:** `scored: false` (3b naqshi) → `totalQuestions` 4 da qoldi. **Yakuniy xulosaga** 6-band qo'shildi (aks holda «nima o'rgandik» ro'yxati darsga zid bo'lardi — §198 mantig'i). **Darvozalar:** esbuild·jsx·keys·til·prompt ✓; dark **8 = baza**. **Sinov:** smoke uz 4/4 · ru 4/4 · **7 skrinshot** (boshlang'ich uz+ru · Lobster tanlangan · havola uzilgan · ru-Lobster · ru-Playfair · yakuniy xulosa). **Muhr:** `darslik-tekshiruvchi` → ov-bandi «ekran qo'shilsa indeks bilan kalitlangan tuzilmalar siljiydi» (ovlash retsepti + `useServerProgress` yon ta'siri). **Ekran soni 21 → 22** — boshlagan o'quvchining progressi tozalanadi, shuning uchun dars ishlatilmayotgan paytda yuklanadi. **Commit YO'Q.** |
| 00:34 (23.09) | **UCH SEANS ISHI TEKSHIRILDI + LAYOUT TASHXISI + `variable` (F-0923-01/02).** Foydalanuvchi 22.09 da yana ikki seans ochib parallel ishlatgan; men hammasini birga tekshirdim. **Kesishish/yo'qotish YO'Q:** `lint:jsx` 157 fayl **0** · esbuild 118 **toza** · `vite build` ✓ · `lint:keys` 97 dars **nomos 0** · `SCREEN_META ↔ screens` barcha darsda mos · smoke uz **9/9** ru **9/9** · `smoke-homework` **36/36**. Mening ligatura ishim (21:16, 115 fayl) ularning 22:19+ yozuvlaridan keyin ham butun — `--check` qoldiq 0. Ball tuzilmasi (`scored` soni · `INLINE_KEYS`) **hech qayerda o'zgarmagan**. Til qarzi tegilgan 9 darsda **faqat kamaygan** (JsFunctions/JsLoops 3→0 · JsVars 7→4 · PracticeLesson2 9→6 · PracticeLesson3 6→2 · PmLesson1 4→2 · JsIntro 23→20); dark o'zgarmagan. **LAYOUT (F-0923-01):** `layout-lint --lang ru` 12 darsda nuqson ko'rsatdi — **12 alohida xato EMAS**, bir nechta umumiy komponent: `ach-coll` 42 hodisa 205–313px · `gloss` 12 hodisa **383–421px** · `frame-soft` 18 hodisa 5–22px va b. **🔴 Bugungi ishdan emasligi ISBOTLANDI:** tegilmagan darslar (`m3-05`, `m4-02`) ham o'lchandi — ular ham toshadi (`button.hw-big`, 12 hodisa). Ya'ni loyiha bo'ylab **eski qarz**; sababi — `layout-lint` `npm run gates` ichida emas (vite kerak, daqiqalar ketadi; asbob izohida «modul yakunida yuritiladi» deyilgan). **Ko'r-ko'rona tuzatilmadi** — CLAUDE.md qoidasi bo'yicha `KATTA_TOZALASH.md` ga to'liq jadval + ustuvorlik bilan yozildi; dalillar `feedback/F-0922-fidbek/tekshiruv/` da (`LAYOUT_TAHLIL.md` + 2 log). **`variable` (F-0923-02, foydalanuvchi qarori):** `JsVarsLesson` 2 joyda «O'zgaruvchi (peremennaya)» → «**(variable)**» — kursdagi «o'zbekcha (inglizcha)» naqshiga mos («Uchirish (deploy)», «Yechim (feature)»); ruscha tegilmadi. Darvozalar bazaga teng (til 4=4 · dark 6=6), smoke uz/ru ✓, skrinshot ✓, qoldiq 0 (arxivdan tashqari). **Kuzatuv:** `peremennaya` bazada ham bor edi — bu seanslarniki emas, eskidan. **Avtopilot rejasi yozildi:** `feedback/F-0922-fidbek/AVTOPILOT_REJA_2026-09-23.md` (o'zini-o'zi tushuntiradi: holat · vazifalar · tegilmaydigan 6 narsa · ish uslubi · ertalabki LMS retesti). **Commit YO'Q.** |
| 03:20 (23.09) | **🤖 TUNGI AVTOPILOT — YAKUNIY REGRESS + YUKLASH PAPKASI (F-0923-03).** Reja: `feedback/F-0922-fidbek/AVTOPILOT_REJA_2026-09-23.md`. **Foydalanuvchi buyrug'i (00:5x):** «bitta GitHub'ga push qil, keyin ishlayver; commit mumkin, men ko'rmaguncha push qilma» → commit `a867a6f` (151 fayl: 22.09 ning uch seans ishi; `src/live/useAutoNext.js` ham kirdi, u `index.js` dan eksport qilinadi — usiz push buzilgan kod bo'lardi; kiritilmadi: `yuklash-2026-09-22/` 30 MB eskirgan, `JAVOB_DARS_PLATFORM_2026-09-21_UZ.md` Axadulla hujjati) · push'ni ruxsat-tizimi blokladi → foydalanuvchi o'zi `git push` qildi: `dcaa93f..a867a6f` ✓. **Regress:** `lint:jsx` 157/**0** · esbuild 118 **toza** · `vite build` ✓ · `lint:prompt` ✓ · `lint:keys` 97 **nomos 0** · prob **160/160** · solo **27/27** · `smoke-homework` **36/36** · `smoke-arena` **97/97** (T1 javob ochildi · T2 avto 6 s · T3 ⏸ yopishqoq). **Topildi — soxta yiqilish, dars emas:** solo birinchi yurishda 26/27 — `JsVarsLesson s15` spetsifikatsiyasi `input[placeholder='let ism = "Aziza"']` ni qidirardi, 22.09 da B-seans o'zgaruvchilarni inglizchaga o'tkazgan (`ism`→`name`, `SEANS-B_MUHR.md` da yozilgan), spetsifikatsiya yangilanmagan (F-0921-15 sinfi takrori). **Qilindi:** `solo-yozma.json` 2 joy — selektor `.split input` (placeholderga bog'lanmaydi; faylda `<input>` bitta), qiymat `let name = "Aziza"` → alohida `--solo` **1/1 ✓**. Qolgan 6 placeholder-selektor manbaga solishtirildi — eskirgani **0**. Dars-kodiga tegilmadi. **Kuzatuv:** `smoke-arena` sarlavha izohi «fayl berilmasa — barcha darslar» deydi, kod esa `exit 2` qiladi; reja-buyrug'i shu tufayli faylsiz edi — 97 fayl `grep -l "<QuizArena"` bilan berildi (skript tegilmadi, qaror foydalanuvchida). **Yuklash:** `yuklash-2026-09-23/` — 88 fayl · 7 modul; `TEKSHIRUV.log`: brauzer uz+ru **176/176** · md5 **88/88** · katalog **70/70**; 88 faylning hammasi 21.09 nusxasidan farq qiladi (kutilgan: ligatura 115 fayl + avto-o'tish 97 dars); `CssLesson1` SCREEN_META 21→**22** (`s7b`, ROYXAT'da tartib 07) — yarim qolgan progress tozalanadi. **Yuklanmadi** (qo'lda, foydalanuvchi). **Muhr:** memory `prob-selektori-matnga-boglanmaydi` ga takror-hodisa. **6-bo'lim qarorlariga tegilmadi.** |
